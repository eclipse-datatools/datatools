...
public class SQLServer2000DriverUIContributor implements IDriverUIContributor,
		Listener {
	...
	protected void updateURL() {
		String url = "jdbc:microsoft:sqlserver://" + hostText.getText() + ":" + portText.getText() + ";databaseName=" + databaseText.getText(); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		urlText.setText(url);
	}
