 ...
 * </copyright>
 *
 * $Id: SybaseASABaseGroupImpl.java,v 1.5 2007/02/28 02:24:49 hcao Exp $
 */
...
public class SybaseASABaseGroupImpl extends UserImpl implements SybaseASABaseGroup 
{
	...
	public EList getUser()
    {
        if (user == null)
        {
            user = new EObjectResolvingEList(User.class, this, SybaseasabasesqlmodelPackage.SYBASE_ASA_BASE_GROUP__USER);
        }
        return user;
    }
