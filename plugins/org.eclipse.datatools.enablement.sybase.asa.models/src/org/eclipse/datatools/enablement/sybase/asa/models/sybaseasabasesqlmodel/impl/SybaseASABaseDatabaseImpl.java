 ...
 * </copyright>
 *
 * $Id: SybaseASABaseDatabaseImpl.java,v 1.2 2007/03/19 16:37:08 jgraham Exp $
 */
...
public class SybaseASABaseDatabaseImpl extends DatabaseImpl implements SybaseASABaseDatabase 
{
	 ...
	 * @ordered
	 */
	protected EList webServices = null;

	/**
	 * The cached value of the '{@link #getDbSpaces() <em>Db Spaces</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getDbSpaces()
	 * @generated
	 ...
	 * @ordered
	 */
	protected EncryptionInfo encryptionInfo = null;
	...
	public EList getDbSpaces() {
		if (dbSpaces == null) {
			dbSpaces = new EObjectWithInverseResolvingEList(SybaseASABaseDBSpace.class, this, SybaseasabasesqlmodelPackage.SYBASE_ASA_BASE_DATABASE__DB_SPACES, SybaseasabasesqlmodelPackage.SYBASE_ASA_BASE_DB_SPACE__DATABASE);
		}
		return dbSpaces;
	}
