...
public interface SQLParsersym {
    public final static int
      ...
      TK_COLON = 759,
      TK_SEMICOLON = 760,
      TK_LESS_THAN_OPERATOR = 761,
      TK_EQUALS_OPERATOR = 762,
      TK_GREATER_THAN_OPERATOR = 763,
      TK_QUESTION_MARK = 764,
      TK_LEFT_BRACKET = 765,
      TK_RIGHT_BRACKET = 766,
      TK_LEFT_BRACKET_TRIGRAPH = 767,
      TK_RIGHT_BRACKET_TRIGRAPH = 768,
      TK_VERTICAL_BAR = 769,
      TK_NOT_EQUALS_OPERATOR = 770,
      TK_GREATER_THAN_OR_EQUALS_OPERATOR = 771,
      TK_LESS_THAN_OR_EQUALS_OPERATOR = 772,
      TK_CONCAT_OPERATOR = 773,
      TK_DOUBLE_PERIOD = 774,
      TK_RIGHT_ARROW = 775,
      TK_STATEMENT_TERMINATOR = 776,
      TK_HOSTVARIABLE = 777,
      TK_PARAMETER_MARKER = 778,
      TK_LINE_COMMENT = 779,
      TK_MULTILINE_COMMENT = 780,
      TK_EOF = 781;
