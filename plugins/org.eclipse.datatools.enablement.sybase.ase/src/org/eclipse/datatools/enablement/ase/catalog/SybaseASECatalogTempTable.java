...
import org.eclipse.datatools.enablement.sybase.ase.models.sybaseasesqlmodel.impl.SybaseASETempTableImpl;
...
public class SybaseASECatalogTempTable extends SybaseASETempTableImpl implements ISybaseASECatalogTable, ICatalogObject,ICatalogTable,IAdaptable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -8696213120545277875L;
	
    private SybaseASEBaseTableLoader tableLoader;
    
    public SybaseASECatalogTempTable()
    {
        super();
