 ...
 * </copyright>
 *
 * $Id: TableExpressionImpl.java,v 1.3 2005/12/19 20:56:36 bpayton Exp $
 */
...
public abstract class TableExpressionImpl extends TableReferenceImpl implements TableExpression {
  ...
  protected EList resultTableAllColumns = null;
    ...
    protected EClass eStaticClass() {
		return SQLQueryModelPackage.eINSTANCE.getTableExpression();
	}
  ...
  public EList getResultTableAllColumns() {
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				case SQLQueryModelPackage.TABLE_EXPRESSION__EANNOTATIONS:
					return ((InternalEList)getEAnnotations()).basicAdd(otherEnd, msgs);
				case SQLQueryModelPackage.TABLE_EXPRESSION__TABLE_JOINED_RIGHT:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLQueryModelPackage.TABLE_EXPRESSION__TABLE_JOINED_RIGHT, msgs);
				case SQLQueryModelPackage.TABLE_EXPRESSION__TABLE_JOINED_LEFT:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLQueryModelPackage.TABLE_EXPRESSION__TABLE_JOINED_LEFT, msgs);
				case SQLQueryModelPackage.TABLE_EXPRESSION__QUERY_SELECT:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLQueryModelPackage.TABLE_EXPRESSION__QUERY_SELECT, msgs);
				case SQLQueryModelPackage.TABLE_EXPRESSION__NEST:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLQueryModelPackage.TABLE_EXPRESSION__NEST, msgs);
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case SQLQueryModelPackage.TABLE_EXPRESSION__DEPENDENCIES:
					return ((InternalEList)getDependencies()).basicRemove(otherEnd, msgs);
				case SQLQueryModelPackage.TABLE_EXPRESSION__TABLE_JOINED_RIGHT:
					return eBasicSetContainer(null, SQLQueryModelPackage.TABLE_EXPRESSION__TABLE_JOINED_RIGHT, msgs);
				case SQLQueryModelPackage.TABLE_EXPRESSION__TABLE_JOINED_LEFT:
					return eBasicSetContainer(null, SQLQueryModelPackage.TABLE_EXPRESSION__TABLE_JOINED_LEFT, msgs);
				case SQLQueryModelPackage.TABLE_EXPRESSION__QUERY_SELECT:
					return eBasicSetContainer(null, SQLQueryModelPackage.TABLE_EXPRESSION__QUERY_SELECT, msgs);
				case SQLQueryModelPackage.TABLE_EXPRESSION__NEST:
					return eBasicSetContainer(null, SQLQueryModelPackage.TABLE_EXPRESSION__NEST, msgs);
				case SQLQueryModelPackage.TABLE_EXPRESSION__COLUMN_LIST:
    ...
    public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case SQLQueryModelPackage.TABLE_EXPRESSION__NAME:
				return getName();
			case SQLQueryModelPackage.TABLE_EXPRESSION__DEPENDENCIES:
				return getDependencies();
			case SQLQueryModelPackage.TABLE_EXPRESSION__DESCRIPTION:
				return getDescription();
			case SQLQueryModelPackage.TABLE_EXPRESSION__LABEL:
				return getLabel();
			case SQLQueryModelPackage.TABLE_EXPRESSION__TABLE_JOINED_RIGHT:
