 ...
 * </copyright>
 *
 * $Id: PredicateBasicImpl.java,v 1.1 2005/12/16 13:11:13 bpayton Exp $
 */
...
public class PredicateBasicImpl extends PredicateImpl implements PredicateBasic {
    ...
    protected EClass eStaticClass() {
		return SQLQueryPackage.eINSTANCE.getPredicateBasic();
	}
    ...
    public void setComparisonOperator(PredicateComparisonOperator newComparisonOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQLQueryPackage.PREDICATE_BASIC__COMPARISON_OPERATOR, oldComparisonOperator, comparisonOperator));
	}
    ...
    public NotificationChain basicSetRightValueExpr(QueryValueExpression newRightValueExpr, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SQLQueryPackage.PREDICATE_BASIC__RIGHT_VALUE_EXPR, oldRightValueExpr, newRightValueExpr);
    ...
    public void setRightValueExpr(QueryValueExpression newRightValueExpr) {
		if (newRightValueExpr != rightValueExpr) {
			...
			if (rightValueExpr != null)
				msgs = ((InternalEObject)rightValueExpr).eInverseRemove(this, SQLQueryPackage.QUERY_VALUE_EXPRESSION__BASIC_RIGHT, QueryValueExpression.class, msgs);
			if (newRightValueExpr != null)
				msgs = ((InternalEObject)newRightValueExpr).eInverseAdd(this, SQLQueryPackage.QUERY_VALUE_EXPRESSION__BASIC_RIGHT, QueryValueExpression.class, msgs);
			msgs = basicSetRightValueExpr(newRightValueExpr, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQLQueryPackage.PREDICATE_BASIC__RIGHT_VALUE_EXPR, newRightValueExpr, newRightValueExpr));
	}
    ...
    public NotificationChain basicSetLeftValueExpr(QueryValueExpression newLeftValueExpr, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SQLQueryPackage.PREDICATE_BASIC__LEFT_VALUE_EXPR, oldLeftValueExpr, newLeftValueExpr);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
    ...
    public void setLeftValueExpr(QueryValueExpression newLeftValueExpr) {
		if (newLeftValueExpr != leftValueExpr) {
			...
			if (leftValueExpr != null)
				msgs = ((InternalEObject)leftValueExpr).eInverseRemove(this, SQLQueryPackage.QUERY_VALUE_EXPRESSION__BASIC_LEFT, QueryValueExpression.class, msgs);
			if (newLeftValueExpr != null)
				msgs = ((InternalEObject)newLeftValueExpr).eInverseAdd(this, SQLQueryPackage.QUERY_VALUE_EXPRESSION__BASIC_LEFT, QueryValueExpression.class, msgs);
			msgs = basicSetLeftValueExpr(newLeftValueExpr, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQLQueryPackage.PREDICATE_BASIC__LEFT_VALUE_EXPR, newLeftValueExpr, newLeftValueExpr));
	}
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				case SQLQueryPackage.PREDICATE_BASIC__EANNOTATIONS:
					return ((InternalEList)getEAnnotations()).basicAdd(otherEnd, msgs);
				case SQLQueryPackage.PREDICATE_BASIC__UPDATE_STATEMENT:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLQueryPackage.PREDICATE_BASIC__UPDATE_STATEMENT, msgs);
				case SQLQueryPackage.PREDICATE_BASIC__DELETE_STATEMENT:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLQueryPackage.PREDICATE_BASIC__DELETE_STATEMENT, msgs);
				case SQLQueryPackage.PREDICATE_BASIC__TABLE_JOINED:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLQueryPackage.PREDICATE_BASIC__TABLE_JOINED, msgs);
				case SQLQueryPackage.PREDICATE_BASIC__COMBINED_LEFT:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLQueryPackage.PREDICATE_BASIC__COMBINED_LEFT, msgs);
				case SQLQueryPackage.PREDICATE_BASIC__COMBINED_RIGHT:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLQueryPackage.PREDICATE_BASIC__COMBINED_RIGHT, msgs);
				case SQLQueryPackage.PREDICATE_BASIC__QUERY_SELECT_HAVING:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLQueryPackage.PREDICATE_BASIC__QUERY_SELECT_HAVING, msgs);
				case SQLQueryPackage.PREDICATE_BASIC__QUERY_SELECT_WHERE:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLQueryPackage.PREDICATE_BASIC__QUERY_SELECT_WHERE, msgs);
				case SQLQueryPackage.PREDICATE_BASIC__VALUE_EXPR_CASE_SEARCH_CONTENT:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLQueryPackage.PREDICATE_BASIC__VALUE_EXPR_CASE_SEARCH_CONTENT, msgs);
				case SQLQueryPackage.PREDICATE_BASIC__NEST:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLQueryPackage.PREDICATE_BASIC__NEST, msgs);
				case SQLQueryPackage.PREDICATE_BASIC__RIGHT_VALUE_EXPR:
					if (rightValueExpr != null)
						msgs = ((InternalEObject)rightValueExpr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SQLQueryPackage.PREDICATE_BASIC__RIGHT_VALUE_EXPR, null, msgs);
					return basicSetRightValueExpr((QueryValueExpression)otherEnd, msgs);
				case SQLQueryPackage.PREDICATE_BASIC__LEFT_VALUE_EXPR:
					if (leftValueExpr != null)
						msgs = ((InternalEObject)leftValueExpr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SQLQueryPackage.PREDICATE_BASIC__LEFT_VALUE_EXPR, null, msgs);
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case SQLQueryPackage.PREDICATE_BASIC__DEPENDENCIES:
					return ((InternalEList)getDependencies()).basicRemove(otherEnd, msgs);
				case SQLQueryPackage.PREDICATE_BASIC__UPDATE_STATEMENT:
					return eBasicSetContainer(null, SQLQueryPackage.PREDICATE_BASIC__UPDATE_STATEMENT, msgs);
				case SQLQueryPackage.PREDICATE_BASIC__DELETE_STATEMENT:
					return eBasicSetContainer(null, SQLQueryPackage.PREDICATE_BASIC__DELETE_STATEMENT, msgs);
				case SQLQueryPackage.PREDICATE_BASIC__TABLE_JOINED:
					return eBasicSetContainer(null, SQLQueryPackage.PREDICATE_BASIC__TABLE_JOINED, msgs);
				case SQLQueryPackage.PREDICATE_BASIC__COMBINED_LEFT:
					return eBasicSetContainer(null, SQLQueryPackage.PREDICATE_BASIC__COMBINED_LEFT, msgs);
				case SQLQueryPackage.PREDICATE_BASIC__COMBINED_RIGHT:
					return eBasicSetContainer(null, SQLQueryPackage.PREDICATE_BASIC__COMBINED_RIGHT, msgs);
				case SQLQueryPackage.PREDICATE_BASIC__QUERY_SELECT_HAVING:
					return eBasicSetContainer(null, SQLQueryPackage.PREDICATE_BASIC__QUERY_SELECT_HAVING, msgs);
				case SQLQueryPackage.PREDICATE_BASIC__QUERY_SELECT_WHERE:
					return eBasicSetContainer(null, SQLQueryPackage.PREDICATE_BASIC__QUERY_SELECT_WHERE, msgs);
				case SQLQueryPackage.PREDICATE_BASIC__VALUE_EXPR_CASE_SEARCH_CONTENT:
					return eBasicSetContainer(null, SQLQueryPackage.PREDICATE_BASIC__VALUE_EXPR_CASE_SEARCH_CONTENT, msgs);
				case SQLQueryPackage.PREDICATE_BASIC__NEST:
					return eBasicSetContainer(null, SQLQueryPackage.PREDICATE_BASIC__NEST, msgs);
				case SQLQueryPackage.PREDICATE_BASIC__RIGHT_VALUE_EXPR:
    ...
    public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case SQLQueryPackage.PREDICATE_BASIC__NAME:
				return getName();
			case SQLQueryPackage.PREDICATE_BASIC__DEPENDENCIES:
				return getDependencies();
			case SQLQueryPackage.PREDICATE_BASIC__DESCRIPTION:
				return getDescription();
			case SQLQueryPackage.PREDICATE_BASIC__LABEL:
				return getLabel();
			case SQLQueryPackage.PREDICATE_BASIC__NEGATED_CONDITION:
			...
			case SQLQueryPackage.PREDICATE_BASIC__NEST:
				return getNest();
			case SQLQueryPackage.PREDICATE_BASIC__NEGATED_PREDICATE:
				return isNegatedPredicate() ? Boolean.TRUE : Boolean.FALSE;
			case SQLQueryPackage.PREDICATE_BASIC__HAS_SELECTIVITY:
				return isHasSelectivity() ? Boolean.TRUE : Boolean.FALSE;
			case SQLQueryPackage.PREDICATE_BASIC__SELECTIVITY_VALUE:
				return getSelectivityValue();
			case SQLQueryPackage.PREDICATE_BASIC__COMPARISON_OPERATOR:
