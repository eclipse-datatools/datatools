 ...
 * </copyright>
 *
 * $Id: PredicateQuantifiedRowSelectImpl.java,v 1.3 2005/12/19 20:56:36 bpayton Exp $
 */
...
public class PredicateQuantifiedRowSelectImpl extends PredicateQuantifiedImpl implements PredicateQuantifiedRowSelect {
    ...
    protected EClass eStaticClass() {
		return SQLQueryModelPackage.eINSTANCE.getPredicateQuantifiedRowSelect();
	}
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				case SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__EANNOTATIONS:
					return ((InternalEList)getEAnnotations()).basicAdd(otherEnd, msgs);
				case SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__UPDATE_STATEMENT:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__UPDATE_STATEMENT, msgs);
				case SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__DELETE_STATEMENT:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__DELETE_STATEMENT, msgs);
				case SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__TABLE_JOINED:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__TABLE_JOINED, msgs);
				case SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__COMBINED_LEFT:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__COMBINED_LEFT, msgs);
				case SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__COMBINED_RIGHT:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__COMBINED_RIGHT, msgs);
				case SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__QUERY_SELECT_HAVING:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__QUERY_SELECT_HAVING, msgs);
				case SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__QUERY_SELECT_WHERE:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__QUERY_SELECT_WHERE, msgs);
				case SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__VALUE_EXPR_CASE_SEARCH_CONTENT:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__VALUE_EXPR_CASE_SEARCH_CONTENT, msgs);
				case SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__NEST:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__NEST, msgs);
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__DEPENDENCIES:
					return ((InternalEList)getDependencies()).basicRemove(otherEnd, msgs);
				case SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__UPDATE_STATEMENT:
					return eBasicSetContainer(null, SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__UPDATE_STATEMENT, msgs);
				case SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__DELETE_STATEMENT:
					return eBasicSetContainer(null, SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__DELETE_STATEMENT, msgs);
				case SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__TABLE_JOINED:
					return eBasicSetContainer(null, SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__TABLE_JOINED, msgs);
				case SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__COMBINED_LEFT:
					return eBasicSetContainer(null, SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__COMBINED_LEFT, msgs);
				case SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__COMBINED_RIGHT:
					return eBasicSetContainer(null, SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__COMBINED_RIGHT, msgs);
				case SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__QUERY_SELECT_HAVING:
					return eBasicSetContainer(null, SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__QUERY_SELECT_HAVING, msgs);
				case SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__QUERY_SELECT_WHERE:
					return eBasicSetContainer(null, SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__QUERY_SELECT_WHERE, msgs);
				case SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__VALUE_EXPR_CASE_SEARCH_CONTENT:
					return eBasicSetContainer(null, SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__VALUE_EXPR_CASE_SEARCH_CONTENT, msgs);
				case SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__NEST:
					return eBasicSetContainer(null, SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__NEST, msgs);
				case SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__QUERY_EXPR:
    ...
    public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__NAME:
				return getName();
			case SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__DEPENDENCIES:
				return getDependencies();
			case SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__DESCRIPTION:
				return getDescription();
			case SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__LABEL:
				return getLabel();
			case SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__NEGATED_CONDITION:
			...
			case SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__NEST:
				return getNest();
			case SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__NEGATED_PREDICATE:
				return isNegatedPredicate() ? Boolean.TRUE : Boolean.FALSE;
			case SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__HAS_SELECTIVITY:
				return isHasSelectivity() ? Boolean.TRUE : Boolean.FALSE;
			case SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT__SELECTIVITY_VALUE:
