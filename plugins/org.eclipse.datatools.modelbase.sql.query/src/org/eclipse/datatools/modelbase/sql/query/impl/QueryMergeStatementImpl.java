 ...
 * </copyright>
 *
 * $Id: QueryMergeStatementImpl.java,v 1.2 2005/12/17 01:46:20 bpayton Exp $
 */
...
public class QueryMergeStatementImpl extends QueryChangeStatementImpl implements QueryMergeStatement {
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				case SQLQueryPackage.QUERY_MERGE_STATEMENT__EANNOTATIONS:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case SQLQueryPackage.QUERY_MERGE_STATEMENT__DEPENDENCIES:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case SQLQueryPackage.QUERY_MERGE_STATEMENT__NAME:
				return getName();
			case SQLQueryPackage.QUERY_MERGE_STATEMENT__DEPENDENCIES:
				return getDependencies();
			case SQLQueryPackage.QUERY_MERGE_STATEMENT__DESCRIPTION:
				return getDescription();
			case SQLQueryPackage.QUERY_MERGE_STATEMENT__LABEL:
				return getLabel();
		}
