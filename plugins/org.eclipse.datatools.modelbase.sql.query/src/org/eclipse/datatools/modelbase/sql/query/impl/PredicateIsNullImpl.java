...
public class PredicateIsNullImpl extends PredicateImpl implements PredicateIsNull {
    ...
    public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case SQLQueryModelPackage.PREDICATE_IS_NULL__NEST:
				return getNest();
			case SQLQueryModelPackage.PREDICATE_IS_NULL__NEGATED_PREDICATE:
				return isNegatedPredicate() ? Boolean.TRUE : Boolean.FALSE;
			case SQLQueryModelPackage.PREDICATE_IS_NULL__HAS_SELECTIVITY:
				return isHasSelectivity() ? Boolean.TRUE : Boolean.FALSE;
			case SQLQueryModelPackage.PREDICATE_IS_NULL__SELECTIVITY_VALUE:
