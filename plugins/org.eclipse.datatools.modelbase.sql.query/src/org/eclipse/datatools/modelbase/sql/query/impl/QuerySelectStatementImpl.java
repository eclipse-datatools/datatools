 ...
 * </copyright>
 *
 * $Id: QuerySelectStatementImpl.java,v 1.2 2005/12/17 01:46:20 bpayton Exp $
 */
...
public class QuerySelectStatementImpl extends QueryStatementImpl implements QuerySelectStatement {
    ...
    protected EClass eStaticClass() {
		return SQLQueryModelPackage.eINSTANCE.getQuerySelectStatement();
	}
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				case SQLQueryModelPackage.QUERY_SELECT_STATEMENT__EANNOTATIONS:
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case SQLQueryModelPackage.QUERY_SELECT_STATEMENT__DEPENDENCIES:
    ...
    public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case SQLQueryModelPackage.QUERY_SELECT_STATEMENT__NAME:
				return getName();
			case SQLQueryModelPackage.QUERY_SELECT_STATEMENT__DEPENDENCIES:
				return getDependencies();
			case SQLQueryModelPackage.QUERY_SELECT_STATEMENT__DESCRIPTION:
				return getDescription();
			case SQLQueryModelPackage.QUERY_SELECT_STATEMENT__LABEL:
				return getLabel();
			case SQLQueryModelPackage.QUERY_SELECT_STATEMENT__QUERY_EXPR:
				return getQueryExpr();
			case SQLQueryModelPackage.QUERY_SELECT_STATEMENT__ORDER_BY_CLAUSE:
