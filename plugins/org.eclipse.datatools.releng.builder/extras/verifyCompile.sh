...
if [ $count -gt 0 ] ; then
        echo "#Compile has error in $1" >> /home/adb/releng.dtp.171/org.eclipse.datatools.releng.builder/monitor.properties
        ...
        echo "compileHasError=true" >> /home/adb/releng.dtp.171/org.eclipse.datatools.releng.builder/monitor.properties
        echo "error.plugin.list=\\" >> /home/adb/releng.dtp.171/org.eclipse.datatools.releng.builder/monitor.properties
        cat $1/notify.list >> /home/adb/releng.dtp.171/org.eclipse.datatools.releng.builder/monitor.properties
        echo " "  >> /home/adb/releng.dtp.171/org.eclipse.datatools.releng.builder/monitor.properties
else
        echo "#No compile error in $1" >> /home/adb/releng.dtp.171/org.eclipse.datatools.releng.builder/monitor.properties
        echo "compileHasError=false" >> /home/adb/releng.dtp.171/org.eclipse.datatools.releng.builder/monitor.properties
fi
