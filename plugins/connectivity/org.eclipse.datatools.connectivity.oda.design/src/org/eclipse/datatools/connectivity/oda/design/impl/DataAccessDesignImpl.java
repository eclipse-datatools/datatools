...
public class DataAccessDesignImpl extends EObjectImpl implements DataAccessDesign {
	...
	public void setNewDataSetDesign(DataSourceDesign dataSourceDesign) {
		...
		DataSetDesign newDataSet = DesignFactory.eINSTANCE.createDataSetDesign();
	...
	public NotificationChain basicSetDataSetDesign(DataSetDesign newDataSetDesign, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DesignPackage.DATA_ACCESS_DESIGN__DATA_SET_DESIGN, oldDataSetDesign, newDataSetDesign);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newDataSetDesign != dataSetDesign) {
			...
			if (dataSetDesign != null) {
				msgs = ((InternalEObject) dataSetDesign).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DesignPackage.DATA_ACCESS_DESIGN__DATA_SET_DESIGN, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.DATA_ACCESS_DESIGN__DATA_SET_DESIGN,
