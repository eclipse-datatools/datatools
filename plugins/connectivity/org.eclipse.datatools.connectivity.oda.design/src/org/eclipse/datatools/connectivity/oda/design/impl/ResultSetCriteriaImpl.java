...
public class ResultSetCriteriaImpl extends EObjectImpl implements ResultSetCriteria {
	 ...
	 * @ordered
	 */
	protected FilterExpression filterSpecification;
	 ...
	 * @ordered
	 */
	protected SortSpecification rowOrdering;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetFilterSpecification(FilterExpression newFilterSpecification,
			NotificationChain msgs) {
		FilterExpression oldFilterSpecification = filterSpecification;
		filterSpecification = newFilterSpecification;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DesignPackage.RESULT_SET_CRITERIA__FILTER_SPECIFICATION, oldFilterSpecification,
					newFilterSpecification);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public void setFilterSpecification(FilterExpression newFilterSpecification) {
		if (newFilterSpecification != filterSpecification) {
			NotificationChain msgs = null;
			if (filterSpecification != null) {
				msgs = ((InternalEObject) filterSpecification).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DesignPackage.RESULT_SET_CRITERIA__FILTER_SPECIFICATION, null, msgs);
			}
			if (newFilterSpecification != null) {
				msgs = ((InternalEObject) newFilterSpecification).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - DesignPackage.RESULT_SET_CRITERIA__FILTER_SPECIFICATION, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					DesignPackage.RESULT_SET_CRITERIA__FILTER_SPECIFICATION, newFilterSpecification,
					newFilterSpecification));
		}
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetRowOrdering(SortSpecification newRowOrdering, NotificationChain msgs) {
		SortSpecification oldRowOrdering = rowOrdering;
		rowOrdering = newRowOrdering;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DesignPackage.RESULT_SET_CRITERIA__ROW_ORDERING, oldRowOrdering, newRowOrdering);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
	...
	public void setRowOrdering(SortSpecification newRowOrdering) {
		if (newRowOrdering != rowOrdering) {
			NotificationChain msgs = null;
			if (rowOrdering != null) {
				msgs = ((InternalEObject) rowOrdering).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DesignPackage.RESULT_SET_CRITERIA__ROW_ORDERING, null, msgs);
			}
			if (newRowOrdering != null) {
				msgs = ((InternalEObject) newRowOrdering).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - DesignPackage.RESULT_SET_CRITERIA__ROW_ORDERING, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.RESULT_SET_CRITERIA__ROW_ORDERING,
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case DesignPackage.RESULT_SET_CRITERIA__FILTER_SPECIFICATION:
			return filterSpecification != null;
		case DesignPackage.RESULT_SET_CRITERIA__ROW_ORDERING:
