...
public enum TextFormatType implements Enumerator {
	 ...
	 * @generated
	 */
	private static final TextFormatType[] VALUES_ARRAY = new TextFormatType[] { PLAIN_LITERAL, HTML_LITERAL,
			RTF_LITERAL, };
	 ...
	 * @generated
	 */
	public static final List<TextFormatType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	...
	public static TextFormatType get(String literal) {
		for (TextFormatType result : VALUES_ARRAY) {
