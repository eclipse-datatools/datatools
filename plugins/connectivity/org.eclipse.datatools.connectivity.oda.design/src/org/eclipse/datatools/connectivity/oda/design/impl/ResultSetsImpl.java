...
public class ResultSetsImpl extends EObjectImpl implements ResultSets {
	 ...
	 * @ordered
	 */
	protected EList<ResultSetDefinition> resultSetDefinitions;
	...
	public ResultSetDefinition findResultSetDefinition(String resultSetName) {
		if (resultSetDefinitions == null || resultSetName == null || resultSetName.length() == 0) {
			return null;
		}
	...
	public EList<ResultSetDefinition> getResultSetDefinitions() {
		if (resultSetDefinitions == null) {
			resultSetDefinitions = new EObjectContainmentEList<>(ResultSetDefinition.class, this,
	...
	public void setDerivedMetaData(boolean newDerivedMetaData) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.RESULT_SETS__DERIVED_META_DATA,
	...
	public void unsetDerivedMetaData() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.UNSET, DesignPackage.RESULT_SETS__DERIVED_META_DATA,
					oldDerivedMetaData, DERIVED_META_DATA_EDEFAULT, oldDerivedMetaDataESet));
		}
	}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case DesignPackage.RESULT_SETS__RESULT_SET_DEFINITIONS:
			...
			getResultSetDefinitions().addAll((Collection<? extends ResultSetDefinition>) newValue);
			return;
		case DesignPackage.RESULT_SETS__DERIVED_META_DATA:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case DesignPackage.RESULT_SETS__RESULT_SET_DEFINITIONS:
			return resultSetDefinitions != null && !resultSetDefinitions.isEmpty();
		case DesignPackage.RESULT_SETS__DERIVED_META_DATA:
