 ...
 * @generated
 */
public class FilterExpressionTypeImpl extends EObjectImpl implements FilterExpressionType {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @ordered
	 */
	protected String declaringExtensionId = DECLARING_EXTENSION_ID_EDEFAULT;
	...
	public void setDeclaringExtensionId(String newDeclaringExtensionId) {
		String oldDeclaringExtensionId = declaringExtensionId;
		declaringExtensionId = newDeclaringExtensionId;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET,
					DesignPackage.FILTER_EXPRESSION_TYPE__DECLARING_EXTENSION_ID, oldDeclaringExtensionId,
					declaringExtensionId));
		}
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.FILTER_EXPRESSION_TYPE__ID, oldId, id));
		}
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case DesignPackage.FILTER_EXPRESSION_TYPE__DECLARING_EXTENSION_ID:
			return DECLARING_EXTENSION_ID_EDEFAULT == null ? declaringExtensionId != null
					: !DECLARING_EXTENSION_ID_EDEFAULT.equals(declaringExtensionId);
		case DesignPackage.FILTER_EXPRESSION_TYPE__ID:
	...
	public String toString() {
		...
		result.append(declaringExtensionId);
