...
public class ExpressionParameterDefinitionImpl extends EObjectImpl implements ExpressionParameterDefinition {
	 ...
	 * @ordered
	 */
	protected ParameterDefinition dynamicInputParameter;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetStaticValues(StaticValues newStaticValues, NotificationChain msgs) {
		StaticValues oldStaticValues = staticValues;
		staticValues = newStaticValues;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DesignPackage.EXPRESSION_PARAMETER_DEFINITION__STATIC_VALUES, oldStaticValues, newStaticValues);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public void setStaticValues(StaticValues newStaticValues) {
		if (newStaticValues != staticValues) {
			NotificationChain msgs = null;
			if (staticValues != null) {
				msgs = ((InternalEObject) staticValues).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DesignPackage.EXPRESSION_PARAMETER_DEFINITION__STATIC_VALUES, null,
						msgs);
			}
			if (newStaticValues != null) {
				msgs = ((InternalEObject) newStaticValues).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - DesignPackage.EXPRESSION_PARAMETER_DEFINITION__STATIC_VALUES, null,
						msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					DesignPackage.EXPRESSION_PARAMETER_DEFINITION__STATIC_VALUES, newStaticValues, newStaticValues));
		}
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDynamicInputParameter(ParameterDefinition newDynamicInputParameter,
			NotificationChain msgs) {
		ParameterDefinition oldDynamicInputParameter = dynamicInputParameter;
		dynamicInputParameter = newDynamicInputParameter;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DesignPackage.EXPRESSION_PARAMETER_DEFINITION__DYNAMIC_INPUT_PARAMETER, oldDynamicInputParameter,
					newDynamicInputParameter);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
	 ...
	 */
	@Override
	public void setDynamicInputParameter(ParameterDefinition newDynamicInputParameter) {
		if (newDynamicInputParameter != dynamicInputParameter) {
			NotificationChain msgs = null;
			if (dynamicInputParameter != null) {
				msgs = ((InternalEObject) dynamicInputParameter).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DesignPackage.EXPRESSION_PARAMETER_DEFINITION__DYNAMIC_INPUT_PARAMETER,
						null, msgs);
			}
			if (newDynamicInputParameter != null) {
				msgs = ((InternalEObject) newDynamicInputParameter).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - DesignPackage.EXPRESSION_PARAMETER_DEFINITION__DYNAMIC_INPUT_PARAMETER,
						null, msgs);
			}
			msgs = basicSetDynamicInputParameter(newDynamicInputParameter, msgs);
			if (msgs != null) {
				msgs.dispatch();
			}
		} else if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET,
					DesignPackage.EXPRESSION_PARAMETER_DEFINITION__DYNAMIC_INPUT_PARAMETER, newDynamicInputParameter,
					newDynamicInputParameter));
		}
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case DesignPackage.EXPRESSION_PARAMETER_DEFINITION__DYNAMIC_INPUT_PARAMETER:
			return dynamicInputParameter != null;
		}
