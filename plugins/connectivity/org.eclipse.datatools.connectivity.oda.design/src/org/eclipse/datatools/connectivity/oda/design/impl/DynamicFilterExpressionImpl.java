 ...
 * @generated
 */
public class DynamicFilterExpressionImpl extends FilterExpressionImpl implements DynamicFilterExpression {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @ordered
	 */
	protected FilterExpressionType defaultType;
	...
	public NotificationChain basicSetContext(AtomicExpressionContext newContext, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DesignPackage.DYNAMIC_FILTER_EXPRESSION__CONTEXT, oldContext, newContext);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newContext != context) {
			...
			if (context != null) {
				msgs = ((InternalEObject) context).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DesignPackage.DYNAMIC_FILTER_EXPRESSION__CONTEXT, null, msgs);
			}
			if (newContext != null) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.DYNAMIC_FILTER_EXPRESSION__CONTEXT,
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDefaultType(FilterExpressionType newDefaultType, NotificationChain msgs) {
		FilterExpressionType oldDefaultType = defaultType;
		defaultType = newDefaultType;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DesignPackage.DYNAMIC_FILTER_EXPRESSION__DEFAULT_TYPE, oldDefaultType, newDefaultType);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
	...
	public void setDefaultType(FilterExpressionType newDefaultType) {
		if (newDefaultType != defaultType) {
			NotificationChain msgs = null;
			if (defaultType != null) {
				msgs = ((InternalEObject) defaultType).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DesignPackage.DYNAMIC_FILTER_EXPRESSION__DEFAULT_TYPE, null, msgs);
			}
			if (newDefaultType != null) {
				msgs = ((InternalEObject) newDefaultType).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - DesignPackage.DYNAMIC_FILTER_EXPRESSION__DEFAULT_TYPE, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.DYNAMIC_FILTER_EXPRESSION__DEFAULT_TYPE,
