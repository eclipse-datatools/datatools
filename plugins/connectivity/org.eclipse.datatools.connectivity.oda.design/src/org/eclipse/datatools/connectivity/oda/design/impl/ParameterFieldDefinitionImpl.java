...
public class ParameterFieldDefinitionImpl extends EObjectImpl implements ParameterFieldDefinition {
	 ...
	 * @ordered
	 */
	protected InputElementAttributes inputAttributes;
	...
	public NotificationChain basicSetAttributes(DataElementAttributes newAttributes, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DesignPackage.PARAMETER_FIELD_DEFINITION__ATTRIBUTES, oldAttributes, newAttributes);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newAttributes != attributes) {
			...
			if (attributes != null) {
				msgs = ((InternalEObject) attributes).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DesignPackage.PARAMETER_FIELD_DEFINITION__ATTRIBUTES, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.PARAMETER_FIELD_DEFINITION__ATTRIBUTES,
	 ...
	 * @generated
	 */
	public NotificationChain basicSetInputAttributes(InputElementAttributes newInputAttributes,
			NotificationChain msgs) {
		InputElementAttributes oldInputAttributes = inputAttributes;
		inputAttributes = newInputAttributes;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DesignPackage.PARAMETER_FIELD_DEFINITION__INPUT_ATTRIBUTES, oldInputAttributes, newInputAttributes);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
		...
		if (newInputAttributes != inputAttributes) {
			...
			if (inputAttributes != null) {
				msgs = ((InternalEObject) inputAttributes).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DesignPackage.PARAMETER_FIELD_DEFINITION__INPUT_ATTRIBUTES, null,
						msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					DesignPackage.PARAMETER_FIELD_DEFINITION__INPUT_ATTRIBUTES, newInputAttributes,
					newInputAttributes));
		}
	}
	...
	public NotificationChain basicSetOutputUsageHints(OutputElementAttributes newOutputUsageHints,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DesignPackage.PARAMETER_FIELD_DEFINITION__OUTPUT_USAGE_HINTS, oldOutputUsageHints,
					newOutputUsageHints);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newOutputUsageHints != outputUsageHints) {
			...
			if (outputUsageHints != null) {
				msgs = ((InternalEObject) outputUsageHints).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DesignPackage.PARAMETER_FIELD_DEFINITION__OUTPUT_USAGE_HINTS, null,
						msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					DesignPackage.PARAMETER_FIELD_DEFINITION__OUTPUT_USAGE_HINTS, newOutputUsageHints,
					newOutputUsageHints));
		}
	}
