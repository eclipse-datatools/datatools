...
public class PropertyImpl extends EObjectImpl implements Property {
	 ...
	 * @ordered
	 */
	protected NameValuePair nameValue;
	 ...
	 * @ordered
	 */
	protected PropertyAttributes designAttributes;
	...
	public NotificationChain basicSetNameValue(NameValuePair newNameValue, NotificationChain msgs) {
		NameValuePair oldNameValue = nameValue;
		nameValue = newNameValue;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DesignPackage.PROPERTY__NAME_VALUE, oldNameValue, newNameValue);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public void setNameValue(NameValuePair newNameValue) {
		if (newNameValue != nameValue) {
			NotificationChain msgs = null;
			if (nameValue != null) {
				msgs = ((InternalEObject) nameValue).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DesignPackage.PROPERTY__NAME_VALUE, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.PROPERTY__NAME_VALUE, newNameValue,
					newNameValue));
		}
	}
	...
	public NotificationChain basicSetDesignAttributes(PropertyAttributes newDesignAttributes, NotificationChain msgs) {
		PropertyAttributes oldDesignAttributes = designAttributes;
		designAttributes = newDesignAttributes;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DesignPackage.PROPERTY__DESIGN_ATTRIBUTES, oldDesignAttributes, newDesignAttributes);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
	...
	public void setDesignAttributes(PropertyAttributes newDesignAttributes) {
		if (newDesignAttributes != designAttributes) {
			NotificationChain msgs = null;
			if (designAttributes != null) {
				msgs = ((InternalEObject) designAttributes).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DesignPackage.PROPERTY__DESIGN_ATTRIBUTES, null, msgs);
			}
			if (newDesignAttributes != null) {
				msgs = ((InternalEObject) newDesignAttributes).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - DesignPackage.PROPERTY__DESIGN_ATTRIBUTES, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.PROPERTY__DESIGN_ATTRIBUTES,
