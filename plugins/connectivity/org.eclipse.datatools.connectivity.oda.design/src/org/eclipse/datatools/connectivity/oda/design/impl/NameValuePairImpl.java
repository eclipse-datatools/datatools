...
public class NameValuePairImpl extends EObjectImpl implements NameValuePair {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.NAME_VALUE_PAIR__NAME, oldName, name));
		}
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.NAME_VALUE_PAIR__VALUE, oldValue,
					value));
		}
	}
