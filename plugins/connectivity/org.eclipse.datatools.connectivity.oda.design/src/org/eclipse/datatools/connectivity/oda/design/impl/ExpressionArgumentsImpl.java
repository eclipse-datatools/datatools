...
public class ExpressionArgumentsImpl extends EObjectImpl implements ExpressionArguments {
	 ...
	 * @ordered
	 */
	protected ExpressionParameters expressionParameters;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetExpressionParameters(ExpressionParameters newExpressionParameters,
			NotificationChain msgs) {
		ExpressionParameters oldExpressionParameters = expressionParameters;
		expressionParameters = newExpressionParameters;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DesignPackage.EXPRESSION_ARGUMENTS__EXPRESSION_PARAMETERS, oldExpressionParameters,
					newExpressionParameters);
			if (msgs == null) {
				msgs = notification;
			} else {
	 ...
	 */
	@Override
	public void setExpressionParameters(ExpressionParameters newExpressionParameters) {
		if (newExpressionParameters != expressionParameters) {
			NotificationChain msgs = null;
			if (expressionParameters != null) {
				msgs = ((InternalEObject) expressionParameters).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DesignPackage.EXPRESSION_ARGUMENTS__EXPRESSION_PARAMETERS, null, msgs);
			}
			if (newExpressionParameters != null) {
				msgs = ((InternalEObject) newExpressionParameters).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - DesignPackage.EXPRESSION_ARGUMENTS__EXPRESSION_PARAMETERS, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					DesignPackage.EXPRESSION_ARGUMENTS__EXPRESSION_PARAMETERS, newExpressionParameters,
					newExpressionParameters));
		}
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case DesignPackage.EXPRESSION_ARGUMENTS__EXPRESSION_PARAMETERS:
			return expressionParameters != null;
		}
