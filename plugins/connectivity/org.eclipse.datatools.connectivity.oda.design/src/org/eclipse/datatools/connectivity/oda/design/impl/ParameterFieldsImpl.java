...
public class ParameterFieldsImpl extends EObjectImpl implements ParameterFields {
	 ...
	 * @ordered
	 */
	protected EList<ParameterFieldDefinition> fieldCollection;
	...
	public EList<ParameterFieldDefinition> getFieldCollection() {
		if (fieldCollection == null) {
			fieldCollection = new EObjectContainmentEList<>(ParameterFieldDefinition.class,
					this, DesignPackage.PARAMETER_FIELDS__FIELD_COLLECTION);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case DesignPackage.PARAMETER_FIELDS__FIELD_COLLECTION:
			...
			getFieldCollection().addAll((Collection<? extends ParameterFieldDefinition>) newValue);
			return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case DesignPackage.PARAMETER_FIELDS__FIELD_COLLECTION:
			return fieldCollection != null && !fieldCollection.isEmpty();
		}
