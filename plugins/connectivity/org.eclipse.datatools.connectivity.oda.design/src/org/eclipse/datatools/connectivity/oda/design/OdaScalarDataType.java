...
public enum OdaScalarDataType implements Enumerator {
	 ...
	 * @generated
	 */
	private static final OdaScalarDataType[] VALUES_ARRAY = new OdaScalarDataType[] { DATE_LITERAL, DOUBLE_LITERAL,
			INTEGER_LITERAL, STRING_LITERAL, TIME_LITERAL, TIMESTAMP_LITERAL, DECIMAL_LITERAL, BLOB_LITERAL,
	 ...
	 * @generated
	 */
	public static final List<OdaScalarDataType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	...
	public static OdaScalarDataType get(String literal) {
		for (OdaScalarDataType result : VALUES_ARRAY) {
