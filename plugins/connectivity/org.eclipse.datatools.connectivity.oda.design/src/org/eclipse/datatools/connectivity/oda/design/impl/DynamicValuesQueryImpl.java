...
public class DynamicValuesQueryImpl extends EObjectImpl implements DynamicValuesQuery {
	 ...
	 * @ordered
	 */
	protected DataElementIdentifier valueColumnIdentifier;
	 ...
	 * @ordered
	 */
	protected String displayNameColumn = DISPLAY_NAME_COLUMN_EDEFAULT;
	...
	public NotificationChain basicSetDataSetDesign(DataSetDesign newDataSetDesign, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DesignPackage.DYNAMIC_VALUES_QUERY__DATA_SET_DESIGN, oldDataSetDesign, newDataSetDesign);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newDataSetDesign != dataSetDesign) {
			...
			if (dataSetDesign != null) {
				msgs = ((InternalEObject) dataSetDesign).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DesignPackage.DYNAMIC_VALUES_QUERY__DATA_SET_DESIGN, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.DYNAMIC_VALUES_QUERY__DATA_SET_DESIGN,
	...
	public void setEnabled(boolean newEnabled) {
		...
		enabledESet = true;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.DYNAMIC_VALUES_QUERY__ENABLED,
	...
	public void unsetEnabled() {
		...
		enabledESet = false;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.UNSET, DesignPackage.DYNAMIC_VALUES_QUERY__ENABLED,
	 ...
	 * @generated
	 */
	public NotificationChain basicSetValueColumnIdentifier(DataElementIdentifier newValueColumnIdentifier,
			NotificationChain msgs) {
		DataElementIdentifier oldValueColumnIdentifier = valueColumnIdentifier;
		valueColumnIdentifier = newValueColumnIdentifier;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DesignPackage.DYNAMIC_VALUES_QUERY__VALUE_COLUMN_IDENTIFIER, oldValueColumnIdentifier,
					newValueColumnIdentifier);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
	 ...
	 */
	@Override
	public void setValueColumnIdentifier(DataElementIdentifier newValueColumnIdentifier) {
		if (newValueColumnIdentifier != valueColumnIdentifier) {
			NotificationChain msgs = null;
			if (valueColumnIdentifier != null) {
				msgs = ((InternalEObject) valueColumnIdentifier).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DesignPackage.DYNAMIC_VALUES_QUERY__VALUE_COLUMN_IDENTIFIER, null,
						msgs);
			}
			if (newValueColumnIdentifier != null) {
				msgs = ((InternalEObject) newValueColumnIdentifier).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - DesignPackage.DYNAMIC_VALUES_QUERY__VALUE_COLUMN_IDENTIFIER, null,
						msgs);
			}
			msgs = basicSetValueColumnIdentifier(newValueColumnIdentifier, msgs);
			if (msgs != null) {
				msgs.dispatch();
			}
		} else if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET,
					DesignPackage.DYNAMIC_VALUES_QUERY__VALUE_COLUMN_IDENTIFIER, newValueColumnIdentifier,
					newValueColumnIdentifier));
		}
	}
	...
	protected void setValueColumnGen(String newValueColumn) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.DYNAMIC_VALUES_QUERY__VALUE_COLUMN,
	...
	public void setDisplayNameColumn(String newDisplayNameColumn) {
		String oldDisplayNameColumn = displayNameColumn;
		displayNameColumn = newDisplayNameColumn;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET,
					DesignPackage.DYNAMIC_VALUES_QUERY__DISPLAY_NAME_COLUMN, oldDisplayNameColumn, displayNameColumn));
		}
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case DesignPackage.DYNAMIC_VALUES_QUERY__ENABLED:
			return isSetEnabled();
		case DesignPackage.DYNAMIC_VALUES_QUERY__VALUE_COLUMN_IDENTIFIER:
			return valueColumnIdentifier != null;
		case DesignPackage.DYNAMIC_VALUES_QUERY__VALUE_COLUMN:
			return VALUE_COLUMN_EDEFAULT == null ? valueColumn != null : !VALUE_COLUMN_EDEFAULT.equals(valueColumn);
		case DesignPackage.DYNAMIC_VALUES_QUERY__DISPLAY_NAME_COLUMN:
			return DISPLAY_NAME_COLUMN_EDEFAULT == null ? displayNameColumn != null
					: !DISPLAY_NAME_COLUMN_EDEFAULT.equals(displayNameColumn);
		}
	...
	public String toString() {
		...
		result.append(displayNameColumn);
		result.append(')');
