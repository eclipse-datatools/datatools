...
public class InputParameterAttributesImpl extends EObjectImpl implements InputParameterAttributes {
	 ...
	 * @ordered
	 */
	protected InputParameterUIHints uiHints;
	...
	public NotificationChain basicSetElementAttributes(InputElementAttributes newElementAttributes,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DesignPackage.INPUT_PARAMETER_ATTRIBUTES__ELEMENT_ATTRIBUTES, oldElementAttributes,
		...
		if (newElementAttributes != elementAttributes) {
			...
			if (elementAttributes != null) {
				msgs = ((InternalEObject) elementAttributes).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DesignPackage.INPUT_PARAMETER_ATTRIBUTES__ELEMENT_ATTRIBUTES, null,
						msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					DesignPackage.INPUT_PARAMETER_ATTRIBUTES__ELEMENT_ATTRIBUTES, newElementAttributes,
					newElementAttributes));
		}
	}
	...
	public NotificationChain basicSetUiHints(InputParameterUIHints newUiHints, NotificationChain msgs) {
		InputParameterUIHints oldUiHints = uiHints;
		uiHints = newUiHints;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DesignPackage.INPUT_PARAMETER_ATTRIBUTES__UI_HINTS, oldUiHints, newUiHints);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
		...
		if (newUiHints != uiHints) {
			...
			if (uiHints != null) {
				msgs = ((InternalEObject) uiHints).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DesignPackage.INPUT_PARAMETER_ATTRIBUTES__UI_HINTS, null, msgs);
			}
			if (newUiHints != null) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.INPUT_PARAMETER_ATTRIBUTES__UI_HINTS,
