...
public class SortSpecificationImpl extends EObjectImpl implements SortSpecification {
	 ...
	 * @ordered
	 */
	protected EList<SortKey> sortKeys;
	...
	public EList<SortKey> getSortKeys() {
		if (sortKeys == null) {
			sortKeys = new EObjectContainmentEList<>(SortKey.class, this,
					DesignPackage.SORT_SPECIFICATION__SORT_KEYS);
		}
		return sortKeys;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case DesignPackage.SORT_SPECIFICATION__SORT_KEYS:
			return ((InternalEList<?>) getSortKeys()).basicRemove(otherEnd, msgs);
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case DesignPackage.SORT_SPECIFICATION__SORT_KEYS:
			return sortKeys != null && !sortKeys.isEmpty();
		}
