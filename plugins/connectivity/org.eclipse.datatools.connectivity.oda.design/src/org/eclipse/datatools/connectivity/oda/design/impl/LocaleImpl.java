...
public class LocaleImpl extends EObjectImpl implements Locale {
	...
	public ULocale getLocale() {
		...
		return new ULocale(getLanguageGen(), toNonNullString(getCountry()), toNonNullString(getVariant()));
	}
	...
	private boolean hasLanguage() {
		return (isSetLanguage() && getLanguageGen() != null && getLanguageGen().length() != 0);
	}
	...
	public void setLanguage(String newLanguage) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.LOCALE__LANGUAGE, oldLanguage, language,
					!oldLanguageESet));
		}
	}
	...
	public void unsetLanguage() {
		...
		languageESet = false;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.UNSET, DesignPackage.LOCALE__LANGUAGE, oldLanguage,
	...
	public void setCountry(String newCountry) {
		...
		country = newCountry;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.LOCALE__COUNTRY, oldCountry, country));
		}
	}
	...
	public void setVariant(String newVariant) {
		...
		variant = newVariant;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.LOCALE__VARIANT, oldVariant, variant));
		}
	}
