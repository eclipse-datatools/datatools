...
public class DataElementUIHintsImpl extends EObjectImpl implements DataElementUIHints {
	...
	protected void setDisplayNameGen(String newDisplayName) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.DATA_ELEMENT_UI_HINTS__DISPLAY_NAME,
	...
	protected void setDescriptionGen(String newDescription) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.DATA_ELEMENT_UI_HINTS__DESCRIPTION,
