...
public enum ExpressionVariableType implements Enumerator {
	 ...
	 * @generated
	 */
	private static final ExpressionVariableType[] VALUES_ARRAY = new ExpressionVariableType[] { RESULT_SET_COLUMN,
			INSTANCE_OF, QUERY_EXPRESSION, };
	...
	public static ExpressionVariableType get(String literal) {
		for (ExpressionVariableType result : VALUES_ARRAY) {
