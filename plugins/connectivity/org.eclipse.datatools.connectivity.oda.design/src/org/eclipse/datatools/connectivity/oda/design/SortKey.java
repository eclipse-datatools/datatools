...
public interface SortKey extends EObject {
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * Deprecated as of 3.3.2; replaced by "columnIdentifier".  The unique name of a result set column. It must reference one of the columns associated with the same ResultSetDefinition.  If a column can only be identified by position, this name may be empty.
	 * <!-- end-model-doc -->
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * Deprecated as of 3.3.2; replaced by "columnIdentifier".  The 1-based index position (left-to-right order) of a result set column.
	 * <!-- end-model-doc -->
