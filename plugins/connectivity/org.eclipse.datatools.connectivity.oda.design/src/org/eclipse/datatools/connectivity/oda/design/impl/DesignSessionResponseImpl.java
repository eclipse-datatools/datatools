...
public class DesignSessionResponseImpl extends EObjectImpl implements DesignSessionResponse {
	 ...
	 * @ordered
	 */
	protected SessionStatus sessionStatus = SESSION_STATUS_EDEFAULT;
	 ...
	 * @ordered
	 */
	protected boolean sessionStatusESet;
	...
	public void setSessionStatus(SessionStatus newSessionStatus) {
		...
		sessionStatus = newSessionStatus == null ? SESSION_STATUS_EDEFAULT : newSessionStatus;
		boolean oldSessionStatusESet = sessionStatusESet;
		sessionStatusESet = true;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.DESIGN_SESSION_RESPONSE__SESSION_STATUS,
					oldSessionStatus, sessionStatus, !oldSessionStatusESet));
		}
	}
	...
	public void unsetSessionStatus() {
		SessionStatus oldSessionStatus = sessionStatus;
		boolean oldSessionStatusESet = sessionStatusESet;
		sessionStatus = SESSION_STATUS_EDEFAULT;
		sessionStatusESet = false;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					DesignPackage.DESIGN_SESSION_RESPONSE__SESSION_STATUS, oldSessionStatus, SESSION_STATUS_EDEFAULT,
	...
	public NotificationChain basicSetDataAccessDesign(DataAccessDesign newDataAccessDesign, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DesignPackage.DESIGN_SESSION_RESPONSE__DATA_ACCESS_DESIGN, oldDataAccessDesign,
					newDataAccessDesign);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newDataAccessDesign != dataAccessDesign) {
			...
			if (dataAccessDesign != null) {
				msgs = ((InternalEObject) dataAccessDesign).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DesignPackage.DESIGN_SESSION_RESPONSE__DATA_ACCESS_DESIGN, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					DesignPackage.DESIGN_SESSION_RESPONSE__DATA_ACCESS_DESIGN, newDataAccessDesign,
					newDataAccessDesign));
		}
	}
	...
	public NotificationChain basicSetDesignerState(DesignerState newDesignerState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DesignPackage.DESIGN_SESSION_RESPONSE__DESIGNER_STATE, oldDesignerState, newDesignerState);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
		...
		if (newDesignerState != designerState) {
			...
			if (designerState != null) {
				msgs = ((InternalEObject) designerState).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DesignPackage.DESIGN_SESSION_RESPONSE__DESIGNER_STATE, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.DESIGN_SESSION_RESPONSE__DESIGNER_STATE,
