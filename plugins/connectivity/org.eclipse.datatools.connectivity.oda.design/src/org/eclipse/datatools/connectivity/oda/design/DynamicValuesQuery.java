...
public interface DynamicValuesQuery extends EObject {
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * Deprecated as of 3.3.2; replaced by "valueColumnIdentifier".  The result set column name whose values are retrieved as the value choices.  This attribute must be one of the column names defined in the data set design's primary result set.
	 * <!-- end-model-doc -->
