...
public class DesignAdapterFactory extends AdapterFactoryImpl {
	...
	protected DesignSwitch<Adapter> modelSwitch = new DesignSwitch<Adapter>() {
		...
		@Override
		public Adapter caseAtomicExpressionContext(AtomicExpressionContext object) {
		...
		@Override
		public Adapter caseCompositeFilterExpression(CompositeFilterExpression object) {
		...
		@Override
		public Adapter caseDynamicFilterExpression(DynamicFilterExpression object) {
		...
		@Override
		public Adapter caseExpressionParameterDefinition(ExpressionParameterDefinition object) {
		...
		@Override
		public Adapter caseInputParameterAttributes(InputParameterAttributes object) {
		...
		@Override
		public Adapter caseOutputElementAttributes(OutputElementAttributes object) {
		...
		@Override
		public Adapter caseParameterFieldDefinition(ParameterFieldDefinition object) {
