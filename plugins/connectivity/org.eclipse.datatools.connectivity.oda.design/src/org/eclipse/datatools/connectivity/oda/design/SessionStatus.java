...
public enum SessionStatus implements Enumerator {
	 ...
	 * @generated
	 */
	private static final SessionStatus[] VALUES_ARRAY = new SessionStatus[] { OK_LITERAL, USER_CANCELLED_LITERAL,
			LOGIN_FAILED_LITERAL, ERROR_LITERAL, };
	...
	public static SessionStatus get(String literal) {
		for (SessionStatus result : VALUES_ARRAY) {
