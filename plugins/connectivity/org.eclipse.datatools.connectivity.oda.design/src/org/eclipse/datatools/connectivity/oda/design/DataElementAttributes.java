...
public interface DataElementAttributes extends EObject {
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * Deprecated as of 3.3.2; replaced by "identifier".  A name that uniquely identifies this data element.  If a data element can only be identified by position, this name may be empty.
	 * <!-- end-model-doc -->
