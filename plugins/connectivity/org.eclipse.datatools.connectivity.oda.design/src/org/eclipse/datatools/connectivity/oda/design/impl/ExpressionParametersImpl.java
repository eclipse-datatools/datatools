 ...
 * @generated
 */
public class ExpressionParametersImpl extends EObjectImpl implements ExpressionParameters {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @ordered
	 */
	protected EList<ExpressionParameterDefinition> parameterDefinitions;
	...
	public EList<ExpressionParameterDefinition> getParameterDefinitions() {
		if (parameterDefinitions == null) {
			parameterDefinitions = new EObjectContainmentEList<>(
	...
	public void eSet(int featureID, Object newValue) {
		...
		case DesignPackage.EXPRESSION_PARAMETERS__PARAMETER_DEFINITIONS:
			...
			getParameterDefinitions().addAll((Collection<? extends ExpressionParameterDefinition>) newValue);
			return;
		}
