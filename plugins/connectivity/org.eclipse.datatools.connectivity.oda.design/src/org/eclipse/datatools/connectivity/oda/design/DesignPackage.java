...
public interface DesignPackage extends EPackage {
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EClass ATOMIC_EXPRESSION_CONTEXT = eINSTANCE.getAtomicExpressionContext();
		 ...
		 * @generated
		 */
		EAttribute ATOMIC_EXPRESSION_CONTEXT__OPTIONAL = eINSTANCE.getAtomicExpressionContext_Optional();
		 ...
		 * @generated
		 */
		EReference ATOMIC_EXPRESSION_CONTEXT__VARIABLE = eINSTANCE.getAtomicExpressionContext_Variable();
		 ...
		 * @generated
		 */
		EReference ATOMIC_EXPRESSION_CONTEXT__ARGUMENTS = eINSTANCE.getAtomicExpressionContext_Arguments();
		 ...
		 * @generated
		 */
		EAttribute AXIS_ATTRIBUTES__AXIS_TYPE = eINSTANCE.getAxisAttributes_AxisType();
		 ...
		 * @generated
		 */
		EAttribute AXIS_ATTRIBUTES__ON_COLUMN_LAYOUT = eINSTANCE.getAxisAttributes_OnColumnLayout();
		 ...
		 * @generated
		 */
		EReference AXIS_ATTRIBUTES__RELATED_COLUMNS = eINSTANCE.getAxisAttributes_RelatedColumns();
		 ...
		 * @generated
		 */
		EReference COLUMN_DEFINITION__ATTRIBUTES = eINSTANCE.getColumnDefinition_Attributes();
		 ...
		 * @generated
		 */
		EReference COLUMN_DEFINITION__USAGE_HINTS = eINSTANCE.getColumnDefinition_UsageHints();
		 ...
		 * @generated
		 */
		EClass COMPOSITE_FILTER_EXPRESSION = eINSTANCE.getCompositeFilterExpression();
		 ...
		 * @generated
		 */
		EReference COMPOSITE_FILTER_EXPRESSION__CHILDREN = eINSTANCE.getCompositeFilterExpression_Children();
		 ...
		 * @generated
		 */
		EAttribute CUSTOM_DATA__PROVIDER_ID = eINSTANCE.getCustomData_ProviderId();
		 ...
		 * @generated
		 */
		EAttribute CUSTOM_DATA__DISPLAY_VALUE = eINSTANCE.getCustomData_DisplayValue();
		 ...
		 * @generated
		 */
		EReference CUSTOM_FILTER_EXPRESSION__TYPE = eINSTANCE.getCustomFilterExpression_Type();
		 ...
		 * @generated
		 */
		EReference CUSTOM_FILTER_EXPRESSION__CONTEXT = eINSTANCE.getCustomFilterExpression_Context();
		 ...
		 * @generated
		 */
		EReference DATA_ACCESS_DESIGN__DATA_SET_DESIGN = eINSTANCE.getDataAccessDesign_DataSetDesign();
		 ...
		 * @generated
		 */
		EReference DATA_ELEMENT_ATTRIBUTES__IDENTIFIER = eINSTANCE.getDataElementAttributes_Identifier();
		 ...
		 * @generated
		 */
		EAttribute DATA_ELEMENT_ATTRIBUTES__NAME = eINSTANCE.getDataElementAttributes_Name();
		 ...
		 * @generated
		 */
		EAttribute DATA_ELEMENT_ATTRIBUTES__POSITION = eINSTANCE.getDataElementAttributes_Position();
		 ...
		 * @generated
		 */
		EAttribute DATA_ELEMENT_ATTRIBUTES__PRECISION = eINSTANCE.getDataElementAttributes_Precision();
		 ...
		 * @generated
		 */
		EAttribute DATA_ELEMENT_ATTRIBUTES__SCALE = eINSTANCE.getDataElementAttributes_Scale();
		 ...
		 * @generated
		 */
		EAttribute DATA_ELEMENT_ATTRIBUTES__NULLABILITY = eINSTANCE.getDataElementAttributes_Nullability();
		 ...
		 * @generated
		 */
		EReference DATA_ELEMENT_ATTRIBUTES__UI_HINTS = eINSTANCE.getDataElementAttributes_UiHints();
		 ...
		 * @generated
		 */
		EAttribute DATA_ELEMENT_IDENTIFIER__NAME = eINSTANCE.getDataElementIdentifier_Name();
		 ...
		 * @generated
		 */
		EAttribute DATA_ELEMENT_IDENTIFIER__POSITION = eINSTANCE.getDataElementIdentifier_Position();
		 ...
		 * @generated
		 */
		EReference DATA_ELEMENT_IDENTIFIERS__IDENTIFIERS = eINSTANCE.getDataElementIdentifiers_Identifiers();
		 ...
		 * @generated
		 */
		EAttribute DATA_ELEMENT_UI_HINTS__DISPLAY_NAME = eINSTANCE.getDataElementUIHints_DisplayName();
		 ...
		 * @generated
		 */
		EAttribute DATA_ELEMENT_UI_HINTS__DESCRIPTION = eINSTANCE.getDataElementUIHints_Description();
		 ...
		 * @generated
		 */
		EAttribute DATA_SET_DESIGN__ODA_EXTENSION_DATA_SET_ID = eINSTANCE.getDataSetDesign_OdaExtensionDataSetId();
		 ...
		 * @generated
		 */
		EReference DATA_SET_DESIGN__DATA_SOURCE_DESIGN = eINSTANCE.getDataSetDesign_DataSourceDesign();
		 ...
		 * @generated
		 */
		EAttribute DATA_SET_DESIGN__DISPLAY_NAME = eINSTANCE.getDataSetDesign_DisplayName();
		 ...
		 * @generated
		 */
		EReference DATA_SET_DESIGN__PUBLIC_PROPERTIES = eINSTANCE.getDataSetDesign_PublicProperties();
		 ...
		 * @generated
		 */
		EReference DATA_SET_DESIGN__PRIVATE_PROPERTIES = eINSTANCE.getDataSetDesign_PrivateProperties();
		 ...
		 * @generated
		 */
		EReference DATA_SET_DESIGN__RESULT_SETS = eINSTANCE.getDataSetDesign_ResultSets();
		 ...
		 * @generated
		 */
		EAttribute DATA_SET_DESIGN__PRIMARY_RESULT_SET_NAME = eINSTANCE.getDataSetDesign_PrimaryResultSetName();
		 ...
		 * @generated
		 */
		EReference DATA_SET_DESIGN__PARAMETERS = eINSTANCE.getDataSetDesign_Parameters();
		 ...
		 * @generated
		 */
		EReference DATA_SET_PARAMETERS__PARAMETER_DEFINITIONS = eINSTANCE.getDataSetParameters_ParameterDefinitions();
		 ...
		 * @generated
		 */
		EAttribute DATA_SET_PARAMETERS__DERIVED_META_DATA = eINSTANCE.getDataSetParameters_DerivedMetaData();
		 ...
		 * @generated
		 */
		EAttribute DATA_SET_QUERY__QUERY_TEXT = eINSTANCE.getDataSetQuery_QueryText();
		 ...
		 * @generated
		 */
		EAttribute DATA_SOURCE_DESIGN__NAME = eINSTANCE.getDataSourceDesign_Name();
		 ...
		 * @generated
		 */
		EAttribute DATA_SOURCE_DESIGN__ODA_EXTENSION_ID = eINSTANCE.getDataSourceDesign_OdaExtensionId();
		 ...
		 * @generated
		 */
		EAttribute DATA_SOURCE_DESIGN__DISPLAY_NAME = eINSTANCE.getDataSourceDesign_DisplayName();
		 ...
		 * @generated
		 */
		EReference DATA_SOURCE_DESIGN__PUBLIC_PROPERTIES = eINSTANCE.getDataSourceDesign_PublicProperties();
		 ...
		 * @generated
		 */
		EReference DATA_SOURCE_DESIGN__PRIVATE_PROPERTIES = eINSTANCE.getDataSourceDesign_PrivateProperties();
		 ...
		 * @generated
		 */
		EAttribute DATA_SOURCE_DESIGN__LINKED_PROFILE_NAME = eINSTANCE.getDataSourceDesign_LinkedProfileName();
		 ...
		 * @generated
		 */
		EAttribute DATA_SOURCE_DESIGN__RESOURCE_FILE = eINSTANCE.getDataSourceDesign_ResourceFile();
		 ...
		 * @generated
		 */
		EAttribute DESIGNER_STATE__VERSION = eINSTANCE.getDesignerState_Version();
		 ...
		 * @generated
		 */
		EReference DESIGNER_STATE__STATE_CONTENT = eINSTANCE.getDesignerState_StateContent();
		 ...
		 * @generated
		 */
		EReference DESIGN_SESSION_REQUEST__DATA_ACCESS_DESIGN = eINSTANCE.getDesignSessionRequest_DataAccessDesign();
		 ...
		 * @generated
		 */
		EAttribute DESIGN_SESSION_REQUEST__EDITABLE = eINSTANCE.getDesignSessionRequest_Editable();
		 ...
		 * @generated
		 */
		EReference DESIGN_SESSION_REQUEST__SESSION_LOCALE = eINSTANCE.getDesignSessionRequest_SessionLocale();
		 ...
		 * @generated
		 */
		EReference DESIGN_SESSION_REQUEST__DESIGNER_STATE = eINSTANCE.getDesignSessionRequest_DesignerState();
		 ...
		 * @generated
		 */
		EAttribute DESIGN_SESSION_RESPONSE__SESSION_STATUS = eINSTANCE.getDesignSessionResponse_SessionStatus();
		 ...
		 * @generated
		 */
		EReference DESIGN_SESSION_RESPONSE__DATA_ACCESS_DESIGN = eINSTANCE.getDesignSessionResponse_DataAccessDesign();
		 ...
		 * @generated
		 */
		EReference DESIGN_SESSION_RESPONSE__DESIGNER_STATE = eINSTANCE.getDesignSessionResponse_DesignerState();
		 ...
		 * @generated
		 */
		EReference DOCUMENT_ROOT__ODA_DESIGN_SESSION = eINSTANCE.getDocumentRoot_OdaDesignSession();
		 ...
		 * @generated
		 */
		EClass DYNAMIC_FILTER_EXPRESSION = eINSTANCE.getDynamicFilterExpression();
		 ...
		 * @generated
		 */
		EReference DYNAMIC_FILTER_EXPRESSION__CONTEXT = eINSTANCE.getDynamicFilterExpression_Context();
		 ...
		 * @generated
		 */
		EReference DYNAMIC_FILTER_EXPRESSION__DEFAULT_TYPE = eINSTANCE.getDynamicFilterExpression_DefaultType();
		 ...
		 * @generated
		 */
		EReference DYNAMIC_VALUES_QUERY__DATA_SET_DESIGN = eINSTANCE.getDynamicValuesQuery_DataSetDesign();
		 ...
		 * @generated
		 */
		EAttribute DYNAMIC_VALUES_QUERY__ENABLED = eINSTANCE.getDynamicValuesQuery_Enabled();
		 ...
		 * @generated
		 */
		EAttribute DYNAMIC_VALUES_QUERY__VALUE_COLUMN = eINSTANCE.getDynamicValuesQuery_ValueColumn();
		 ...
		 * @generated
		 */
		EAttribute DYNAMIC_VALUES_QUERY__DISPLAY_NAME_COLUMN = eINSTANCE.getDynamicValuesQuery_DisplayNameColumn();
		 ...
		 * @generated
		 */
		EClass EXPRESSION_PARAMETER_DEFINITION = eINSTANCE.getExpressionParameterDefinition();
		 ...
		 * @generated
		 */
		EAttribute EXPRESSION_VARIABLE__TYPE = eINSTANCE.getExpressionVariable_Type();
		 ...
		 * @generated
		 */
		EAttribute EXPRESSION_VARIABLE__IDENTIFIER = eINSTANCE.getExpressionVariable_Identifier();
		 ...
		 * @generated
		 */
		EAttribute EXPRESSION_VARIABLE__NATIVE_DATA_TYPE_CODE = eINSTANCE.getExpressionVariable_NativeDataTypeCode();
		 ...
		 * @generated
		 */
		EAttribute FILTER_EXPRESSION__NEGATABLE = eINSTANCE.getFilterExpression_Negatable();
		 ...
		 * @generated
		 */
		EAttribute FILTER_EXPRESSION_TYPE__ID = eINSTANCE.getFilterExpressionType_Id();
		 ...
		 * @generated
		 */
		EReference INPUT_ELEMENT_ATTRIBUTES__DEFAULT_VALUES = eINSTANCE.getInputElementAttributes_DefaultValues();
		 ...
		 * @generated
		 */
		EAttribute INPUT_ELEMENT_ATTRIBUTES__EDITABLE = eINSTANCE.getInputElementAttributes_Editable();
		 ...
		 * @generated
		 */
		EAttribute INPUT_ELEMENT_ATTRIBUTES__OPTIONAL = eINSTANCE.getInputElementAttributes_Optional();
		 ...
		 * @generated
		 */
		EAttribute INPUT_ELEMENT_ATTRIBUTES__MASKS_VALUE = eINSTANCE.getInputElementAttributes_MasksValue();
		 ...
		 * @generated
		 */
		EReference INPUT_ELEMENT_ATTRIBUTES__UI_HINTS = eINSTANCE.getInputElementAttributes_UiHints();
		 ...
		 * @generated
		 */
		EAttribute INPUT_ELEMENT_UI_HINTS__PROMPT_STYLE = eINSTANCE.getInputElementUIHints_PromptStyle();
		 ...
		 * @generated
		 */
		EClass INPUT_PARAMETER_ATTRIBUTES = eINSTANCE.getInputParameterAttributes();
		 ...
		 * @generated
		 */
		EReference INPUT_PARAMETER_ATTRIBUTES__UI_HINTS = eINSTANCE.getInputParameterAttributes_UiHints();
		 ...
		 * @generated
		 */
		EReference NOT_EXPRESSION__NEGATING_EXPRESSION = eINSTANCE.getNotExpression_NegatingExpression();
		 ...
		 * @generated
		 */
		EReference ODA_DESIGN_SESSION__REQUEST = eINSTANCE.getOdaDesignSession_Request();
		 ...
		 * @generated
		 */
		EReference ODA_DESIGN_SESSION__RESPONSE = eINSTANCE.getOdaDesignSession_Response();
		 ...
		 * @generated
		 */
		EClass OUTPUT_ELEMENT_ATTRIBUTES = eINSTANCE.getOutputElementAttributes();
		 ...
		 * @generated
		 */
		EAttribute OUTPUT_ELEMENT_ATTRIBUTES__LABEL = eINSTANCE.getOutputElementAttributes_Label();
		 ...
		 * @generated
		 */
		EReference OUTPUT_ELEMENT_ATTRIBUTES__FORMATTING_HINTS = eINSTANCE.getOutputElementAttributes_FormattingHints();
		 ...
		 * @generated
		 */
		EAttribute OUTPUT_ELEMENT_ATTRIBUTES__HELP_TEXT = eINSTANCE.getOutputElementAttributes_HelpText();
		 ...
		 * @generated
		 */
		EAttribute PARAMETER_DEFINITION__IN_OUT_MODE = eINSTANCE.getParameterDefinition_InOutMode();
		 ...
		 * @generated
		 */
		EReference PARAMETER_DEFINITION__ATTRIBUTES = eINSTANCE.getParameterDefinition_Attributes();
		 ...
		 * @generated
		 */
		EReference PARAMETER_DEFINITION__INPUT_ATTRIBUTES = eINSTANCE.getParameterDefinition_InputAttributes();
		 ...
		 * @generated
		 */
		EReference PARAMETER_DEFINITION__OUTPUT_USAGE_HINTS = eINSTANCE.getParameterDefinition_OutputUsageHints();
		 ...
		 * @generated
		 */
		EReference PARAMETER_DEFINITION__FIELDS = eINSTANCE.getParameterDefinition_Fields();
		 ...
		 * @generated
		 */
		EClass PARAMETER_FIELD_DEFINITION = eINSTANCE.getParameterFieldDefinition();
		 ...
		 * @generated
		 */
		EReference PARAMETER_FIELD_DEFINITION__ATTRIBUTES = eINSTANCE.getParameterFieldDefinition_Attributes();
		 ...
		 * @generated
		 */
		EReference PARAMETER_FIELDS__FIELD_COLLECTION = eINSTANCE.getParameterFields_FieldCollection();
		 ...
		 * @generated
		 */
		EReference PROPERTY__DESIGN_ATTRIBUTES = eINSTANCE.getProperty_DesignAttributes();
		 ...
		 * @generated
		 */
		EAttribute PROPERTY_ATTRIBUTES__DISPLAY_NAME = eINSTANCE.getPropertyAttributes_DisplayName();
		 ...
		 * @generated
		 */
		EReference PROPERTY_ATTRIBUTES__ELEMENT_ATTRIBUTES = eINSTANCE.getPropertyAttributes_ElementAttributes();
		 ...
		 * @generated
		 */
		EAttribute PROPERTY_ATTRIBUTES__DERIVED_META_DATA = eINSTANCE.getPropertyAttributes_DerivedMetaData();
		 ...
		 * @generated
		 */
		EReference RESULT_SET_CRITERIA__FILTER_SPECIFICATION = eINSTANCE.getResultSetCriteria_FilterSpecification();
		 ...
		 * @generated
		 */
		EReference RESULT_SET_CRITERIA__ROW_ORDERING = eINSTANCE.getResultSetCriteria_RowOrdering();
		 ...
		 * @generated
		 */
		EAttribute RESULT_SET_DEFINITION__NAME = eINSTANCE.getResultSetDefinition_Name();
		 ...
		 * @generated
		 */
		EReference RESULT_SET_DEFINITION__RESULT_SET_COLUMNS = eINSTANCE.getResultSetDefinition_ResultSetColumns();
		 ...
		 * @generated
		 */
		EReference RESULT_SET_DEFINITION__CRITERIA = eINSTANCE.getResultSetDefinition_Criteria();
		 ...
		 * @generated
		 */
		EReference RESULT_SETS__RESULT_SET_DEFINITIONS = eINSTANCE.getResultSets_ResultSetDefinitions();
		 ...
		 * @generated
		 */
		EAttribute RESULT_SETS__DERIVED_META_DATA = eINSTANCE.getResultSets_DerivedMetaData();
		 ...
		 * @generated
		 */
		EReference RESULT_SUBSET__DATA_SET_DESIGN = eINSTANCE.getResultSubset_DataSetDesign();
		 ...
		 * @generated
		 */
		EAttribute RESULT_SUBSET__RESULT_SET_NAME = eINSTANCE.getResultSubset_ResultSetName();
		 ...
		 * @generated
		 */
		EReference RESULT_SUBSET__COLUMN_IDENTIFIERS = eINSTANCE.getResultSubset_ColumnIdentifiers();
		 ...
		 * @generated
		 */
		EReference SCALAR_VALUE_CHOICES__SCALAR_VALUES = eINSTANCE.getScalarValueChoices_ScalarValues();
		 ...
		 * @generated
		 */
		EAttribute SCALAR_VALUE_DEFINITION__VALUE = eINSTANCE.getScalarValueDefinition_Value();
		 ...
		 * @generated
		 */
		EAttribute SCALAR_VALUE_DEFINITION__DISPLAY_NAME = eINSTANCE.getScalarValueDefinition_DisplayName();
		 ...
		 * @generated
		 */
		EReference SORT_KEY__COLUMN_IDENTIFIER = eINSTANCE.getSortKey_ColumnIdentifier();
		 ...
		 * @generated
		 */
		EAttribute SORT_KEY__COLUMN_POSITION = eINSTANCE.getSortKey_ColumnPosition();
		 ...
		 * @generated
		 */
		EAttribute SORT_KEY__SORT_DIRECTION = eINSTANCE.getSortKey_SortDirection();
		 ...
		 * @generated
		 */
		EAttribute SORT_KEY__NULL_VALUE_ORDERING = eINSTANCE.getSortKey_NullValueOrdering();
		 ...
		 * @generated
		 */
		EReference SORT_SPECIFICATION__SORT_KEYS = eINSTANCE.getSortSpecification_SortKeys();
		 ...
		 * @generated
		 */
		EAttribute VALUE_FORMAT_HINTS__DISPLAY_SIZE = eINSTANCE.getValueFormatHints_DisplaySize();
		 ...
		 * @generated
		 */
		EAttribute VALUE_FORMAT_HINTS__DISPLAY_FORMAT = eINSTANCE.getValueFormatHints_DisplayFormat();
		 ...
		 * @generated
		 */
		EAttribute VALUE_FORMAT_HINTS__TEXT_FORMAT_TYPE = eINSTANCE.getValueFormatHints_TextFormatType();
		 ...
		 * @generated
		 */
		EAttribute VALUE_FORMAT_HINTS__HORIZONTAL_ALIGNMENT = eINSTANCE.getValueFormatHints_HorizontalAlignment();
		 ...
		 * @generated
		 */
		EAttribute VALUE_FORMAT_HINTS__TEXT_WRAP_TYPE = eINSTANCE.getValueFormatHints_TextWrapType();
		 ...
		 * @generated
		 */
		EEnum INPUT_PROMPT_CONTROL_STYLE = eINSTANCE.getInputPromptControlStyle();
		 ...
		 * @generated
		 */
		EDataType ELEMENT_NULLABILITY_OBJECT = eINSTANCE.getElementNullabilityObject();
		 ...
		 * @generated
		 */
		EDataType EXPRESSION_VARIABLE_TYPE_OBJECT = eINSTANCE.getExpressionVariableTypeObject();
		 ...
		 * @generated
		 */
		EDataType INPUT_PROMPT_CONTROL_STYLE_OBJECT = eINSTANCE.getInputPromptControlStyleObject();
		 ...
		 * @generated
		 */
		EDataType NULL_ORDERING_TYPE_OBJECT = eINSTANCE.getNullOrderingTypeObject();
		 ...
		 * @generated
		 */
		EDataType ODA_COMPLEX_DATA_TYPE_OBJECT = eINSTANCE.getOdaComplexDataTypeObject();
		 ...
		 * @generated
		 */
		EDataType ODA_SCALAR_DATA_TYPE_OBJECT = eINSTANCE.getOdaScalarDataTypeObject();
