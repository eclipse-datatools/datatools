 ...
 * @generated
 */
public class CompositeFilterExpressionImpl extends FilterExpressionImpl implements CompositeFilterExpression {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @ordered
	 */
	protected EList<FilterExpression> children;
	...
	public EList<FilterExpression> getChildren() {
		if (children == null) {
			children = new EObjectContainmentEList<>(FilterExpression.class, this,
	...
	public void eSet(int featureID, Object newValue) {
		...
		case DesignPackage.COMPOSITE_FILTER_EXPRESSION__CHILDREN:
			getChildren().clear();
			getChildren().addAll((Collection<? extends FilterExpression>) newValue);
			return;
		}
