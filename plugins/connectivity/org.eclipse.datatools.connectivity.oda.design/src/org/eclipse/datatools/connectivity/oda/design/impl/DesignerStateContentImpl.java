...
public class DesignerStateContentImpl extends EObjectImpl implements DesignerStateContent {
	 ...
	 * @ordered
	 */
	protected String stateContentAsString = STATE_CONTENT_AS_STRING_EDEFAULT;
	 ...
	 * @ordered
	 */
	protected byte[] stateContentAsBlob = STATE_CONTENT_AS_BLOB_EDEFAULT;
	...
	private void setStateContentAsStringGen(String newStateContentAsString) {
		String oldStateContentAsString = stateContentAsString;
		stateContentAsString = newStateContentAsString;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET,
					DesignPackage.DESIGNER_STATE_CONTENT__STATE_CONTENT_AS_STRING, oldStateContentAsString,
	...
	private void setStateContentAsBlobGen(byte[] newStateContentAsBlob) {
		byte[] oldStateContentAsBlob = stateContentAsBlob;
		stateContentAsBlob = newStateContentAsBlob;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET,
					DesignPackage.DESIGNER_STATE_CONTENT__STATE_CONTENT_AS_BLOB, oldStateContentAsBlob,
					stateContentAsBlob));
		}
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case DesignPackage.DESIGNER_STATE_CONTENT__STATE_CONTENT_AS_STRING:
			return STATE_CONTENT_AS_STRING_EDEFAULT == null ? stateContentAsString != null
					: !STATE_CONTENT_AS_STRING_EDEFAULT.equals(stateContentAsString);
		case DesignPackage.DESIGNER_STATE_CONTENT__STATE_CONTENT_AS_BLOB:
			return STATE_CONTENT_AS_BLOB_EDEFAULT == null ? stateContentAsBlob != null
					: !STATE_CONTENT_AS_BLOB_EDEFAULT.equals(stateContentAsBlob);
		}
	...
	public String toString() {
		...
		result.append(stateContentAsString);
		result.append(", stateContentAsBlob: "); //$NON-NLS-1$
		result.append(stateContentAsBlob);
		result.append(')');
