...
public class ExpressionVariableImpl extends EObjectImpl implements ExpressionVariable {
	 ...
	 * @ordered
	 */
	protected ExpressionVariableType type = TYPE_EDEFAULT;
	...
	public void setType(ExpressionVariableType newType) {
		ExpressionVariableType oldType = type;
		type = newType == null ? TYPE_EDEFAULT : newType;
		boolean oldTypeESet = typeESet;
		typeESet = true;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.EXPRESSION_VARIABLE__TYPE, oldType,
					type, !oldTypeESet));
		}
	}
	...
	public void unsetType() {
		...
		typeESet = false;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.UNSET, DesignPackage.EXPRESSION_VARIABLE__TYPE, oldType,
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.EXPRESSION_VARIABLE__IDENTIFIER,
	...
	public void setNativeDataTypeCode(int newNativeDataTypeCode) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET,
					DesignPackage.EXPRESSION_VARIABLE__NATIVE_DATA_TYPE_CODE, oldNativeDataTypeCode, nativeDataTypeCode,
	...
	public void unsetNativeDataTypeCode() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					DesignPackage.EXPRESSION_VARIABLE__NATIVE_DATA_TYPE_CODE, oldNativeDataTypeCode,
