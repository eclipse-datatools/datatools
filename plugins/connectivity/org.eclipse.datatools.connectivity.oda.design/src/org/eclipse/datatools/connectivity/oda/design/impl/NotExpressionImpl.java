 ...
 * @generated
 */
public class NotExpressionImpl extends FilterExpressionImpl implements NotExpression {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @ordered
	 */
	protected FilterExpression negatingExpression;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetNegatingExpression(FilterExpression newNegatingExpression,
			NotificationChain msgs) {
		FilterExpression oldNegatingExpression = negatingExpression;
		negatingExpression = newNegatingExpression;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DesignPackage.NOT_EXPRESSION__NEGATING_EXPRESSION, oldNegatingExpression, newNegatingExpression);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public void setNegatingExpression(FilterExpression newNegatingExpression) {
		if (newNegatingExpression != negatingExpression) {
			NotificationChain msgs = null;
			if (negatingExpression != null) {
				msgs = ((InternalEObject) negatingExpression).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DesignPackage.NOT_EXPRESSION__NEGATING_EXPRESSION, null, msgs);
			}
			if (newNegatingExpression != null) {
				msgs = ((InternalEObject) newNegatingExpression).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - DesignPackage.NOT_EXPRESSION__NEGATING_EXPRESSION, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.NOT_EXPRESSION__NEGATING_EXPRESSION,
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case DesignPackage.NOT_EXPRESSION__NEGATING_EXPRESSION:
			return negatingExpression != null;
		}
