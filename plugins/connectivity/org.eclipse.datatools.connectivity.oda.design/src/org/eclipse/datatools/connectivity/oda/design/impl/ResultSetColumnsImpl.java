...
public class ResultSetColumnsImpl extends EObjectImpl implements ResultSetColumns {
	 ...
	 * @ordered
	 */
	protected EList<ColumnDefinition> resultColumnDefinitions;
	...
	public EList<ColumnDefinition> getResultColumnDefinitions() {
		if (resultColumnDefinitions == null) {
			resultColumnDefinitions = new EObjectContainmentEList<>(ColumnDefinition.class, this,
	...
	public void eSet(int featureID, Object newValue) {
		...
		case DesignPackage.RESULT_SET_COLUMNS__RESULT_COLUMN_DEFINITIONS:
			...
			getResultColumnDefinitions().addAll((Collection<? extends ColumnDefinition>) newValue);
			return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case DesignPackage.RESULT_SET_COLUMNS__RESULT_COLUMN_DEFINITIONS:
			return resultColumnDefinitions != null && !resultColumnDefinitions.isEmpty();
		}
