...
public class CustomDataImpl extends EObjectImpl implements CustomData {
	...
	public void setProviderId(String newProviderId) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.CUSTOM_DATA__PROVIDER_ID, oldProviderId,
					providerId));
		}
	}
	...
	public void setValue(Object newValue) {
		...
		value = newValue;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.CUSTOM_DATA__VALUE, oldValue, value));
		}
	}
	...
	public void setDisplayValue(String newDisplayValue) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.CUSTOM_DATA__DISPLAY_VALUE,
