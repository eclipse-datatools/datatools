...
public class NewInformixConnectionProfileWizard extends NewConnectionProfileWizard {
	...
	public void addCustomPages() {
		mPropPage = new InformixDBProfileDetailsWizardPage("detailsPage"); //$NON-NLS-1$
		addPage(mPropPage);
	}
