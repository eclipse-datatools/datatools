...
//	public static final String SYBASE_CATEGORY_ID = "com.sybase.stf.servers.jdbc.sybase"; //$NON-NLS-1$

//	public static final String PROP_PREFIX = "com.sybase.stf.servers.jdbc.sybase.asa.";//$NON-NLS-1$
...
//	public static final String PROP_DB_NAME = PROP_PREFIX + "dbName"; //$NON-NLS-1$
//	public static final String PROP_DRIVER_XACONNECTCLASS = PROP_PREFIX + "xaConnectClass"; //$NON-NLS-1$
	
	public static final String PROVIDER_ID = "org.eclipse.datatools.enablement.sybase.asa.connectionProfile"; //$NON-NLS-1$
}
