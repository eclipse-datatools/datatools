	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SQLDataTypesPackage.USER_DEFINED_TYPE: {
				...
				if (result == null) {
					result = caseSQLObject(userDefinedType);
				}
				if (result == null) {
					result = caseENamedElement(userDefinedType);
				}
				if (result == null) {
					result = caseEModelElement(userDefinedType);
				}
				if (result == null) {
			...
			case SQLDataTypesPackage.DATA_TYPE: {
				...
				if (result == null) {
					result = caseSQLObject(dataType);
				}
				if (result == null) {
					result = caseENamedElement(dataType);
				}
				if (result == null) {
			...
			case SQLDataTypesPackage.PREDEFINED_DATA_TYPE: {
				...
				if (result == null) {
					result = caseSQLDataType(predefinedDataType);
				}
				if (result == null) {
					result = caseDataType(predefinedDataType);
				}
				if (result == null) {
					result = caseSQLObject(predefinedDataType);
				}
				if (result == null) {
					result = caseENamedElement(predefinedDataType);
				}
				if (result == null) {
					result = caseEModelElement(predefinedDataType);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLDataTypesPackage.COLLECTION_DATA_TYPE: {
				...
				if (result == null) {
					result = caseConstructedDataType(collectionDataType);
				}
				if (result == null) {
					result = caseDataType(collectionDataType);
				}
				if (result == null) {
					result = caseSQLObject(collectionDataType);
				}
				if (result == null) {
					result = caseENamedElement(collectionDataType);
				}
				if (result == null) {
					result = caseEModelElement(collectionDataType);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLDataTypesPackage.NUMERICAL_DATA_TYPE: {
				...
				if (result == null) {
					result = casePredefinedDataType(numericalDataType);
				}
				if (result == null) {
					result = caseSQLDataType(numericalDataType);
				}
				if (result == null) {
					result = caseDataType(numericalDataType);
				}
				if (result == null) {
					result = caseSQLObject(numericalDataType);
				}
				if (result == null) {
					result = caseENamedElement(numericalDataType);
				}
				if (result == null) {
					result = caseEModelElement(numericalDataType);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLDataTypesPackage.CHARACTER_STRING_DATA_TYPE: {
				...
				if (result == null) {
					result = casePredefinedDataType(characterStringDataType);
				}
				if (result == null) {
					result = caseSQLDataType(characterStringDataType);
				}
				if (result == null) {
					result = caseDataType(characterStringDataType);
				}
				if (result == null) {
					result = caseSQLObject(characterStringDataType);
				}
				if (result == null) {
					result = caseENamedElement(characterStringDataType);
				}
				if (result == null) {
					result = caseEModelElement(characterStringDataType);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLDataTypesPackage.ROW_DATA_TYPE: {
				...
				if (result == null) {
					result = caseConstructedDataType(rowDataType);
				}
				if (result == null) {
					result = caseDataType(rowDataType);
				}
				if (result == null) {
					result = caseSQLObject(rowDataType);
				}
				if (result == null) {
					result = caseENamedElement(rowDataType);
				}
				if (result == null) {
					result = caseEModelElement(rowDataType);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLDataTypesPackage.ARRAY_DATA_TYPE: {
				...
				if (result == null) {
					result = caseCollectionDataType(arrayDataType);
				}
				if (result == null) {
					result = caseConstructedDataType(arrayDataType);
				}
				if (result == null) {
					result = caseDataType(arrayDataType);
				}
				if (result == null) {
					result = caseSQLObject(arrayDataType);
				}
				if (result == null) {
					result = caseENamedElement(arrayDataType);
				}
				if (result == null) {
					result = caseEModelElement(arrayDataType);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLDataTypesPackage.MULTISET_DATA_TYPE: {
				...
				if (result == null) {
					result = caseCollectionDataType(multisetDataType);
				}
				if (result == null) {
					result = caseConstructedDataType(multisetDataType);
				}
				if (result == null) {
					result = caseDataType(multisetDataType);
				}
				if (result == null) {
					result = caseSQLObject(multisetDataType);
				}
				if (result == null) {
					result = caseENamedElement(multisetDataType);
				}
				if (result == null) {
					result = caseEModelElement(multisetDataType);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLDataTypesPackage.BOOLEAN_DATA_TYPE: {
				...
				if (result == null) {
					result = casePredefinedDataType(booleanDataType);
				}
				if (result == null) {
					result = caseSQLDataType(booleanDataType);
				}
				if (result == null) {
					result = caseDataType(booleanDataType);
				}
				if (result == null) {
					result = caseSQLObject(booleanDataType);
				}
				if (result == null) {
					result = caseENamedElement(booleanDataType);
				}
				if (result == null) {
					result = caseEModelElement(booleanDataType);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLDataTypesPackage.INTERVAL_DATA_TYPE: {
				...
				if (result == null) {
					result = casePredefinedDataType(intervalDataType);
				}
				if (result == null) {
					result = caseSQLDataType(intervalDataType);
				}
				if (result == null) {
					result = caseDataType(intervalDataType);
				}
				if (result == null) {
					result = caseSQLObject(intervalDataType);
				}
				if (result == null) {
					result = caseENamedElement(intervalDataType);
				}
				if (result == null) {
					result = caseEModelElement(intervalDataType);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLDataTypesPackage.BINARY_STRING_DATA_TYPE: {
				...
				if (result == null) {
					result = casePredefinedDataType(binaryStringDataType);
				}
				if (result == null) {
					result = caseSQLDataType(binaryStringDataType);
				}
				if (result == null) {
					result = caseDataType(binaryStringDataType);
				}
				if (result == null) {
					result = caseSQLObject(binaryStringDataType);
				}
				if (result == null) {
					result = caseENamedElement(binaryStringDataType);
				}
				if (result == null) {
					result = caseEModelElement(binaryStringDataType);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLDataTypesPackage.CHARACTER_SET: {
				...
				if (result == null) {
					result = caseSQLObject(characterSet);
				}
				if (result == null) {
					result = caseENamedElement(characterSet);
				}
				if (result == null) {
					result = caseEModelElement(characterSet);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLDataTypesPackage.TIME_DATA_TYPE: {
				...
				if (result == null) {
					result = casePredefinedDataType(timeDataType);
				}
				if (result == null) {
					result = caseSQLDataType(timeDataType);
				}
				if (result == null) {
					result = caseDataType(timeDataType);
				}
				if (result == null) {
					result = caseSQLObject(timeDataType);
				}
				if (result == null) {
					result = caseENamedElement(timeDataType);
				}
				if (result == null) {
					result = caseEModelElement(timeDataType);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLDataTypesPackage.DISTINCT_USER_DEFINED_TYPE: {
				...
				if (result == null) {
					result = caseUserDefinedType(distinctUserDefinedType);
				}
				if (result == null) {
					result = caseDataType(distinctUserDefinedType);
				}
				if (result == null) {
					result = caseSQLObject(distinctUserDefinedType);
				}
				if (result == null) {
					result = caseENamedElement(distinctUserDefinedType);
				}
				if (result == null) {
					result = caseEModelElement(distinctUserDefinedType);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLDataTypesPackage.STRUCTURED_USER_DEFINED_TYPE: {
				...
				if (result == null) {
					result = caseUserDefinedType(structuredUserDefinedType);
				}
				if (result == null) {
					result = caseDataType(structuredUserDefinedType);
				}
				if (result == null) {
					result = caseSQLObject(structuredUserDefinedType);
				}
				if (result == null) {
					result = caseENamedElement(structuredUserDefinedType);
				}
				if (result == null) {
					result = caseEModelElement(structuredUserDefinedType);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLDataTypesPackage.ATTRIBUTE_DEFINITION: {
				...
				if (result == null) {
					result = caseTypedElement(attributeDefinition);
				}
				if (result == null) {
					result = caseSQLObject(attributeDefinition);
				}
				if (result == null) {
					result = caseENamedElement(attributeDefinition);
				}
				if (result == null) {
					result = caseEModelElement(attributeDefinition);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLDataTypesPackage.FIXED_PRECISION_DATA_TYPE: {
				...
				if (result == null) {
					result = caseExactNumericDataType(fixedPrecisionDataType);
				}
				if (result == null) {
					result = caseNumericalDataType(fixedPrecisionDataType);
				}
				if (result == null) {
					result = casePredefinedDataType(fixedPrecisionDataType);
				}
				if (result == null) {
					result = caseSQLDataType(fixedPrecisionDataType);
				}
				if (result == null) {
					result = caseDataType(fixedPrecisionDataType);
				}
				if (result == null) {
					result = caseSQLObject(fixedPrecisionDataType);
				}
				if (result == null) {
					result = caseENamedElement(fixedPrecisionDataType);
				}
				if (result == null) {
					result = caseEModelElement(fixedPrecisionDataType);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLDataTypesPackage.DOMAIN: {
				...
				if (result == null) {
					result = caseDistinctUserDefinedType(domain);
				}
				if (result == null) {
					result = caseUserDefinedType(domain);
				}
				if (result == null) {
					result = caseDataType(domain);
				}
				if (result == null) {
					result = caseSQLObject(domain);
				}
				if (result == null) {
					result = caseENamedElement(domain);
				}
				if (result == null) {
					result = caseEModelElement(domain);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLDataTypesPackage.FIELD: {
				...
				if (result == null) {
					result = caseSQLObject(field);
				}
				if (result == null) {
					result = caseENamedElement(field);
				}
				if (result == null) {
					result = caseEModelElement(field);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLDataTypesPackage.REFERENCE_DATA_TYPE: {
				...
				if (result == null) {
					result = caseConstructedDataType(referenceDataType);
				}
				if (result == null) {
					result = caseDataType(referenceDataType);
				}
				if (result == null) {
					result = caseSQLObject(referenceDataType);
				}
				if (result == null) {
					result = caseENamedElement(referenceDataType);
				}
				if (result == null) {
					result = caseEModelElement(referenceDataType);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLDataTypesPackage.CONSTRUCTED_DATA_TYPE: {
				...
				if (result == null) {
					result = caseDataType(constructedDataType);
				}
				if (result == null) {
					result = caseSQLObject(constructedDataType);
				}
				if (result == null) {
					result = caseENamedElement(constructedDataType);
				}
				if (result == null) {
					result = caseEModelElement(constructedDataType);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLDataTypesPackage.SQL_DATA_TYPE: {
				...
				if (result == null) {
					result = caseDataType(sqlDataType);
				}
				if (result == null) {
					result = caseSQLObject(sqlDataType);
				}
				if (result == null) {
					result = caseENamedElement(sqlDataType);
				}
				if (result == null) {
					result = caseEModelElement(sqlDataType);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLDataTypesPackage.DATA_LINK_DATA_TYPE: {
				...
				if (result == null) {
					result = casePredefinedDataType(dataLinkDataType);
				}
				if (result == null) {
					result = caseSQLDataType(dataLinkDataType);
				}
				if (result == null) {
					result = caseDataType(dataLinkDataType);
				}
				if (result == null) {
					result = caseSQLObject(dataLinkDataType);
				}
				if (result == null) {
					result = caseENamedElement(dataLinkDataType);
				}
				if (result == null) {
					result = caseEModelElement(dataLinkDataType);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLDataTypesPackage.USER_DEFINED_TYPE_ORDERING: {
				...
				if (result == null) {
					result = caseSQLObject(userDefinedTypeOrdering);
				}
				if (result == null) {
					result = caseENamedElement(userDefinedTypeOrdering);
				}
				if (result == null) {
					result = caseEModelElement(userDefinedTypeOrdering);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLDataTypesPackage.DATE_DATA_TYPE: {
				...
				if (result == null) {
					result = casePredefinedDataType(dateDataType);
				}
				if (result == null) {
					result = caseSQLDataType(dateDataType);
				}
				if (result == null) {
					result = caseDataType(dateDataType);
				}
				if (result == null) {
					result = caseSQLObject(dateDataType);
				}
				if (result == null) {
					result = caseENamedElement(dateDataType);
				}
				if (result == null) {
					result = caseEModelElement(dateDataType);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLDataTypesPackage.EXACT_NUMERIC_DATA_TYPE: {
				...
				if (result == null) {
					result = caseNumericalDataType(exactNumericDataType);
				}
				if (result == null) {
					result = casePredefinedDataType(exactNumericDataType);
				}
				if (result == null) {
					result = caseSQLDataType(exactNumericDataType);
				}
				if (result == null) {
					result = caseDataType(exactNumericDataType);
				}
				if (result == null) {
					result = caseSQLObject(exactNumericDataType);
				}
				if (result == null) {
					result = caseENamedElement(exactNumericDataType);
				}
				if (result == null) {
					result = caseEModelElement(exactNumericDataType);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLDataTypesPackage.APPROXIMATE_NUMERIC_DATA_TYPE: {
				...
				if (result == null) {
					result = caseNumericalDataType(approximateNumericDataType);
				}
				if (result == null) {
					result = casePredefinedDataType(approximateNumericDataType);
				}
				if (result == null) {
					result = caseSQLDataType(approximateNumericDataType);
				}
				if (result == null) {
					result = caseDataType(approximateNumericDataType);
				}
				if (result == null) {
					result = caseSQLObject(approximateNumericDataType);
				}
				if (result == null) {
					result = caseENamedElement(approximateNumericDataType);
				}
				if (result == null) {
					result = caseEModelElement(approximateNumericDataType);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLDataTypesPackage.INTEGER_DATA_TYPE: {
				...
				if (result == null) {
					result = caseExactNumericDataType(integerDataType);
				}
				if (result == null) {
					result = caseNumericalDataType(integerDataType);
				}
				if (result == null) {
					result = casePredefinedDataType(integerDataType);
				}
				if (result == null) {
					result = caseSQLDataType(integerDataType);
				}
				if (result == null) {
					result = caseDataType(integerDataType);
				}
				if (result == null) {
					result = caseSQLObject(integerDataType);
				}
				if (result == null) {
					result = caseENamedElement(integerDataType);
				}
				if (result == null) {
					result = caseEModelElement(integerDataType);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLDataTypesPackage.XML_DATA_TYPE: {
				...
				if (result == null) {
					result = casePredefinedDataType(xmlDataType);
				}
				if (result == null) {
					result = caseSQLDataType(xmlDataType);
				}
				if (result == null) {
					result = caseDataType(xmlDataType);
				}
				if (result == null) {
					result = caseSQLObject(xmlDataType);
				}
				if (result == null) {
					result = caseENamedElement(xmlDataType);
				}
				if (result == null) {
					result = caseEModelElement(xmlDataType);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLDataTypesPackage.ELEMENT_TYPE: {
				...
				if (result == null) {
					result = caseTypedElement(elementType);
				}
				if (result == null) {
					result = caseSQLObject(elementType);
				}
				if (result == null) {
