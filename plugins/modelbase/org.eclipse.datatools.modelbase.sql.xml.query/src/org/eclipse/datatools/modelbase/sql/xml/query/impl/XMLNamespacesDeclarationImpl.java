...
public class XMLNamespacesDeclarationImpl extends SQLQueryObjectImpl implements XMLNamespacesDeclaration {
	...
	public XMLValueFunctionElement getValueFunctionElement() {
		if (eContainerFeatureID() != SQLXMLQueryModelPackage.XML_NAMESPACES_DECLARATION__VALUE_FUNCTION_ELEMENT) {
			return null;
		}
	...
	public XMLValueFunctionForest getValueFunctionForest() {
		if (eContainerFeatureID() != SQLXMLQueryModelPackage.XML_NAMESPACES_DECLARATION__VALUE_FUNCTION_FOREST) {
			return null;
		}
		return (XMLValueFunctionForest)eInternalContainer();
	}
	...
	public XMLTableFunction getTableFunction() {
		if (eContainerFeatureID() != SQLXMLQueryModelPackage.XML_NAMESPACES_DECLARATION__TABLE_FUNCTION) {
			return null;
		}
