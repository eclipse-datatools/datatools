...
public class XMLQueryExpressionImpl extends SQLQueryObjectImpl implements XMLQueryExpression {
	...
	public XMLPredicateExists getPredicateExists() {
		if (eContainerFeatureID() != SQLXMLQueryModelPackage.XML_QUERY_EXPRESSION__PREDICATE_EXISTS) {
			return null;
		}
	...
	public XMLValueFunctionQuery getValueFunctionQuery() {
		if (eContainerFeatureID() != SQLXMLQueryModelPackage.XML_QUERY_EXPRESSION__VALUE_FUNCTION_QUERY) {
			return null;
		}
