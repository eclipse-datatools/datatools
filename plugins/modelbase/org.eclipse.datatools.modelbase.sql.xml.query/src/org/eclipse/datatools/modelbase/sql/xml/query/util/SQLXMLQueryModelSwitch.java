    ...
    protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SQLXMLQueryModelPackage.XML_VALUE_FUNCTION_CONCAT: {
				...
				if (result == null) {
					result = caseXMLValueFunction(xmlValueFunctionConcat);
				}
				if (result == null) {
					result = caseValueExpressionFunction(xmlValueFunctionConcat);
				}
				if (result == null) {
					result = caseValueExpressionAtomic(xmlValueFunctionConcat);
				}
				if (result == null) {
					result = caseQueryValueExpression(xmlValueFunctionConcat);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlValueFunctionConcat);
				}
				if (result == null) {
					result = caseValueExpression(xmlValueFunctionConcat);
				}
				if (result == null) {
					result = caseSQLObject(xmlValueFunctionConcat);
				}
				if (result == null) {
					result = caseENamedElement(xmlValueFunctionConcat);
				}
				if (result == null) {
					result = caseEModelElement(xmlValueFunctionConcat);
				}
				if (result == null) {
			...
			case SQLXMLQueryModelPackage.XML_VALUE_FUNCTION: {
				...
				if (result == null) {
					result = caseValueExpressionFunction(xmlValueFunction);
				}
				if (result == null) {
					result = caseValueExpressionAtomic(xmlValueFunction);
				}
				if (result == null) {
					result = caseQueryValueExpression(xmlValueFunction);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlValueFunction);
				}
				if (result == null) {
					result = caseValueExpression(xmlValueFunction);
				}
				if (result == null) {
					result = caseSQLObject(xmlValueFunction);
				}
				if (result == null) {
					result = caseENamedElement(xmlValueFunction);
				}
				if (result == null) {
					result = caseEModelElement(xmlValueFunction);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_NAMESPACE_DECLARATION_PREFIX: {
				...
				if (result == null) {
					result = caseXMLNamespaceDeclarationItem(xmlNamespaceDeclarationPrefix);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlNamespaceDeclarationPrefix);
				}
				if (result == null) {
					result = caseSQLObject(xmlNamespaceDeclarationPrefix);
				}
				if (result == null) {
					result = caseENamedElement(xmlNamespaceDeclarationPrefix);
				}
				if (result == null) {
					result = caseEModelElement(xmlNamespaceDeclarationPrefix);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_NAMESPACE_DECLARATION_DEFAULT: {
				...
				if (result == null) {
					result = caseXMLNamespaceDeclarationItem(xmlNamespaceDeclarationDefault);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlNamespaceDeclarationDefault);
				}
				if (result == null) {
					result = caseSQLObject(xmlNamespaceDeclarationDefault);
				}
				if (result == null) {
					result = caseENamedElement(xmlNamespaceDeclarationDefault);
				}
				if (result == null) {
					result = caseEModelElement(xmlNamespaceDeclarationDefault);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_ATTRIBUTE_DECLARATION_ITEM: {
				...
				if (result == null) {
					result = caseQueryValueExpression(xmlAttributeDeclarationItem);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlAttributeDeclarationItem);
				}
				if (result == null) {
					result = caseValueExpression(xmlAttributeDeclarationItem);
				}
				if (result == null) {
					result = caseSQLObject(xmlAttributeDeclarationItem);
				}
				if (result == null) {
					result = caseENamedElement(xmlAttributeDeclarationItem);
				}
				if (result == null) {
					result = caseEModelElement(xmlAttributeDeclarationItem);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_VALUE_FUNCTION_ELEMENT: {
				...
				if (result == null) {
					result = caseXMLValueFunction(xmlValueFunctionElement);
				}
				if (result == null) {
					result = caseValueExpressionFunction(xmlValueFunctionElement);
				}
				if (result == null) {
					result = caseValueExpressionAtomic(xmlValueFunctionElement);
				}
				if (result == null) {
					result = caseQueryValueExpression(xmlValueFunctionElement);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlValueFunctionElement);
				}
				if (result == null) {
					result = caseValueExpression(xmlValueFunctionElement);
				}
				if (result == null) {
					result = caseSQLObject(xmlValueFunctionElement);
				}
				if (result == null) {
					result = caseENamedElement(xmlValueFunctionElement);
				}
				if (result == null) {
					result = caseEModelElement(xmlValueFunctionElement);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_NAMESPACE_DECLARATION_ITEM: {
				...
				if (result == null) {
					result = caseSQLQueryObject(xmlNamespaceDeclarationItem);
				}
				if (result == null) {
					result = caseSQLObject(xmlNamespaceDeclarationItem);
				}
				if (result == null) {
					result = caseENamedElement(xmlNamespaceDeclarationItem);
				}
				if (result == null) {
					result = caseEModelElement(xmlNamespaceDeclarationItem);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_VALUE_FUNCTION_ELEMENT_CONTENT_ITEM: {
				...
				if (result == null) {
					result = caseQueryValueExpression(xmlValueFunctionElementContentItem);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlValueFunctionElementContentItem);
				}
				if (result == null) {
					result = caseValueExpression(xmlValueFunctionElementContentItem);
				}
				if (result == null) {
					result = caseSQLObject(xmlValueFunctionElementContentItem);
				}
				if (result == null) {
					result = caseENamedElement(xmlValueFunctionElementContentItem);
				}
				if (result == null) {
					result = caseEModelElement(xmlValueFunctionElementContentItem);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_VALUE_FUNCTION_FOREST: {
				...
				if (result == null) {
					result = caseXMLValueFunction(xmlValueFunctionForest);
				}
				if (result == null) {
					result = caseValueExpressionFunction(xmlValueFunctionForest);
				}
				if (result == null) {
					result = caseValueExpressionAtomic(xmlValueFunctionForest);
				}
				if (result == null) {
					result = caseQueryValueExpression(xmlValueFunctionForest);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlValueFunctionForest);
				}
				if (result == null) {
					result = caseValueExpression(xmlValueFunctionForest);
				}
				if (result == null) {
					result = caseSQLObject(xmlValueFunctionForest);
				}
				if (result == null) {
					result = caseENamedElement(xmlValueFunctionForest);
				}
				if (result == null) {
					result = caseEModelElement(xmlValueFunctionForest);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_VALUE_FUNCTION_COMMENT: {
				...
				if (result == null) {
					result = caseXMLValueFunction(xmlValueFunctionComment);
				}
				if (result == null) {
					result = caseValueExpressionFunction(xmlValueFunctionComment);
				}
				if (result == null) {
					result = caseValueExpressionAtomic(xmlValueFunctionComment);
				}
				if (result == null) {
					result = caseQueryValueExpression(xmlValueFunctionComment);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlValueFunctionComment);
				}
				if (result == null) {
					result = caseValueExpression(xmlValueFunctionComment);
				}
				if (result == null) {
					result = caseSQLObject(xmlValueFunctionComment);
				}
				if (result == null) {
					result = caseENamedElement(xmlValueFunctionComment);
				}
				if (result == null) {
					result = caseEModelElement(xmlValueFunctionComment);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_VALUE_FUNCTION_DOCUMENT: {
				...
				if (result == null) {
					result = caseXMLValueFunction(xmlValueFunctionDocument);
				}
				if (result == null) {
					result = caseValueExpressionFunction(xmlValueFunctionDocument);
				}
				if (result == null) {
					result = caseValueExpressionAtomic(xmlValueFunctionDocument);
				}
				if (result == null) {
					result = caseQueryValueExpression(xmlValueFunctionDocument);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlValueFunctionDocument);
				}
				if (result == null) {
					result = caseValueExpression(xmlValueFunctionDocument);
				}
				if (result == null) {
					result = caseSQLObject(xmlValueFunctionDocument);
				}
				if (result == null) {
					result = caseENamedElement(xmlValueFunctionDocument);
				}
				if (result == null) {
					result = caseEModelElement(xmlValueFunctionDocument);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_VALUE_FUNCTION_PARSE: {
				...
				if (result == null) {
					result = caseXMLValueFunction(xmlValueFunctionParse);
				}
				if (result == null) {
					result = caseValueExpressionFunction(xmlValueFunctionParse);
				}
				if (result == null) {
					result = caseValueExpressionAtomic(xmlValueFunctionParse);
				}
				if (result == null) {
					result = caseQueryValueExpression(xmlValueFunctionParse);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlValueFunctionParse);
				}
				if (result == null) {
					result = caseValueExpression(xmlValueFunctionParse);
				}
				if (result == null) {
					result = caseSQLObject(xmlValueFunctionParse);
				}
				if (result == null) {
					result = caseENamedElement(xmlValueFunctionParse);
				}
				if (result == null) {
					result = caseEModelElement(xmlValueFunctionParse);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_VALUE_FUNCTION_PI: {
				...
				if (result == null) {
					result = caseXMLValueFunction(xmlValueFunctionPI);
				}
				if (result == null) {
					result = caseValueExpressionFunction(xmlValueFunctionPI);
				}
				if (result == null) {
					result = caseValueExpressionAtomic(xmlValueFunctionPI);
				}
				if (result == null) {
					result = caseQueryValueExpression(xmlValueFunctionPI);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlValueFunctionPI);
				}
				if (result == null) {
					result = caseValueExpression(xmlValueFunctionPI);
				}
				if (result == null) {
					result = caseSQLObject(xmlValueFunctionPI);
				}
				if (result == null) {
					result = caseENamedElement(xmlValueFunctionPI);
				}
				if (result == null) {
					result = caseEModelElement(xmlValueFunctionPI);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_VALUE_FUNCTION_QUERY: {
				...
				if (result == null) {
					result = caseXMLValueFunction(xmlValueFunctionQuery);
				}
				if (result == null) {
					result = caseValueExpressionFunction(xmlValueFunctionQuery);
				}
				if (result == null) {
					result = caseValueExpressionAtomic(xmlValueFunctionQuery);
				}
				if (result == null) {
					result = caseQueryValueExpression(xmlValueFunctionQuery);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlValueFunctionQuery);
				}
				if (result == null) {
					result = caseValueExpression(xmlValueFunctionQuery);
				}
				if (result == null) {
					result = caseSQLObject(xmlValueFunctionQuery);
				}
				if (result == null) {
					result = caseENamedElement(xmlValueFunctionQuery);
				}
				if (result == null) {
					result = caseEModelElement(xmlValueFunctionQuery);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_VALUE_FUNCTION_TEXT: {
				...
				if (result == null) {
					result = caseXMLValueFunction(xmlValueFunctionText);
				}
				if (result == null) {
					result = caseValueExpressionFunction(xmlValueFunctionText);
				}
				if (result == null) {
					result = caseValueExpressionAtomic(xmlValueFunctionText);
				}
				if (result == null) {
					result = caseQueryValueExpression(xmlValueFunctionText);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlValueFunctionText);
				}
				if (result == null) {
					result = caseValueExpression(xmlValueFunctionText);
				}
				if (result == null) {
					result = caseSQLObject(xmlValueFunctionText);
				}
				if (result == null) {
					result = caseENamedElement(xmlValueFunctionText);
				}
				if (result == null) {
					result = caseEModelElement(xmlValueFunctionText);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_VALUE_FUNCTION_VALIDATE: {
				...
				if (result == null) {
					result = caseXMLValueFunction(xmlValueFunctionValidate);
				}
				if (result == null) {
					result = caseValueExpressionFunction(xmlValueFunctionValidate);
				}
				if (result == null) {
					result = caseValueExpressionAtomic(xmlValueFunctionValidate);
				}
				if (result == null) {
					result = caseQueryValueExpression(xmlValueFunctionValidate);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlValueFunctionValidate);
				}
				if (result == null) {
					result = caseValueExpression(xmlValueFunctionValidate);
				}
				if (result == null) {
					result = caseSQLObject(xmlValueFunctionValidate);
				}
				if (result == null) {
					result = caseENamedElement(xmlValueFunctionValidate);
				}
				if (result == null) {
					result = caseEModelElement(xmlValueFunctionValidate);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_VALUE_EXPRESSION_CAST: {
				...
				if (result == null) {
					result = caseValueExpressionCast(xmlValueExpressionCast);
				}
				if (result == null) {
					result = caseValueExpressionAtomic(xmlValueExpressionCast);
				}
				if (result == null) {
					result = caseQueryValueExpression(xmlValueExpressionCast);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlValueExpressionCast);
				}
				if (result == null) {
					result = caseValueExpression(xmlValueExpressionCast);
				}
				if (result == null) {
					result = caseSQLObject(xmlValueExpressionCast);
				}
				if (result == null) {
					result = caseENamedElement(xmlValueExpressionCast);
				}
				if (result == null) {
					result = caseEModelElement(xmlValueExpressionCast);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_PREDICATE: {
				...
				if (result == null) {
					result = casePredicate(xmlPredicate);
				}
				if (result == null) {
					result = caseQuerySearchCondition(xmlPredicate);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlPredicate);
				}
				if (result == null) {
					result = caseSearchCondition(xmlPredicate);
				}
				if (result == null) {
					result = caseSQLObject(xmlPredicate);
				}
				if (result == null) {
					result = caseENamedElement(xmlPredicate);
				}
				if (result == null) {
					result = caseEModelElement(xmlPredicate);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_PREDICATE_CONTENT: {
				...
				if (result == null) {
					result = caseXMLPredicate(xmlPredicateContent);
				}
				if (result == null) {
					result = casePredicate(xmlPredicateContent);
				}
				if (result == null) {
					result = caseQuerySearchCondition(xmlPredicateContent);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlPredicateContent);
				}
				if (result == null) {
					result = caseSearchCondition(xmlPredicateContent);
				}
				if (result == null) {
					result = caseSQLObject(xmlPredicateContent);
				}
				if (result == null) {
					result = caseENamedElement(xmlPredicateContent);
				}
				if (result == null) {
					result = caseEModelElement(xmlPredicateContent);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_PREDICATE_DOCUMENT: {
				...
				if (result == null) {
					result = caseXMLPredicate(xmlPredicateDocument);
				}
				if (result == null) {
					result = casePredicate(xmlPredicateDocument);
				}
				if (result == null) {
					result = caseQuerySearchCondition(xmlPredicateDocument);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlPredicateDocument);
				}
				if (result == null) {
					result = caseSearchCondition(xmlPredicateDocument);
				}
				if (result == null) {
					result = caseSQLObject(xmlPredicateDocument);
				}
				if (result == null) {
					result = caseENamedElement(xmlPredicateDocument);
				}
				if (result == null) {
					result = caseEModelElement(xmlPredicateDocument);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_PREDICATE_EXISTS: {
				...
				if (result == null) {
					result = caseXMLPredicate(xmlPredicateExists);
				}
				if (result == null) {
					result = casePredicate(xmlPredicateExists);
				}
				if (result == null) {
					result = caseQuerySearchCondition(xmlPredicateExists);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlPredicateExists);
				}
				if (result == null) {
					result = caseSearchCondition(xmlPredicateExists);
				}
				if (result == null) {
					result = caseSQLObject(xmlPredicateExists);
				}
				if (result == null) {
					result = caseENamedElement(xmlPredicateExists);
				}
				if (result == null) {
					result = caseEModelElement(xmlPredicateExists);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_PREDICATE_VALID: {
				...
				if (result == null) {
					result = caseXMLPredicate(xmlPredicateValid);
				}
				if (result == null) {
					result = casePredicate(xmlPredicateValid);
				}
				if (result == null) {
					result = caseQuerySearchCondition(xmlPredicateValid);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlPredicateValid);
				}
				if (result == null) {
					result = caseSearchCondition(xmlPredicateValid);
				}
				if (result == null) {
					result = caseSQLObject(xmlPredicateValid);
				}
				if (result == null) {
					result = caseENamedElement(xmlPredicateValid);
				}
				if (result == null) {
					result = caseEModelElement(xmlPredicateValid);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_QUERY_EXPRESSION: {
				...
				if (result == null) {
					result = caseSQLQueryObject(xmlQueryExpression);
				}
				if (result == null) {
					result = caseSQLObject(xmlQueryExpression);
				}
				if (result == null) {
					result = caseENamedElement(xmlQueryExpression);
				}
				if (result == null) {
					result = caseEModelElement(xmlQueryExpression);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_QUERY_ARGUMENT_LIST: {
				...
				if (result == null) {
					result = caseSQLQueryObject(xmlQueryArgumentList);
				}
				if (result == null) {
					result = caseSQLObject(xmlQueryArgumentList);
				}
				if (result == null) {
					result = caseENamedElement(xmlQueryArgumentList);
				}
				if (result == null) {
					result = caseEModelElement(xmlQueryArgumentList);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_QUERY_ARGUMENT_ITEM: {
				...
				if (result == null) {
					result = caseQueryValueExpression(xmlQueryArgumentItem);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlQueryArgumentItem);
				}
				if (result == null) {
					result = caseValueExpression(xmlQueryArgumentItem);
				}
				if (result == null) {
					result = caseSQLObject(xmlQueryArgumentItem);
				}
				if (result == null) {
					result = caseENamedElement(xmlQueryArgumentItem);
				}
				if (result == null) {
					result = caseEModelElement(xmlQueryArgumentItem);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_SERIALIZE_FUNCTION: {
				...
				if (result == null) {
					result = caseValueExpressionFunction(xmlSerializeFunction);
				}
				if (result == null) {
					result = caseValueExpressionAtomic(xmlSerializeFunction);
				}
				if (result == null) {
					result = caseQueryValueExpression(xmlSerializeFunction);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlSerializeFunction);
				}
				if (result == null) {
					result = caseValueExpression(xmlSerializeFunction);
				}
				if (result == null) {
					result = caseSQLObject(xmlSerializeFunction);
				}
				if (result == null) {
					result = caseENamedElement(xmlSerializeFunction);
				}
				if (result == null) {
					result = caseEModelElement(xmlSerializeFunction);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_SERIALIZE_FUNCTION_TARGET: {
				...
				if (result == null) {
					result = caseQueryValueExpression(xmlSerializeFunctionTarget);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlSerializeFunctionTarget);
				}
				if (result == null) {
					result = caseValueExpression(xmlSerializeFunctionTarget);
				}
				if (result == null) {
					result = caseSQLObject(xmlSerializeFunctionTarget);
				}
				if (result == null) {
					result = caseENamedElement(xmlSerializeFunctionTarget);
				}
				if (result == null) {
					result = caseEModelElement(xmlSerializeFunctionTarget);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_AGGREGATE_FUNCTION: {
				...
				if (result == null) {
					result = caseValueExpressionFunction(xmlAggregateFunction);
				}
				if (result == null) {
					result = caseValueExpressionAtomic(xmlAggregateFunction);
				}
				if (result == null) {
					result = caseQueryValueExpression(xmlAggregateFunction);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlAggregateFunction);
				}
				if (result == null) {
					result = caseValueExpression(xmlAggregateFunction);
				}
				if (result == null) {
					result = caseSQLObject(xmlAggregateFunction);
				}
				if (result == null) {
					result = caseENamedElement(xmlAggregateFunction);
				}
				if (result == null) {
					result = caseEModelElement(xmlAggregateFunction);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_VALUE_FUNCTION_CONCAT_CONTENT_ITEM: {
				...
				if (result == null) {
					result = caseQueryValueExpression(xmlValueFunctionConcatContentItem);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlValueFunctionConcatContentItem);
				}
				if (result == null) {
					result = caseValueExpression(xmlValueFunctionConcatContentItem);
				}
				if (result == null) {
					result = caseSQLObject(xmlValueFunctionConcatContentItem);
				}
				if (result == null) {
					result = caseENamedElement(xmlValueFunctionConcatContentItem);
				}
				if (result == null) {
					result = caseEModelElement(xmlValueFunctionConcatContentItem);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_VALUE_FUNCTION_COMMENT_CONTENT: {
				...
				if (result == null) {
					result = caseQueryValueExpression(xmlValueFunctionCommentContent);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlValueFunctionCommentContent);
				}
				if (result == null) {
					result = caseValueExpression(xmlValueFunctionCommentContent);
				}
				if (result == null) {
					result = caseSQLObject(xmlValueFunctionCommentContent);
				}
				if (result == null) {
					result = caseENamedElement(xmlValueFunctionCommentContent);
				}
				if (result == null) {
					result = caseEModelElement(xmlValueFunctionCommentContent);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_VALUE_FUNCTION_DOCUMENT_CONTENT: {
				...
				if (result == null) {
					result = caseQueryValueExpression(xmlValueFunctionDocumentContent);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlValueFunctionDocumentContent);
				}
				if (result == null) {
					result = caseValueExpression(xmlValueFunctionDocumentContent);
				}
				if (result == null) {
					result = caseSQLObject(xmlValueFunctionDocumentContent);
				}
				if (result == null) {
					result = caseENamedElement(xmlValueFunctionDocumentContent);
				}
				if (result == null) {
					result = caseEModelElement(xmlValueFunctionDocumentContent);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_AGGREGATE_SORT_SPECIFICATION: {
				...
				if (result == null) {
					result = caseSQLQueryObject(xmlAggregateSortSpecification);
				}
				if (result == null) {
					result = caseSQLObject(xmlAggregateSortSpecification);
				}
				if (result == null) {
					result = caseENamedElement(xmlAggregateSortSpecification);
				}
				if (result == null) {
					result = caseEModelElement(xmlAggregateSortSpecification);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_VALUE_FUNCTION_FOREST_CONTENT_ITEM: {
				...
				if (result == null) {
					result = caseQueryValueExpression(xmlValueFunctionForestContentItem);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlValueFunctionForestContentItem);
				}
				if (result == null) {
					result = caseValueExpression(xmlValueFunctionForestContentItem);
				}
				if (result == null) {
					result = caseSQLObject(xmlValueFunctionForestContentItem);
				}
				if (result == null) {
					result = caseENamedElement(xmlValueFunctionForestContentItem);
				}
				if (result == null) {
					result = caseEModelElement(xmlValueFunctionForestContentItem);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_VALUE_FUNCTION_PARSE_CONTENT: {
				...
				if (result == null) {
					result = caseQueryValueExpression(xmlValueFunctionParseContent);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlValueFunctionParseContent);
				}
				if (result == null) {
					result = caseValueExpression(xmlValueFunctionParseContent);
				}
				if (result == null) {
					result = caseSQLObject(xmlValueFunctionParseContent);
				}
				if (result == null) {
					result = caseENamedElement(xmlValueFunctionParseContent);
				}
				if (result == null) {
					result = caseEModelElement(xmlValueFunctionParseContent);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_VALUE_FUNCTION_PI_CONTENT: {
				...
				if (result == null) {
					result = caseQueryValueExpression(xmlValueFunctionPIContent);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlValueFunctionPIContent);
				}
				if (result == null) {
					result = caseValueExpression(xmlValueFunctionPIContent);
				}
				if (result == null) {
					result = caseSQLObject(xmlValueFunctionPIContent);
				}
				if (result == null) {
					result = caseENamedElement(xmlValueFunctionPIContent);
				}
				if (result == null) {
					result = caseEModelElement(xmlValueFunctionPIContent);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_TABLE_FUNCTION: {
				...
				if (result == null) {
					result = caseTableFunction(xmlTableFunction);
				}
				if (result == null) {
					result = caseTableExpression(xmlTableFunction);
				}
				if (result == null) {
					result = caseTableReference(xmlTableFunction);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlTableFunction);
				}
				if (result == null) {
					result = caseSQLObject(xmlTableFunction);
				}
				if (result == null) {
					result = caseENamedElement(xmlTableFunction);
				}
				if (result == null) {
					result = caseEModelElement(xmlTableFunction);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_VALUE_FUNCTION_TEXT_CONTENT: {
				...
				if (result == null) {
					result = caseQueryValueExpression(xmlValueFunctionTextContent);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlValueFunctionTextContent);
				}
				if (result == null) {
					result = caseValueExpression(xmlValueFunctionTextContent);
				}
				if (result == null) {
					result = caseSQLObject(xmlValueFunctionTextContent);
				}
				if (result == null) {
					result = caseENamedElement(xmlValueFunctionTextContent);
				}
				if (result == null) {
					result = caseEModelElement(xmlValueFunctionTextContent);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_VALUE_FUNCTION_VALIDATE_CONTENT: {
				...
				if (result == null) {
					result = caseQueryValueExpression(xmlValueFunctionValidateContent);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlValueFunctionValidateContent);
				}
				if (result == null) {
					result = caseValueExpression(xmlValueFunctionValidateContent);
				}
				if (result == null) {
					result = caseSQLObject(xmlValueFunctionValidateContent);
				}
				if (result == null) {
					result = caseENamedElement(xmlValueFunctionValidateContent);
				}
				if (result == null) {
					result = caseEModelElement(xmlValueFunctionValidateContent);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_TABLE_COLUMN_DEFINITION_ITEM: {
				...
				if (result == null) {
					result = caseSQLQueryObject(xmlTableColumnDefinitionItem);
				}
				if (result == null) {
					result = caseSQLObject(xmlTableColumnDefinitionItem);
				}
				if (result == null) {
					result = caseENamedElement(xmlTableColumnDefinitionItem);
				}
				if (result == null) {
					result = caseEModelElement(xmlTableColumnDefinitionItem);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_TABLE_COLUMN_DEFINITION_REGULAR: {
				...
				if (result == null) {
					result = caseXMLTableColumnDefinitionItem(xmlTableColumnDefinitionRegular);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlTableColumnDefinitionRegular);
				}
				if (result == null) {
					result = caseSQLObject(xmlTableColumnDefinitionRegular);
				}
				if (result == null) {
					result = caseENamedElement(xmlTableColumnDefinitionRegular);
				}
				if (result == null) {
					result = caseEModelElement(xmlTableColumnDefinitionRegular);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_TABLE_COLUMN_DEFINITION_ORDINALITY: {
				...
				if (result == null) {
					result = caseXMLTableColumnDefinitionItem(xmlTableColumnDefinitionOrdinality);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlTableColumnDefinitionOrdinality);
				}
				if (result == null) {
					result = caseSQLObject(xmlTableColumnDefinitionOrdinality);
				}
				if (result == null) {
					result = caseENamedElement(xmlTableColumnDefinitionOrdinality);
				}
				if (result == null) {
					result = caseEModelElement(xmlTableColumnDefinitionOrdinality);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_VALUE_FUNCTION_VALIDATE_ACCORDING_TO: {
				...
				if (result == null) {
					result = caseSQLQueryObject(xmlValueFunctionValidateAccordingTo);
				}
				if (result == null) {
					result = caseSQLObject(xmlValueFunctionValidateAccordingTo);
				}
				if (result == null) {
					result = caseENamedElement(xmlValueFunctionValidateAccordingTo);
				}
				if (result == null) {
					result = caseEModelElement(xmlValueFunctionValidateAccordingTo);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_VALUE_FUNCTION_VALIDATE_ACCORDING_TO_URI: {
				...
				if (result == null) {
					result = caseXMLValueFunctionValidateAccordingTo(xmlValueFunctionValidateAccordingToURI);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlValueFunctionValidateAccordingToURI);
				}
				if (result == null) {
					result = caseSQLObject(xmlValueFunctionValidateAccordingToURI);
				}
				if (result == null) {
					result = caseENamedElement(xmlValueFunctionValidateAccordingToURI);
				}
				if (result == null) {
					result = caseEModelElement(xmlValueFunctionValidateAccordingToURI);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_VALUE_FUNCTION_VALIDATE_ACCORDING_TO_IDENTIFIER: {
				...
				if (result == null) {
					result = caseXMLValueFunctionValidateAccordingTo(xmlValueFunctionValidateAccordingToIdentifier);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlValueFunctionValidateAccordingToIdentifier);
				}
				if (result == null) {
					result = caseSQLObject(xmlValueFunctionValidateAccordingToIdentifier);
				}
				if (result == null) {
					result = caseENamedElement(xmlValueFunctionValidateAccordingToIdentifier);
				}
				if (result == null) {
					result = caseEModelElement(xmlValueFunctionValidateAccordingToIdentifier);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_VALUE_FUNCTION_VALIDATE_ELEMENT_NAME: {
				...
				if (result == null) {
					result = caseSQLQueryObject(xmlValueFunctionValidateElementName);
				}
				if (result == null) {
					result = caseSQLObject(xmlValueFunctionValidateElementName);
				}
				if (result == null) {
					result = caseENamedElement(xmlValueFunctionValidateElementName);
				}
				if (result == null) {
					result = caseEModelElement(xmlValueFunctionValidateElementName);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_VALUE_FUNCTION_VALIDATE_ELEMENT_NAMESPACE: {
				...
				if (result == null) {
					result = caseSQLQueryObject(xmlValueFunctionValidateElementNamespace);
				}
				if (result == null) {
					result = caseSQLObject(xmlValueFunctionValidateElementNamespace);
				}
				if (result == null) {
					result = caseENamedElement(xmlValueFunctionValidateElementNamespace);
				}
				if (result == null) {
					result = caseEModelElement(xmlValueFunctionValidateElementNamespace);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_NAMESPACES_DECLARATION: {
				...
				if (result == null) {
					result = caseSQLQueryObject(xmlNamespacesDeclaration);
				}
				if (result == null) {
					result = caseSQLObject(xmlNamespacesDeclaration);
				}
				if (result == null) {
					result = caseENamedElement(xmlNamespacesDeclaration);
				}
				if (result == null) {
					result = caseEModelElement(xmlNamespacesDeclaration);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_VALUE_FUNCTION_ELEMENT_CONTENT_LIST: {
				...
				if (result == null) {
					result = caseSQLQueryObject(xmlValueFunctionElementContentList);
				}
				if (result == null) {
					result = caseSQLObject(xmlValueFunctionElementContentList);
				}
				if (result == null) {
					result = caseENamedElement(xmlValueFunctionElementContentList);
				}
				if (result == null) {
					result = caseEModelElement(xmlValueFunctionElementContentList);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_VALUE_FUNCTION_QUERY_RETURNING: {
				...
				if (result == null) {
					result = caseSQLQueryObject(xmlValueFunctionQueryReturning);
				}
				if (result == null) {
					result = caseSQLObject(xmlValueFunctionQueryReturning);
				}
				if (result == null) {
					result = caseENamedElement(xmlValueFunctionQueryReturning);
				}
				if (result == null) {
					result = caseEModelElement(xmlValueFunctionQueryReturning);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_VALUE_FUNCTION_VALIDATE_ELEMENT: {
				...
				if (result == null) {
					result = caseSQLQueryObject(xmlValueFunctionValidateElement);
				}
				if (result == null) {
					result = caseSQLObject(xmlValueFunctionValidateElement);
				}
				if (result == null) {
					result = caseENamedElement(xmlValueFunctionValidateElement);
				}
				if (result == null) {
					result = caseEModelElement(xmlValueFunctionValidateElement);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_TABLE_COLUMN_DEFINITION_DEFAULT: {
				...
				if (result == null) {
					result = caseQueryValueExpression(xmlTableColumnDefinitionDefault);
				}
				if (result == null) {
					result = caseSQLQueryObject(xmlTableColumnDefinitionDefault);
				}
				if (result == null) {
					result = caseValueExpression(xmlTableColumnDefinitionDefault);
				}
				if (result == null) {
					result = caseSQLObject(xmlTableColumnDefinitionDefault);
				}
				if (result == null) {
					result = caseENamedElement(xmlTableColumnDefinitionDefault);
				}
				if (result == null) {
					result = caseEModelElement(xmlTableColumnDefinitionDefault);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLXMLQueryModelPackage.XML_SERIALIZE_FUNCTION_ENCODING: {
				...
				if (result == null) {
					result = caseSQLQueryObject(xmlSerializeFunctionEncoding);
				}
				if (result == null) {
					result = caseSQLObject(xmlSerializeFunctionEncoding);
				}
				if (result == null) {
					result = caseENamedElement(xmlSerializeFunctionEncoding);
				}
				if (result == null) {
					result = caseEModelElement(xmlSerializeFunctionEncoding);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
