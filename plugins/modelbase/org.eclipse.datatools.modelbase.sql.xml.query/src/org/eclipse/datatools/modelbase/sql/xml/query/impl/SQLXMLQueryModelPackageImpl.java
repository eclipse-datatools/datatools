...
public class SQLXMLQueryModelPackageImpl extends EPackageImpl implements SQLXMLQueryModelPackage {
    ...
    public static SQLXMLQueryModelPackage init() {
		...
		Object registeredSQLXMLQueryModelPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		SQLXMLQueryModelPackageImpl theSQLXMLQueryModelPackage = registeredSQLXMLQueryModelPackage instanceof SQLXMLQueryModelPackageImpl ? (SQLXMLQueryModelPackageImpl)registeredSQLXMLQueryModelPackage : new SQLXMLQueryModelPackageImpl();
    ...
    public void initializePackageContents() {
		...
		initEReference(getXMLQueryExpression_PredicateExists(), this.getXMLPredicateExists(), this.getXMLPredicateExists_XqueryExpr(), "predicateExists", null, 0, 1, XMLQueryExpression.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getXMLQueryExpression_ValueFunctionQuery(), this.getXMLValueFunctionQuery(), this.getXMLValueFunctionQuery_XqueryExpr(), "valueFunctionQuery", null, 0, 1, XMLQueryExpression.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getXMLQueryArgumentList_PredicateExists(), this.getXMLPredicateExists(), this.getXMLPredicateExists_XqueryArgList(), "predicateExists", null, 0, 1, XMLQueryArgumentList.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getXMLQueryArgumentList_ValueFunctionQuery(), this.getXMLValueFunctionQuery(), this.getXMLValueFunctionQuery_XqueryArgList(), "valueFunctionQuery", null, 0, 1, XMLQueryArgumentList.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getXMLQueryArgumentList_TableFunction(), this.getXMLTableFunction(), this.getXMLTableFunction_XqueryArgList(), "tableFunction", null, 0, 1, XMLQueryArgumentList.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getXMLValueFunctionForestContentItem_ValueFunctionForest(), this.getXMLValueFunctionForest(), this.getXMLValueFunctionForest_ForestContentList(), "valueFunctionForest", null, 0, 1, XMLValueFunctionForestContentItem.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getXMLValueFunctionForestContentItem_ValueExpr(), theSQLQueryModelPackage.getQueryValueExpression(), null, "valueExpr", null, 0, 1, XMLValueFunctionForestContentItem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getXMLTableColumnDefinitionItem_TableFunction(), this.getXMLTableFunction(), this.getXMLTableFunction_ColumnDefList(), "tableFunction", null, 0, 1, XMLTableColumnDefinitionItem.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getXMLNamespacesDeclaration_ValueFunctionElement(), this.getXMLValueFunctionElement(), this.getXMLValueFunctionElement_NamespacesDecl(), "valueFunctionElement", null, 0, 1, XMLNamespacesDeclaration.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getXMLNamespacesDeclaration_ValueFunctionForest(), this.getXMLValueFunctionForest(), this.getXMLValueFunctionForest_NamespacesDecl(), "valueFunctionForest", null, 0, 1, XMLNamespacesDeclaration.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getXMLNamespacesDeclaration_TableFunction(), this.getXMLTableFunction(), this.getXMLTableFunction_NamespacesDecl(), "tableFunction", null, 0, 1, XMLNamespacesDeclaration.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getXMLValueFunctionElementContentList_ValueFunctionElement(), this.getXMLValueFunctionElement(), this.getXMLValueFunctionElement_ElementContentList(), "valueFunctionElement", null, 0, 1, XMLValueFunctionElementContentList.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
