...
public abstract class QueryValueExpressionImpl extends SQLQueryObjectImpl implements QueryValueExpression {
	...
	public ValuesRow getValuesRow() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_VALUE_EXPRESSION__VALUES_ROW) {
			return null;
		}
		return (ValuesRow)eInternalContainer();
	}
	...
	public OrderByValueExpression getOrderByValueExpr() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_VALUE_EXPRESSION__ORDER_BY_VALUE_EXPR) {
			return null;
		}
		return (OrderByValueExpression)eInternalContainer();
	}
	...
	public ResultColumn getResultColumn() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_VALUE_EXPRESSION__RESULT_COLUMN) {
			return null;
		}
		return (ResultColumn)eInternalContainer();
	}
	...
	public PredicateBasic getBasicRight() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_VALUE_EXPRESSION__BASIC_RIGHT) {
			return null;
		}
		return (PredicateBasic)eInternalContainer();
	}
	...
	public PredicateBasic getBasicLeft() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_VALUE_EXPRESSION__BASIC_LEFT) {
			return null;
		}
		return (PredicateBasic)eInternalContainer();
	}
	...
	public PredicateLike getLikePattern() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_VALUE_EXPRESSION__LIKE_PATTERN) {
			return null;
		}
		return (PredicateLike)eInternalContainer();
	}
	...
	public PredicateLike getLikeMatching() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_VALUE_EXPRESSION__LIKE_MATCHING) {
			return null;
		}
		return (PredicateLike)eInternalContainer();
	}
	...
	public PredicateIsNull getPredicateNull() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_VALUE_EXPRESSION__PREDICATE_NULL) {
			return null;
		}
		return (PredicateIsNull)eInternalContainer();
	}
	...
	public PredicateInValueList getInValueListRight() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_VALUE_EXPRESSION__IN_VALUE_LIST_RIGHT) {
			return null;
		}
		return (PredicateInValueList)eInternalContainer();
	}
	...
	public PredicateInValueList getInValueListLeft() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_VALUE_EXPRESSION__IN_VALUE_LIST_LEFT) {
			return null;
		}
		return (PredicateInValueList)eInternalContainer();
	}
	...
	public PredicateInValueRowSelect getInValueRowSelectLeft() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_VALUE_EXPRESSION__IN_VALUE_ROW_SELECT_LEFT) {
			return null;
		}
		return (PredicateInValueRowSelect)eInternalContainer();
	}
	...
	public PredicateInValueSelect getInValueSelectLeft() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_VALUE_EXPRESSION__IN_VALUE_SELECT_LEFT) {
			return null;
		}
		return (PredicateInValueSelect)eInternalContainer();
	}
	...
	public PredicateQuantifiedRowSelect getQuantifiedRowSelectLeft() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_VALUE_EXPRESSION__QUANTIFIED_ROW_SELECT_LEFT) {
			return null;
		}
		return (PredicateQuantifiedRowSelect)eInternalContainer();
	}
	...
	public PredicateQuantifiedValueSelect getQuantifiedValueSelectLeft() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_VALUE_EXPRESSION__QUANTIFIED_VALUE_SELECT_LEFT) {
			return null;
		}
		return (PredicateQuantifiedValueSelect)eInternalContainer();
	}
	...
	public PredicateBetween getBetweenLeft() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_VALUE_EXPRESSION__BETWEEN_LEFT) {
			return null;
		}
		return (PredicateBetween)eInternalContainer();
	}
	...
	public PredicateBetween getBetweenRight1() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_VALUE_EXPRESSION__BETWEEN_RIGHT1) {
			return null;
		}
		return (PredicateBetween)eInternalContainer();
	}
	...
	public PredicateBetween getBetweenRight2() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_VALUE_EXPRESSION__BETWEEN_RIGHT2) {
			return null;
		}
		return (PredicateBetween)eInternalContainer();
	}
	...
	public ValueExpressionCast getValueExprCast() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_VALUE_EXPRESSION__VALUE_EXPR_CAST) {
			return null;
		}
		return (ValueExpressionCast)eInternalContainer();
	}
	...
	public ValueExpressionFunction getValueExprFunction() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_VALUE_EXPRESSION__VALUE_EXPR_FUNCTION) {
			return null;
		}
		return (ValueExpressionFunction)eInternalContainer();
	}
	...
	public ValueExpressionCombined getValueExprCombinedLeft() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_VALUE_EXPRESSION__VALUE_EXPR_COMBINED_LEFT) {
			return null;
		}
		return (ValueExpressionCombined)eInternalContainer();
	}
	...
	public ValueExpressionCombined getValueExprCombinedRight() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_VALUE_EXPRESSION__VALUE_EXPR_COMBINED_RIGHT) {
			return null;
		}
		return (ValueExpressionCombined)eInternalContainer();
	}
	...
	public GroupingExpression getGroupingExpr() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_VALUE_EXPRESSION__GROUPING_EXPR) {
			return null;
		}
		return (GroupingExpression)eInternalContainer();
	}
	...
	public ValueExpressionCaseElse getValueExprCaseElse() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_VALUE_EXPRESSION__VALUE_EXPR_CASE_ELSE) {
			return null;
		}
		return (ValueExpressionCaseElse)eInternalContainer();
	}
	...
	public ValueExpressionCaseSimple getValueExprCaseSimple() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_VALUE_EXPRESSION__VALUE_EXPR_CASE_SIMPLE) {
			return null;
		}
		return (ValueExpressionCaseSimple)eInternalContainer();
	}
	...
	public ValueExpressionCaseSimpleContent getValueExprCaseSimpleContentWhen() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_VALUE_EXPRESSION__VALUE_EXPR_CASE_SIMPLE_CONTENT_WHEN) {
			return null;
		}
		return (ValueExpressionCaseSimpleContent)eInternalContainer();
	}
	...
	public ValueExpressionCaseSimpleContent getValueExprCaseSimpleContentResult() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_VALUE_EXPRESSION__VALUE_EXPR_CASE_SIMPLE_CONTENT_RESULT) {
			return null;
		}
		return (ValueExpressionCaseSimpleContent)eInternalContainer();
	}
	...
	public ValueExpressionCaseSearchContent getValueExprCaseSearchContent() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_VALUE_EXPRESSION__VALUE_EXPR_CASE_SEARCH_CONTENT) {
			return null;
		}
		return (ValueExpressionCaseSearchContent)eInternalContainer();
	}
	...
	public PredicateLike getLikeEscape() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_VALUE_EXPRESSION__LIKE_ESCAPE) {
			return null;
		}
		return (PredicateLike)eInternalContainer();
	}
	...
	public ValueExpressionLabeledDuration getValueExprLabeledDuration() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_VALUE_EXPRESSION__VALUE_EXPR_LABELED_DURATION) {
			return null;
		}
		return (ValueExpressionLabeledDuration)eInternalContainer();
	}
...
public ValueExpressionNested getNest() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_VALUE_EXPRESSION__NEST) {
			return null;
		}
		return (ValueExpressionNested)eInternalContainer();
	}
...
public UpdateSourceExprList getUpdateSourceExprList() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_VALUE_EXPRESSION__UPDATE_SOURCE_EXPR_LIST) {
			return null;
		}
		return (UpdateSourceExprList)eInternalContainer();
	}
...
public void setUpdateSourceExprList(UpdateSourceExprList newUpdateSourceExprList) {
	...
	public TableFunction getTableFunction() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_VALUE_EXPRESSION__TABLE_FUNCTION) {
			return null;
		}
		return (TableFunction)eInternalContainer();
	}
	...
	public ValueExpressionRow getValueExprRow() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_VALUE_EXPRESSION__VALUE_EXPR_ROW) {
			return null;
		}
		return (ValueExpressionRow)eInternalContainer();
	}
	...
	public CallStatement getCallStatement() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_VALUE_EXPRESSION__CALL_STATEMENT) {
			return null;
		}
		return (CallStatement)eInternalContainer();
	}
