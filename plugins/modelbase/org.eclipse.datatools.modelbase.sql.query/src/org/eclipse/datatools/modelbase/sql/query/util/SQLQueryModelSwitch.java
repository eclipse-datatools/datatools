    ...
    protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SQLQueryModelPackage.QUERY_STATEMENT: {
				...
				if (result == null) {
					result = caseSQLQueryObject(queryStatement);
				}
				if (result == null) {
					result = caseSQLDataStatement(queryStatement);
				}
				if (result == null) {
					result = caseSQLObject(queryStatement);
				}
				if (result == null) {
					result = caseSQLStatement(queryStatement);
				}
				if (result == null) {
					result = caseENamedElement(queryStatement);
				}
				if (result == null) {
					result = caseEModelElement(queryStatement);
				}
				if (result == null) {
			...
			case SQLQueryModelPackage.QUERY_DELETE_STATEMENT: {
				...
				if (result == null) {
					result = caseQueryChangeStatement(queryDeleteStatement);
				}
				if (result == null) {
					result = caseQueryStatement(queryDeleteStatement);
				}
				if (result == null) {
					result = caseSQLDataChangeStatement(queryDeleteStatement);
				}
				if (result == null) {
					result = caseSQLQueryObject(queryDeleteStatement);
				}
				if (result == null) {
					result = caseSQLDataStatement(queryDeleteStatement);
				}
				if (result == null) {
					result = caseSQLObject(queryDeleteStatement);
				}
				if (result == null) {
					result = caseSQLStatement(queryDeleteStatement);
				}
				if (result == null) {
					result = caseENamedElement(queryDeleteStatement);
				}
				if (result == null) {
					result = caseEModelElement(queryDeleteStatement);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.QUERY_INSERT_STATEMENT: {
				...
				if (result == null) {
					result = caseQueryChangeStatement(queryInsertStatement);
				}
				if (result == null) {
					result = caseQueryStatement(queryInsertStatement);
				}
				if (result == null) {
					result = caseSQLDataChangeStatement(queryInsertStatement);
				}
				if (result == null) {
					result = caseSQLQueryObject(queryInsertStatement);
				}
				if (result == null) {
					result = caseSQLDataStatement(queryInsertStatement);
				}
				if (result == null) {
					result = caseSQLObject(queryInsertStatement);
				}
				if (result == null) {
					result = caseSQLStatement(queryInsertStatement);
				}
				if (result == null) {
					result = caseENamedElement(queryInsertStatement);
				}
				if (result == null) {
					result = caseEModelElement(queryInsertStatement);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.QUERY_SELECT_STATEMENT: {
				...
				if (result == null) {
					result = caseQueryStatement(querySelectStatement);
				}
				if (result == null) {
					result = caseSQLQueryObject(querySelectStatement);
				}
				if (result == null) {
					result = caseSQLDataStatement(querySelectStatement);
				}
				if (result == null) {
					result = caseSQLObject(querySelectStatement);
				}
				if (result == null) {
					result = caseSQLStatement(querySelectStatement);
				}
				if (result == null) {
					result = caseENamedElement(querySelectStatement);
				}
				if (result == null) {
					result = caseEModelElement(querySelectStatement);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.QUERY_UPDATE_STATEMENT: {
				...
				if (result == null) {
					result = caseQueryChangeStatement(queryUpdateStatement);
				}
				if (result == null) {
					result = caseQueryStatement(queryUpdateStatement);
				}
				if (result == null) {
					result = caseSQLDataChangeStatement(queryUpdateStatement);
				}
				if (result == null) {
					result = caseSQLQueryObject(queryUpdateStatement);
				}
				if (result == null) {
					result = caseSQLDataStatement(queryUpdateStatement);
				}
				if (result == null) {
					result = caseSQLObject(queryUpdateStatement);
				}
				if (result == null) {
					result = caseSQLStatement(queryUpdateStatement);
				}
				if (result == null) {
					result = caseENamedElement(queryUpdateStatement);
				}
				if (result == null) {
					result = caseEModelElement(queryUpdateStatement);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.UPDATE_ASSIGNMENT_EXPRESSION: {
				...
				if (result == null) {
					result = caseSQLQueryObject(updateAssignmentExpression);
				}
				if (result == null) {
					result = caseSQLObject(updateAssignmentExpression);
				}
				if (result == null) {
					result = caseENamedElement(updateAssignmentExpression);
				}
				if (result == null) {
					result = caseEModelElement(updateAssignmentExpression);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.CURSOR_REFERENCE: {
				...
				if (result == null) {
					result = caseSQLQueryObject(cursorReference);
				}
				if (result == null) {
					result = caseSQLObject(cursorReference);
				}
				if (result == null) {
					result = caseENamedElement(cursorReference);
				}
				if (result == null) {
					result = caseEModelElement(cursorReference);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.QUERY_SEARCH_CONDITION: {
				...
				if (result == null) {
					result = caseSQLQueryObject(querySearchCondition);
				}
				if (result == null) {
					result = caseSearchCondition(querySearchCondition);
				}
				if (result == null) {
					result = caseSQLObject(querySearchCondition);
				}
				if (result == null) {
					result = caseENamedElement(querySearchCondition);
				}
				if (result == null) {
					result = caseEModelElement(querySearchCondition);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.QUERY_EXPRESSION_BODY: {
				...
				if (result == null) {
					result = caseTableExpression(queryExpressionBody);
				}
				if (result == null) {
					result = caseTableReference(queryExpressionBody);
				}
				if (result == null) {
					result = caseSQLQueryObject(queryExpressionBody);
				}
				if (result == null) {
					result = caseSQLObject(queryExpressionBody);
				}
				if (result == null) {
					result = caseENamedElement(queryExpressionBody);
				}
				if (result == null) {
					result = caseEModelElement(queryExpressionBody);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.QUERY_VALUE_EXPRESSION: {
				...
				if (result == null) {
					result = caseSQLQueryObject(queryValueExpression);
				}
				if (result == null) {
					result = caseValueExpression(queryValueExpression);
				}
				if (result == null) {
					result = caseSQLObject(queryValueExpression);
				}
				if (result == null) {
					result = caseENamedElement(queryValueExpression);
				}
				if (result == null) {
					result = caseEModelElement(queryValueExpression);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.QUERY_EXPRESSION_ROOT: {
				...
				if (result == null) {
					result = caseSQLQueryObject(queryExpressionRoot);
				}
				if (result == null) {
					result = caseQueryExpression(queryExpressionRoot);
				}
				if (result == null) {
					result = caseSQLObject(queryExpressionRoot);
				}
				if (result == null) {
					result = caseENamedElement(queryExpressionRoot);
				}
				if (result == null) {
					result = caseEModelElement(queryExpressionRoot);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.VALUES_ROW: {
				...
				if (result == null) {
					result = caseSQLQueryObject(valuesRow);
				}
				if (result == null) {
					result = caseSQLObject(valuesRow);
				}
				if (result == null) {
					result = caseENamedElement(valuesRow);
				}
				if (result == null) {
					result = caseEModelElement(valuesRow);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.QUERY_VALUES: {
				...
				if (result == null) {
					result = caseQueryExpressionBody(queryValues);
				}
				if (result == null) {
					result = caseTableExpression(queryValues);
				}
				if (result == null) {
					result = caseTableReference(queryValues);
				}
				if (result == null) {
					result = caseSQLQueryObject(queryValues);
				}
				if (result == null) {
					result = caseSQLObject(queryValues);
				}
				if (result == null) {
					result = caseENamedElement(queryValues);
				}
				if (result == null) {
					result = caseEModelElement(queryValues);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.TABLE_REFERENCE: {
				...
				if (result == null) {
					result = caseSQLQueryObject(tableReference);
				}
				if (result == null) {
					result = caseSQLObject(tableReference);
				}
				if (result == null) {
					result = caseENamedElement(tableReference);
				}
				if (result == null) {
					result = caseEModelElement(tableReference);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.TABLE_EXPRESSION: {
				...
				if (result == null) {
					result = caseTableReference(tableExpression);
				}
				if (result == null) {
					result = caseSQLQueryObject(tableExpression);
				}
				if (result == null) {
					result = caseSQLObject(tableExpression);
				}
				if (result == null) {
					result = caseENamedElement(tableExpression);
				}
				if (result == null) {
					result = caseEModelElement(tableExpression);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.TABLE_JOINED: {
				...
				if (result == null) {
					result = caseTableReference(tableJoined);
				}
				if (result == null) {
					result = caseSQLQueryObject(tableJoined);
				}
				if (result == null) {
					result = caseSQLObject(tableJoined);
				}
				if (result == null) {
					result = caseENamedElement(tableJoined);
				}
				if (result == null) {
					result = caseEModelElement(tableJoined);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.WITH_TABLE_SPECIFICATION: {
				...
				if (result == null) {
					result = caseSQLQueryObject(withTableSpecification);
				}
				if (result == null) {
					result = caseSQLObject(withTableSpecification);
				}
				if (result == null) {
					result = caseENamedElement(withTableSpecification);
				}
				if (result == null) {
					result = caseEModelElement(withTableSpecification);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.PREDICATE: {
				...
				if (result == null) {
					result = caseQuerySearchCondition(predicate);
				}
				if (result == null) {
					result = caseSQLQueryObject(predicate);
				}
				if (result == null) {
					result = caseSearchCondition(predicate);
				}
				if (result == null) {
					result = caseSQLObject(predicate);
				}
				if (result == null) {
					result = caseENamedElement(predicate);
				}
				if (result == null) {
					result = caseEModelElement(predicate);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.SEARCH_CONDITION_COMBINED: {
				...
				if (result == null) {
					result = caseQuerySearchCondition(searchConditionCombined);
				}
				if (result == null) {
					result = caseSQLQueryObject(searchConditionCombined);
				}
				if (result == null) {
					result = caseSearchCondition(searchConditionCombined);
				}
				if (result == null) {
					result = caseSQLObject(searchConditionCombined);
				}
				if (result == null) {
					result = caseENamedElement(searchConditionCombined);
				}
				if (result == null) {
					result = caseEModelElement(searchConditionCombined);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.ORDER_BY_VALUE_EXPRESSION: {
				...
				if (result == null) {
					result = caseOrderBySpecification(orderByValueExpression);
				}
				if (result == null) {
					result = caseSQLQueryObject(orderByValueExpression);
				}
				if (result == null) {
					result = caseSQLObject(orderByValueExpression);
				}
				if (result == null) {
					result = caseENamedElement(orderByValueExpression);
				}
				if (result == null) {
					result = caseEModelElement(orderByValueExpression);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.QUERY_COMBINED: {
				...
				if (result == null) {
					result = caseQueryExpressionBody(queryCombined);
				}
				if (result == null) {
					result = caseTableExpression(queryCombined);
				}
				if (result == null) {
					result = caseTableReference(queryCombined);
				}
				if (result == null) {
					result = caseSQLQueryObject(queryCombined);
				}
				if (result == null) {
					result = caseSQLObject(queryCombined);
				}
				if (result == null) {
					result = caseENamedElement(queryCombined);
				}
				if (result == null) {
					result = caseEModelElement(queryCombined);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.QUERY_SELECT: {
				...
				if (result == null) {
					result = caseQueryExpressionBody(querySelect);
				}
				if (result == null) {
					result = caseTableExpression(querySelect);
				}
				if (result == null) {
					result = caseTableReference(querySelect);
				}
				if (result == null) {
					result = caseSQLQueryObject(querySelect);
				}
				if (result == null) {
					result = caseSQLObject(querySelect);
				}
				if (result == null) {
					result = caseENamedElement(querySelect);
				}
				if (result == null) {
					result = caseEModelElement(querySelect);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.GROUPING_SPECIFICATION: {
				...
				if (result == null) {
					result = caseSQLQueryObject(groupingSpecification);
				}
				if (result == null) {
					result = caseSQLObject(groupingSpecification);
				}
				if (result == null) {
					result = caseENamedElement(groupingSpecification);
				}
				if (result == null) {
					result = caseEModelElement(groupingSpecification);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.QUERY_RESULT_SPECIFICATION: {
				...
				if (result == null) {
					result = caseSQLQueryObject(queryResultSpecification);
				}
				if (result == null) {
					result = caseSQLObject(queryResultSpecification);
				}
				if (result == null) {
					result = caseENamedElement(queryResultSpecification);
				}
				if (result == null) {
					result = caseEModelElement(queryResultSpecification);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.RESULT_TABLE_ALL_COLUMNS: {
				...
				if (result == null) {
					result = caseQueryResultSpecification(resultTableAllColumns);
				}
				if (result == null) {
					result = caseSQLQueryObject(resultTableAllColumns);
				}
				if (result == null) {
					result = caseSQLObject(resultTableAllColumns);
				}
				if (result == null) {
					result = caseENamedElement(resultTableAllColumns);
				}
				if (result == null) {
					result = caseEModelElement(resultTableAllColumns);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.RESULT_COLUMN: {
				...
				if (result == null) {
					result = caseQueryResultSpecification(resultColumn);
				}
				if (result == null) {
					result = caseSQLQueryObject(resultColumn);
				}
				if (result == null) {
					result = caseSQLObject(resultColumn);
				}
				if (result == null) {
					result = caseENamedElement(resultColumn);
				}
				if (result == null) {
					result = caseEModelElement(resultColumn);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.PREDICATE_BASIC: {
				...
				if (result == null) {
					result = casePredicate(predicateBasic);
				}
				if (result == null) {
					result = caseQuerySearchCondition(predicateBasic);
				}
				if (result == null) {
					result = caseSQLQueryObject(predicateBasic);
				}
				if (result == null) {
					result = caseSearchCondition(predicateBasic);
				}
				if (result == null) {
					result = caseSQLObject(predicateBasic);
				}
				if (result == null) {
					result = caseENamedElement(predicateBasic);
				}
				if (result == null) {
					result = caseEModelElement(predicateBasic);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.PREDICATE_QUANTIFIED: {
				...
				if (result == null) {
					result = casePredicate(predicateQuantified);
				}
				if (result == null) {
					result = caseQuerySearchCondition(predicateQuantified);
				}
				if (result == null) {
					result = caseSQLQueryObject(predicateQuantified);
				}
				if (result == null) {
					result = caseSearchCondition(predicateQuantified);
				}
				if (result == null) {
					result = caseSQLObject(predicateQuantified);
				}
				if (result == null) {
					result = caseENamedElement(predicateQuantified);
				}
				if (result == null) {
					result = caseEModelElement(predicateQuantified);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.PREDICATE_BETWEEN: {
				...
				if (result == null) {
					result = casePredicate(predicateBetween);
				}
				if (result == null) {
					result = caseQuerySearchCondition(predicateBetween);
				}
				if (result == null) {
					result = caseSQLQueryObject(predicateBetween);
				}
				if (result == null) {
					result = caseSearchCondition(predicateBetween);
				}
				if (result == null) {
					result = caseSQLObject(predicateBetween);
				}
				if (result == null) {
					result = caseENamedElement(predicateBetween);
				}
				if (result == null) {
					result = caseEModelElement(predicateBetween);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.PREDICATE_EXISTS: {
				...
				if (result == null) {
					result = casePredicate(predicateExists);
				}
				if (result == null) {
					result = caseQuerySearchCondition(predicateExists);
				}
				if (result == null) {
					result = caseSQLQueryObject(predicateExists);
				}
				if (result == null) {
					result = caseSearchCondition(predicateExists);
				}
				if (result == null) {
					result = caseSQLObject(predicateExists);
				}
				if (result == null) {
					result = caseENamedElement(predicateExists);
				}
				if (result == null) {
					result = caseEModelElement(predicateExists);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.PREDICATE_IN: {
				...
				if (result == null) {
					result = casePredicate(predicateIn);
				}
				if (result == null) {
					result = caseQuerySearchCondition(predicateIn);
				}
				if (result == null) {
					result = caseSQLQueryObject(predicateIn);
				}
				if (result == null) {
					result = caseSearchCondition(predicateIn);
				}
				if (result == null) {
					result = caseSQLObject(predicateIn);
				}
				if (result == null) {
					result = caseENamedElement(predicateIn);
				}
				if (result == null) {
					result = caseEModelElement(predicateIn);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.PREDICATE_LIKE: {
				...
				if (result == null) {
					result = casePredicate(predicateLike);
				}
				if (result == null) {
					result = caseQuerySearchCondition(predicateLike);
				}
				if (result == null) {
					result = caseSQLQueryObject(predicateLike);
				}
				if (result == null) {
					result = caseSearchCondition(predicateLike);
				}
				if (result == null) {
					result = caseSQLObject(predicateLike);
				}
				if (result == null) {
					result = caseENamedElement(predicateLike);
				}
				if (result == null) {
					result = caseEModelElement(predicateLike);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.PREDICATE_IS_NULL: {
				...
				if (result == null) {
					result = casePredicate(predicateIsNull);
				}
				if (result == null) {
					result = caseQuerySearchCondition(predicateIsNull);
				}
				if (result == null) {
					result = caseSQLQueryObject(predicateIsNull);
				}
				if (result == null) {
					result = caseSearchCondition(predicateIsNull);
				}
				if (result == null) {
					result = caseSQLObject(predicateIsNull);
				}
				if (result == null) {
					result = caseENamedElement(predicateIsNull);
				}
				if (result == null) {
					result = caseEModelElement(predicateIsNull);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.PREDICATE_QUANTIFIED_VALUE_SELECT: {
				...
				if (result == null) {
					result = casePredicateQuantified(predicateQuantifiedValueSelect);
				}
				if (result == null) {
					result = casePredicate(predicateQuantifiedValueSelect);
				}
				if (result == null) {
					result = caseQuerySearchCondition(predicateQuantifiedValueSelect);
				}
				if (result == null) {
					result = caseSQLQueryObject(predicateQuantifiedValueSelect);
				}
				if (result == null) {
					result = caseSearchCondition(predicateQuantifiedValueSelect);
				}
				if (result == null) {
					result = caseSQLObject(predicateQuantifiedValueSelect);
				}
				if (result == null) {
					result = caseENamedElement(predicateQuantifiedValueSelect);
				}
				if (result == null) {
					result = caseEModelElement(predicateQuantifiedValueSelect);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.PREDICATE_QUANTIFIED_ROW_SELECT: {
				...
				if (result == null) {
					result = casePredicateQuantified(predicateQuantifiedRowSelect);
				}
				if (result == null) {
					result = casePredicate(predicateQuantifiedRowSelect);
				}
				if (result == null) {
					result = caseQuerySearchCondition(predicateQuantifiedRowSelect);
				}
				if (result == null) {
					result = caseSQLQueryObject(predicateQuantifiedRowSelect);
				}
				if (result == null) {
					result = caseSearchCondition(predicateQuantifiedRowSelect);
				}
				if (result == null) {
					result = caseSQLObject(predicateQuantifiedRowSelect);
				}
				if (result == null) {
					result = caseENamedElement(predicateQuantifiedRowSelect);
				}
				if (result == null) {
					result = caseEModelElement(predicateQuantifiedRowSelect);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.PREDICATE_IN_VALUE_SELECT: {
				...
				if (result == null) {
					result = casePredicateIn(predicateInValueSelect);
				}
				if (result == null) {
					result = casePredicate(predicateInValueSelect);
				}
				if (result == null) {
					result = caseQuerySearchCondition(predicateInValueSelect);
				}
				if (result == null) {
					result = caseSQLQueryObject(predicateInValueSelect);
				}
				if (result == null) {
					result = caseSearchCondition(predicateInValueSelect);
				}
				if (result == null) {
					result = caseSQLObject(predicateInValueSelect);
				}
				if (result == null) {
					result = caseENamedElement(predicateInValueSelect);
				}
				if (result == null) {
					result = caseEModelElement(predicateInValueSelect);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.PREDICATE_IN_VALUE_LIST: {
				...
				if (result == null) {
					result = casePredicateIn(predicateInValueList);
				}
				if (result == null) {
					result = casePredicate(predicateInValueList);
				}
				if (result == null) {
					result = caseQuerySearchCondition(predicateInValueList);
				}
				if (result == null) {
					result = caseSQLQueryObject(predicateInValueList);
				}
				if (result == null) {
					result = caseSearchCondition(predicateInValueList);
				}
				if (result == null) {
					result = caseSQLObject(predicateInValueList);
				}
				if (result == null) {
					result = caseENamedElement(predicateInValueList);
				}
				if (result == null) {
					result = caseEModelElement(predicateInValueList);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.PREDICATE_IN_VALUE_ROW_SELECT: {
				...
				if (result == null) {
					result = casePredicateIn(predicateInValueRowSelect);
				}
				if (result == null) {
					result = casePredicate(predicateInValueRowSelect);
				}
				if (result == null) {
					result = caseQuerySearchCondition(predicateInValueRowSelect);
				}
				if (result == null) {
					result = caseSQLQueryObject(predicateInValueRowSelect);
				}
				if (result == null) {
					result = caseSearchCondition(predicateInValueRowSelect);
				}
				if (result == null) {
					result = caseSQLObject(predicateInValueRowSelect);
				}
				if (result == null) {
					result = caseENamedElement(predicateInValueRowSelect);
				}
				if (result == null) {
					result = caseEModelElement(predicateInValueRowSelect);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.VALUE_EXPRESSION_SIMPLE: {
				...
				if (result == null) {
					result = caseValueExpressionAtomic(valueExpressionSimple);
				}
				if (result == null) {
					result = caseQueryValueExpression(valueExpressionSimple);
				}
				if (result == null) {
					result = caseSQLQueryObject(valueExpressionSimple);
				}
				if (result == null) {
					result = caseValueExpression(valueExpressionSimple);
				}
				if (result == null) {
					result = caseSQLObject(valueExpressionSimple);
				}
				if (result == null) {
					result = caseENamedElement(valueExpressionSimple);
				}
				if (result == null) {
					result = caseEModelElement(valueExpressionSimple);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.VALUE_EXPRESSION_COLUMN: {
				...
				if (result == null) {
					result = caseValueExpressionAtomic(valueExpressionColumn);
				}
				if (result == null) {
					result = caseQueryValueExpression(valueExpressionColumn);
				}
				if (result == null) {
					result = caseSQLQueryObject(valueExpressionColumn);
				}
				if (result == null) {
					result = caseValueExpression(valueExpressionColumn);
				}
				if (result == null) {
					result = caseSQLObject(valueExpressionColumn);
				}
				if (result == null) {
					result = caseENamedElement(valueExpressionColumn);
				}
				if (result == null) {
					result = caseEModelElement(valueExpressionColumn);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.VALUE_EXPRESSION_VARIABLE: {
				...
				if (result == null) {
					result = caseValueExpressionAtomic(valueExpressionVariable);
				}
				if (result == null) {
					result = caseQueryValueExpression(valueExpressionVariable);
				}
				if (result == null) {
					result = caseSQLQueryObject(valueExpressionVariable);
				}
				if (result == null) {
					result = caseValueExpression(valueExpressionVariable);
				}
				if (result == null) {
					result = caseSQLObject(valueExpressionVariable);
				}
				if (result == null) {
					result = caseENamedElement(valueExpressionVariable);
				}
				if (result == null) {
					result = caseEModelElement(valueExpressionVariable);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.VALUE_EXPRESSION_SCALAR_SELECT: {
				...
				if (result == null) {
					result = caseValueExpressionAtomic(valueExpressionScalarSelect);
				}
				if (result == null) {
					result = caseQueryValueExpression(valueExpressionScalarSelect);
				}
				if (result == null) {
					result = caseSQLQueryObject(valueExpressionScalarSelect);
				}
				if (result == null) {
					result = caseValueExpression(valueExpressionScalarSelect);
				}
				if (result == null) {
					result = caseSQLObject(valueExpressionScalarSelect);
				}
				if (result == null) {
					result = caseENamedElement(valueExpressionScalarSelect);
				}
				if (result == null) {
					result = caseEModelElement(valueExpressionScalarSelect);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.VALUE_EXPRESSION_LABELED_DURATION: {
				...
				if (result == null) {
					result = caseValueExpressionAtomic(valueExpressionLabeledDuration);
				}
				if (result == null) {
					result = caseQueryValueExpression(valueExpressionLabeledDuration);
				}
				if (result == null) {
					result = caseSQLQueryObject(valueExpressionLabeledDuration);
				}
				if (result == null) {
					result = caseValueExpression(valueExpressionLabeledDuration);
				}
				if (result == null) {
					result = caseSQLObject(valueExpressionLabeledDuration);
				}
				if (result == null) {
					result = caseENamedElement(valueExpressionLabeledDuration);
				}
				if (result == null) {
					result = caseEModelElement(valueExpressionLabeledDuration);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.VALUE_EXPRESSION_CASE: {
				...
				if (result == null) {
					result = caseValueExpressionAtomic(valueExpressionCase);
				}
				if (result == null) {
					result = caseQueryValueExpression(valueExpressionCase);
				}
				if (result == null) {
					result = caseSQLQueryObject(valueExpressionCase);
				}
				if (result == null) {
					result = caseValueExpression(valueExpressionCase);
				}
				if (result == null) {
					result = caseSQLObject(valueExpressionCase);
				}
				if (result == null) {
					result = caseENamedElement(valueExpressionCase);
				}
				if (result == null) {
					result = caseEModelElement(valueExpressionCase);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.VALUE_EXPRESSION_CAST: {
				...
				if (result == null) {
					result = caseValueExpressionAtomic(valueExpressionCast);
				}
				if (result == null) {
					result = caseQueryValueExpression(valueExpressionCast);
				}
				if (result == null) {
					result = caseSQLQueryObject(valueExpressionCast);
				}
				if (result == null) {
					result = caseValueExpression(valueExpressionCast);
				}
				if (result == null) {
					result = caseSQLObject(valueExpressionCast);
				}
				if (result == null) {
					result = caseENamedElement(valueExpressionCast);
				}
				if (result == null) {
					result = caseEModelElement(valueExpressionCast);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.VALUE_EXPRESSION_NULL_VALUE: {
				...
				if (result == null) {
					result = caseValueExpressionAtomic(valueExpressionNullValue);
				}
				if (result == null) {
					result = caseQueryValueExpression(valueExpressionNullValue);
				}
				if (result == null) {
					result = caseSQLQueryObject(valueExpressionNullValue);
				}
				if (result == null) {
					result = caseValueExpression(valueExpressionNullValue);
				}
				if (result == null) {
					result = caseSQLObject(valueExpressionNullValue);
				}
				if (result == null) {
					result = caseENamedElement(valueExpressionNullValue);
				}
				if (result == null) {
					result = caseEModelElement(valueExpressionNullValue);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.VALUE_EXPRESSION_DEFAULT_VALUE: {
				...
				if (result == null) {
					result = caseValueExpressionAtomic(valueExpressionDefaultValue);
				}
				if (result == null) {
					result = caseQueryValueExpression(valueExpressionDefaultValue);
				}
				if (result == null) {
					result = caseSQLQueryObject(valueExpressionDefaultValue);
				}
				if (result == null) {
					result = caseValueExpression(valueExpressionDefaultValue);
				}
				if (result == null) {
					result = caseSQLObject(valueExpressionDefaultValue);
				}
				if (result == null) {
					result = caseENamedElement(valueExpressionDefaultValue);
				}
				if (result == null) {
					result = caseEModelElement(valueExpressionDefaultValue);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.VALUE_EXPRESSION_FUNCTION: {
				...
				if (result == null) {
					result = caseValueExpressionAtomic(valueExpressionFunction);
				}
				if (result == null) {
					result = caseQueryValueExpression(valueExpressionFunction);
				}
				if (result == null) {
					result = caseSQLQueryObject(valueExpressionFunction);
				}
				if (result == null) {
					result = caseValueExpression(valueExpressionFunction);
				}
				if (result == null) {
					result = caseSQLObject(valueExpressionFunction);
				}
				if (result == null) {
					result = caseENamedElement(valueExpressionFunction);
				}
				if (result == null) {
					result = caseEModelElement(valueExpressionFunction);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.VALUE_EXPRESSION_COMBINED: {
				...
				if (result == null) {
					result = caseQueryValueExpression(valueExpressionCombined);
				}
				if (result == null) {
					result = caseSQLQueryObject(valueExpressionCombined);
				}
				if (result == null) {
					result = caseValueExpression(valueExpressionCombined);
				}
				if (result == null) {
					result = caseSQLObject(valueExpressionCombined);
				}
				if (result == null) {
					result = caseENamedElement(valueExpressionCombined);
				}
				if (result == null) {
					result = caseEModelElement(valueExpressionCombined);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.GROUPING_SETS: {
				...
				if (result == null) {
					result = caseGroupingSpecification(groupingSets);
				}
				if (result == null) {
					result = caseSQLQueryObject(groupingSets);
				}
				if (result == null) {
					result = caseSQLObject(groupingSets);
				}
				if (result == null) {
					result = caseENamedElement(groupingSets);
				}
				if (result == null) {
					result = caseEModelElement(groupingSets);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.GROUPING: {
				...
				if (result == null) {
					result = caseGroupingSpecification(grouping);
				}
				if (result == null) {
					result = caseSQLQueryObject(grouping);
				}
				if (result == null) {
					result = caseSQLObject(grouping);
				}
				if (result == null) {
					result = caseENamedElement(grouping);
				}
				if (result == null) {
					result = caseEModelElement(grouping);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.GROUPING_SETS_ELEMENT: {
				...
				if (result == null) {
					result = caseSQLQueryObject(groupingSetsElement);
				}
				if (result == null) {
					result = caseSQLObject(groupingSetsElement);
				}
				if (result == null) {
					result = caseENamedElement(groupingSetsElement);
				}
				if (result == null) {
					result = caseEModelElement(groupingSetsElement);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.GROUPING_SETS_ELEMENT_SUBLIST: {
				...
				if (result == null) {
					result = caseGroupingSetsElement(groupingSetsElementSublist);
				}
				if (result == null) {
					result = caseSQLQueryObject(groupingSetsElementSublist);
				}
				if (result == null) {
					result = caseSQLObject(groupingSetsElementSublist);
				}
				if (result == null) {
					result = caseENamedElement(groupingSetsElementSublist);
				}
				if (result == null) {
					result = caseEModelElement(groupingSetsElementSublist);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.GROUPING_SETS_ELEMENT_EXPRESSION: {
				...
				if (result == null) {
					result = caseGroupingSetsElement(groupingSetsElementExpression);
				}
				if (result == null) {
					result = caseSQLQueryObject(groupingSetsElementExpression);
				}
				if (result == null) {
					result = caseSQLObject(groupingSetsElementExpression);
				}
				if (result == null) {
					result = caseENamedElement(groupingSetsElementExpression);
				}
				if (result == null) {
					result = caseEModelElement(groupingSetsElementExpression);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.SUPER_GROUP: {
				...
				if (result == null) {
					result = caseGrouping(superGroup);
				}
				if (result == null) {
					result = caseGroupingSpecification(superGroup);
				}
				if (result == null) {
					result = caseSQLQueryObject(superGroup);
				}
				if (result == null) {
					result = caseSQLObject(superGroup);
				}
				if (result == null) {
					result = caseENamedElement(superGroup);
				}
				if (result == null) {
					result = caseEModelElement(superGroup);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.GROUPING_EXPRESSION: {
				...
				if (result == null) {
					result = caseGrouping(groupingExpression);
				}
				if (result == null) {
					result = caseGroupingSpecification(groupingExpression);
				}
				if (result == null) {
					result = caseSQLQueryObject(groupingExpression);
				}
				if (result == null) {
					result = caseSQLObject(groupingExpression);
				}
				if (result == null) {
					result = caseENamedElement(groupingExpression);
				}
				if (result == null) {
					result = caseEModelElement(groupingExpression);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.SUPER_GROUP_ELEMENT: {
				...
				if (result == null) {
					result = caseSQLQueryObject(superGroupElement);
				}
				if (result == null) {
					result = caseSQLObject(superGroupElement);
				}
				if (result == null) {
					result = caseENamedElement(superGroupElement);
				}
				if (result == null) {
					result = caseEModelElement(superGroupElement);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.SUPER_GROUP_ELEMENT_SUBLIST: {
				...
				if (result == null) {
					result = caseSuperGroupElement(superGroupElementSublist);
				}
				if (result == null) {
					result = caseSQLQueryObject(superGroupElementSublist);
				}
				if (result == null) {
					result = caseSQLObject(superGroupElementSublist);
				}
				if (result == null) {
					result = caseENamedElement(superGroupElementSublist);
				}
				if (result == null) {
					result = caseEModelElement(superGroupElementSublist);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.SUPER_GROUP_ELEMENT_EXPRESSION: {
				...
				if (result == null) {
					result = caseSuperGroupElement(superGroupElementExpression);
				}
				if (result == null) {
					result = caseSQLQueryObject(superGroupElementExpression);
				}
				if (result == null) {
					result = caseSQLObject(superGroupElementExpression);
				}
				if (result == null) {
					result = caseENamedElement(superGroupElementExpression);
				}
				if (result == null) {
					result = caseEModelElement(superGroupElementExpression);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.VALUE_EXPRESSION_CASE_SEARCH: {
				...
				if (result == null) {
					result = caseValueExpressionCase(valueExpressionCaseSearch);
				}
				if (result == null) {
					result = caseValueExpressionAtomic(valueExpressionCaseSearch);
				}
				if (result == null) {
					result = caseQueryValueExpression(valueExpressionCaseSearch);
				}
				if (result == null) {
					result = caseSQLQueryObject(valueExpressionCaseSearch);
				}
				if (result == null) {
					result = caseValueExpression(valueExpressionCaseSearch);
				}
				if (result == null) {
					result = caseSQLObject(valueExpressionCaseSearch);
				}
				if (result == null) {
					result = caseENamedElement(valueExpressionCaseSearch);
				}
				if (result == null) {
					result = caseEModelElement(valueExpressionCaseSearch);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.VALUE_EXPRESSION_CASE_SIMPLE: {
				...
				if (result == null) {
					result = caseValueExpressionCase(valueExpressionCaseSimple);
				}
				if (result == null) {
					result = caseValueExpressionAtomic(valueExpressionCaseSimple);
				}
				if (result == null) {
					result = caseQueryValueExpression(valueExpressionCaseSimple);
				}
				if (result == null) {
					result = caseSQLQueryObject(valueExpressionCaseSimple);
				}
				if (result == null) {
					result = caseValueExpression(valueExpressionCaseSimple);
				}
				if (result == null) {
					result = caseSQLObject(valueExpressionCaseSimple);
				}
				if (result == null) {
					result = caseENamedElement(valueExpressionCaseSimple);
				}
				if (result == null) {
					result = caseEModelElement(valueExpressionCaseSimple);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.VALUE_EXPRESSION_CASE_ELSE: {
				...
				if (result == null) {
					result = caseSQLQueryObject(valueExpressionCaseElse);
				}
				if (result == null) {
					result = caseSQLObject(valueExpressionCaseElse);
				}
				if (result == null) {
					result = caseENamedElement(valueExpressionCaseElse);
				}
				if (result == null) {
					result = caseEModelElement(valueExpressionCaseElse);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.VALUE_EXPRESSION_CASE_SEARCH_CONTENT: {
				...
				if (result == null) {
					result = caseSQLQueryObject(valueExpressionCaseSearchContent);
				}
				if (result == null) {
					result = caseSQLObject(valueExpressionCaseSearchContent);
				}
				if (result == null) {
					result = caseENamedElement(valueExpressionCaseSearchContent);
				}
				if (result == null) {
					result = caseEModelElement(valueExpressionCaseSearchContent);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.VALUE_EXPRESSION_CASE_SIMPLE_CONTENT: {
				...
				if (result == null) {
					result = caseSQLQueryObject(valueExpressionCaseSimpleContent);
				}
				if (result == null) {
					result = caseSQLObject(valueExpressionCaseSimpleContent);
				}
				if (result == null) {
					result = caseENamedElement(valueExpressionCaseSimpleContent);
				}
				if (result == null) {
					result = caseEModelElement(valueExpressionCaseSimpleContent);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.TABLE_IN_DATABASE: {
				...
				if (result == null) {
					result = caseTableExpression(tableInDatabase);
				}
				if (result == null) {
					result = caseTableReference(tableInDatabase);
				}
				if (result == null) {
					result = caseSQLQueryObject(tableInDatabase);
				}
				if (result == null) {
					result = caseSQLObject(tableInDatabase);
				}
				if (result == null) {
					result = caseENamedElement(tableInDatabase);
				}
				if (result == null) {
					result = caseEModelElement(tableInDatabase);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.TABLE_FUNCTION: {
				...
				if (result == null) {
					result = caseTableExpression(tableFunction);
				}
				if (result == null) {
					result = caseTableReference(tableFunction);
				}
				if (result == null) {
					result = caseSQLQueryObject(tableFunction);
				}
				if (result == null) {
					result = caseSQLObject(tableFunction);
				}
				if (result == null) {
					result = caseENamedElement(tableFunction);
				}
				if (result == null) {
					result = caseEModelElement(tableFunction);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.SQL_QUERY_OBJECT: {
				...
				if (result == null) {
					result = caseSQLObject(sqlQueryObject);
				}
				if (result == null) {
					result = caseENamedElement(sqlQueryObject);
				}
				if (result == null) {
					result = caseEModelElement(sqlQueryObject);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.QUERY_CHANGE_STATEMENT: {
				...
				if (result == null) {
					result = caseQueryStatement(queryChangeStatement);
				}
				if (result == null) {
					result = caseSQLDataChangeStatement(queryChangeStatement);
				}
				if (result == null) {
					result = caseSQLQueryObject(queryChangeStatement);
				}
				if (result == null) {
					result = caseSQLDataStatement(queryChangeStatement);
				}
				if (result == null) {
					result = caseSQLObject(queryChangeStatement);
				}
				if (result == null) {
					result = caseSQLStatement(queryChangeStatement);
				}
				if (result == null) {
					result = caseENamedElement(queryChangeStatement);
				}
				if (result == null) {
					result = caseEModelElement(queryChangeStatement);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.COLUMN_NAME: {
				...
				if (result == null) {
					result = caseSQLQueryObject(columnName);
				}
				if (result == null) {
					result = caseSQLObject(columnName);
				}
				if (result == null) {
					result = caseENamedElement(columnName);
				}
				if (result == null) {
					result = caseEModelElement(columnName);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.TABLE_NESTED: {
				...
				if (result == null) {
					result = caseTableReference(tableNested);
				}
				if (result == null) {
					result = caseSQLQueryObject(tableNested);
				}
				if (result == null) {
					result = caseSQLObject(tableNested);
				}
				if (result == null) {
					result = caseENamedElement(tableNested);
				}
				if (result == null) {
					result = caseEModelElement(tableNested);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.QUERY_MERGE_STATEMENT: {
				...
				if (result == null) {
					result = caseQueryChangeStatement(queryMergeStatement);
				}
				if (result == null) {
					result = caseQueryStatement(queryMergeStatement);
				}
				if (result == null) {
					result = caseSQLDataChangeStatement(queryMergeStatement);
				}
				if (result == null) {
					result = caseSQLQueryObject(queryMergeStatement);
				}
				if (result == null) {
					result = caseSQLDataStatement(queryMergeStatement);
				}
				if (result == null) {
					result = caseSQLObject(queryMergeStatement);
				}
				if (result == null) {
					result = caseSQLStatement(queryMergeStatement);
				}
				if (result == null) {
					result = caseENamedElement(queryMergeStatement);
				}
				if (result == null) {
					result = caseEModelElement(queryMergeStatement);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.SEARCH_CONDITION_NESTED: {
				...
				if (result == null) {
					result = caseQuerySearchCondition(searchConditionNested);
				}
				if (result == null) {
					result = caseSQLQueryObject(searchConditionNested);
				}
				if (result == null) {
					result = caseSearchCondition(searchConditionNested);
				}
				if (result == null) {
					result = caseSQLObject(searchConditionNested);
				}
				if (result == null) {
					result = caseENamedElement(searchConditionNested);
				}
				if (result == null) {
					result = caseEModelElement(searchConditionNested);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.VALUE_EXPRESSION_NESTED: {
				...
				if (result == null) {
					result = caseQueryValueExpression(valueExpressionNested);
				}
				if (result == null) {
					result = caseSQLQueryObject(valueExpressionNested);
				}
				if (result == null) {
					result = caseValueExpression(valueExpressionNested);
				}
				if (result == null) {
					result = caseSQLObject(valueExpressionNested);
				}
				if (result == null) {
					result = caseENamedElement(valueExpressionNested);
				}
				if (result == null) {
					result = caseEModelElement(valueExpressionNested);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.VALUE_EXPRESSION_ATOMIC: {
				...
				if (result == null) {
					result = caseQueryValueExpression(valueExpressionAtomic);
				}
				if (result == null) {
					result = caseSQLQueryObject(valueExpressionAtomic);
				}
				if (result == null) {
					result = caseValueExpression(valueExpressionAtomic);
				}
				if (result == null) {
					result = caseSQLObject(valueExpressionAtomic);
				}
				if (result == null) {
					result = caseENamedElement(valueExpressionAtomic);
				}
				if (result == null) {
					result = caseEModelElement(valueExpressionAtomic);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.ORDER_BY_SPECIFICATION: {
				...
				if (result == null) {
					result = caseSQLQueryObject(orderBySpecification);
				}
				if (result == null) {
					result = caseSQLObject(orderBySpecification);
				}
				if (result == null) {
					result = caseENamedElement(orderBySpecification);
				}
				if (result == null) {
					result = caseEModelElement(orderBySpecification);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.ORDER_BY_ORDINAL: {
				...
				if (result == null) {
					result = caseOrderBySpecification(orderByOrdinal);
				}
				if (result == null) {
					result = caseSQLQueryObject(orderByOrdinal);
				}
				if (result == null) {
					result = caseSQLObject(orderByOrdinal);
				}
				if (result == null) {
					result = caseENamedElement(orderByOrdinal);
				}
				if (result == null) {
					result = caseEModelElement(orderByOrdinal);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.TABLE_CORRELATION: {
				...
				if (result == null) {
					result = caseSQLQueryObject(tableCorrelation);
				}
				if (result == null) {
					result = caseSQLObject(tableCorrelation);
				}
				if (result == null) {
					result = caseENamedElement(tableCorrelation);
				}
				if (result == null) {
					result = caseEModelElement(tableCorrelation);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.UPDATE_SOURCE: {
				...
				if (result == null) {
					result = caseSQLQueryObject(updateSource);
				}
				if (result == null) {
					result = caseSQLObject(updateSource);
				}
				if (result == null) {
					result = caseENamedElement(updateSource);
				}
				if (result == null) {
					result = caseEModelElement(updateSource);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.UPDATE_SOURCE_EXPR_LIST: {
				...
				if (result == null) {
					result = caseUpdateSource(updateSourceExprList);
				}
				if (result == null) {
					result = caseSQLQueryObject(updateSourceExprList);
				}
				if (result == null) {
					result = caseSQLObject(updateSourceExprList);
				}
				if (result == null) {
					result = caseENamedElement(updateSourceExprList);
				}
				if (result == null) {
					result = caseEModelElement(updateSourceExprList);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.UPDATE_SOURCE_QUERY: {
				...
				if (result == null) {
					result = caseUpdateSource(updateSourceQuery);
				}
				if (result == null) {
					result = caseSQLQueryObject(updateSourceQuery);
				}
				if (result == null) {
					result = caseSQLObject(updateSourceQuery);
				}
				if (result == null) {
					result = caseENamedElement(updateSourceQuery);
				}
				if (result == null) {
					result = caseEModelElement(updateSourceQuery);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.ORDER_BY_RESULT_COLUMN: {
				...
				if (result == null) {
					result = caseOrderBySpecification(orderByResultColumn);
				}
				if (result == null) {
					result = caseSQLQueryObject(orderByResultColumn);
				}
				if (result == null) {
					result = caseSQLObject(orderByResultColumn);
				}
				if (result == null) {
					result = caseENamedElement(orderByResultColumn);
				}
				if (result == null) {
					result = caseEModelElement(orderByResultColumn);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.WITH_TABLE_REFERENCE: {
				...
				if (result == null) {
					result = caseTableExpression(withTableReference);
				}
				if (result == null) {
					result = caseTableReference(withTableReference);
				}
				if (result == null) {
					result = caseSQLQueryObject(withTableReference);
				}
				if (result == null) {
					result = caseSQLObject(withTableReference);
				}
				if (result == null) {
					result = caseENamedElement(withTableReference);
				}
				if (result == null) {
					result = caseEModelElement(withTableReference);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.QUERY_NESTED: {
				...
				if (result == null) {
					result = caseQueryExpressionBody(queryNested);
				}
				if (result == null) {
					result = caseTableExpression(queryNested);
				}
				if (result == null) {
					result = caseTableReference(queryNested);
				}
				if (result == null) {
					result = caseSQLQueryObject(queryNested);
				}
				if (result == null) {
					result = caseSQLObject(queryNested);
				}
				if (result == null) {
					result = caseENamedElement(queryNested);
				}
				if (result == null) {
					result = caseEModelElement(queryNested);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.VALUE_EXPRESSION_ROW: {
				...
				if (result == null) {
					result = caseQueryValueExpression(valueExpressionRow);
				}
				if (result == null) {
					result = caseSQLQueryObject(valueExpressionRow);
				}
				if (result == null) {
					result = caseValueExpression(valueExpressionRow);
				}
				if (result == null) {
					result = caseSQLObject(valueExpressionRow);
				}
				if (result == null) {
					result = caseENamedElement(valueExpressionRow);
				}
				if (result == null) {
					result = caseEModelElement(valueExpressionRow);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.MERGE_TARGET_TABLE: {
				...
				if (result == null) {
					result = caseSQLQueryObject(mergeTargetTable);
				}
				if (result == null) {
					result = caseSQLObject(mergeTargetTable);
				}
				if (result == null) {
					result = caseENamedElement(mergeTargetTable);
				}
				if (result == null) {
					result = caseEModelElement(mergeTargetTable);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.MERGE_SOURCE_TABLE: {
				...
				if (result == null) {
					result = caseSQLQueryObject(mergeSourceTable);
				}
				if (result == null) {
					result = caseSQLObject(mergeSourceTable);
				}
				if (result == null) {
					result = caseENamedElement(mergeSourceTable);
				}
				if (result == null) {
					result = caseEModelElement(mergeSourceTable);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.MERGE_ON_CONDITION: {
				...
				if (result == null) {
					result = caseSQLQueryObject(mergeOnCondition);
				}
				if (result == null) {
					result = caseSQLObject(mergeOnCondition);
				}
				if (result == null) {
					result = caseENamedElement(mergeOnCondition);
				}
				if (result == null) {
					result = caseEModelElement(mergeOnCondition);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.MERGE_UPDATE_SPECIFICATION: {
				...
				if (result == null) {
					result = caseMergeOperationSpecification(mergeUpdateSpecification);
				}
				if (result == null) {
					result = caseSQLQueryObject(mergeUpdateSpecification);
				}
				if (result == null) {
					result = caseSQLObject(mergeUpdateSpecification);
				}
				if (result == null) {
					result = caseENamedElement(mergeUpdateSpecification);
				}
				if (result == null) {
					result = caseEModelElement(mergeUpdateSpecification);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.MERGE_INSERT_SPECIFICATION: {
				...
				if (result == null) {
					result = caseMergeOperationSpecification(mergeInsertSpecification);
				}
				if (result == null) {
					result = caseSQLQueryObject(mergeInsertSpecification);
				}
				if (result == null) {
					result = caseSQLObject(mergeInsertSpecification);
				}
				if (result == null) {
					result = caseENamedElement(mergeInsertSpecification);
				}
				if (result == null) {
					result = caseEModelElement(mergeInsertSpecification);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.MERGE_OPERATION_SPECIFICATION: {
				...
				if (result == null) {
					result = caseSQLQueryObject(mergeOperationSpecification);
				}
				if (result == null) {
					result = caseSQLObject(mergeOperationSpecification);
				}
				if (result == null) {
					result = caseENamedElement(mergeOperationSpecification);
				}
				if (result == null) {
					result = caseEModelElement(mergeOperationSpecification);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.UPDATE_OF_COLUMN: {
				...
				if (result == null) {
					result = caseSQLQueryObject(updateOfColumn);
				}
				if (result == null) {
					result = caseSQLObject(updateOfColumn);
				}
				if (result == null) {
					result = caseENamedElement(updateOfColumn);
				}
				if (result == null) {
					result = caseEModelElement(updateOfColumn);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.UPDATABILITY_EXPRESSION: {
				...
				if (result == null) {
					result = caseSQLQueryObject(updatabilityExpression);
				}
				if (result == null) {
					result = caseSQLObject(updatabilityExpression);
				}
				if (result == null) {
					result = caseENamedElement(updatabilityExpression);
				}
				if (result == null) {
					result = caseEModelElement(updatabilityExpression);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.CALL_STATEMENT: {
				...
				if (result == null) {
					result = caseSQLQueryObject(callStatement);
				}
				if (result == null) {
					result = caseSQLControlStatement(callStatement);
				}
				if (result == null) {
					result = caseSQLObject(callStatement);
				}
				if (result == null) {
					result = caseSQLStatement(callStatement);
				}
				if (result == null) {
					result = caseENamedElement(callStatement);
				}
				if (result == null) {
					result = caseEModelElement(callStatement);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.PROCEDURE_REFERENCE: {
				...
				if (result == null) {
					result = caseSQLQueryObject(procedureReference);
				}
				if (result == null) {
					result = caseSQLObject(procedureReference);
				}
				if (result == null) {
					result = caseENamedElement(procedureReference);
				}
				if (result == null) {
					result = caseEModelElement(procedureReference);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SQLQueryModelPackage.TABLE_QUERY_LATERAL: {
				...
				if (result == null) {
					result = caseTableExpression(tableQueryLateral);
				}
				if (result == null) {
					result = caseTableReference(tableQueryLateral);
				}
				if (result == null) {
					result = caseSQLQueryObject(tableQueryLateral);
				}
				if (result == null) {
					result = caseSQLObject(tableQueryLateral);
				}
				if (result == null) {
					result = caseENamedElement(tableQueryLateral);
				}
				if (result == null) {
					result = caseEModelElement(tableQueryLateral);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
