...
public class SQLQueryModelPackageImpl extends EPackageImpl implements SQLQueryModelPackage {
	...
	public static SQLQueryModelPackage init() {
		...
		Object registeredSQLQueryModelPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		SQLQueryModelPackageImpl theSQLQueryModelPackage = registeredSQLQueryModelPackage instanceof SQLQueryModelPackageImpl ? (SQLQueryModelPackageImpl)registeredSQLQueryModelPackage : new SQLQueryModelPackageImpl();
	...
	public void initializePackageContents() {
		...
		initEReference(getQueryExpressionBody_UpdateSourceQuery(), this.getUpdateSourceQuery(), this.getUpdateSourceQuery_QueryExpr(), "updateSourceQuery", null, 0, 1, QueryExpressionBody.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getQueryExpressionBody_WithTableSpecification(), this.getWithTableSpecification(), this.getWithTableSpecification_WithTableQueryExpr(), "withTableSpecification", null, 0, 1, QueryExpressionBody.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getQueryValueExpression_TableFunction(), this.getTableFunction(), this.getTableFunction_ParameterList(), "tableFunction", null, 0, 1, QueryValueExpression.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getQueryValueExpression_ValueExprRow(), this.getValueExpressionRow(), this.getValueExpressionRow_ValueExprList(), "valueExprRow", null, 0, 1, QueryValueExpression.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getQueryValueExpression_CallStatement(), this.getCallStatement(), this.getCallStatement_ArgumentList(), "callStatement", null, 0, 1, QueryValueExpression.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getValuesRow_QueryValues(), this.getQueryValues(), this.getQueryValues_ValuesRowList(), "queryValues", null, 0, 1, ValuesRow.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTableReference_TableJoinedRight(), this.getTableJoined(), this.getTableJoined_TableRefRight(), "tableJoinedRight", null, 0, 1, TableReference.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTableReference_TableJoinedLeft(), this.getTableJoined(), this.getTableJoined_TableRefLeft(), "tableJoinedLeft", null, 0, 1, TableReference.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTableInDatabase_DatabaseTable(), theSQLTablesPackage.getTable(), null, "databaseTable", null, 0, 1, TableInDatabase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getColumnName_WithTableSpecification(), this.getWithTableSpecification(), this.getWithTableSpecification_ColumnNameList(), "withTableSpecification", null, 0, 1, ColumnName.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
