...
public QueryUpdateStatement getUpdateStatement() {
		if (eContainerFeatureID() != SQLQueryModelPackage.UPDATE_ASSIGNMENT_EXPRESSION__UPDATE_STATEMENT) {
			return null;
		}
...
public void setUpdateSource(UpdateSource newUpdateSource) {
	...
	public MergeUpdateSpecification getMergeUpdateSpec() {
		if (eContainerFeatureID() != SQLQueryModelPackage.UPDATE_ASSIGNMENT_EXPRESSION__MERGE_UPDATE_SPEC) {
			return null;
		}
		return (MergeUpdateSpecification)eInternalContainer();
	}
