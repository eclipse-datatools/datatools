...
public abstract class TableReferenceImpl extends SQLQueryObjectImpl implements TableReference {
	...
	public TableJoined getTableJoinedRight() {
		if (eContainerFeatureID() != SQLQueryModelPackage.TABLE_REFERENCE__TABLE_JOINED_RIGHT) {
			return null;
		}
	...
	public TableJoined getTableJoinedLeft() {
		if (eContainerFeatureID() != SQLQueryModelPackage.TABLE_REFERENCE__TABLE_JOINED_LEFT) {
			return null;
		}
		return (TableJoined)eInternalContainer();
	}
	...
	public QuerySelect getQuerySelect() {
		if (eContainerFeatureID() != SQLQueryModelPackage.TABLE_REFERENCE__QUERY_SELECT) {
			return null;
		}
...
public TableNested getNest() {
		if (eContainerFeatureID() != SQLQueryModelPackage.TABLE_REFERENCE__NEST) {
			return null;
		}
		return (TableNested)eInternalContainer();
	}
...
public void setNest(TableNested newNest) {
	...
	public MergeSourceTable getMergeSourceTable() {
		if (eContainerFeatureID() != SQLQueryModelPackage.TABLE_REFERENCE__MERGE_SOURCE_TABLE) {
			return null;
		}
		return (MergeSourceTable)eInternalContainer();
	}
