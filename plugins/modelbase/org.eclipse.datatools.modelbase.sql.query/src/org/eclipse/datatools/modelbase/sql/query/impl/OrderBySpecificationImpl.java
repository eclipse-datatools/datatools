...
public abstract class OrderBySpecificationImpl extends SQLQueryObjectImpl implements OrderBySpecification {
	...
	public QuerySelectStatement getSelectStatement() {
		if (eContainerFeatureID() != SQLQueryModelPackage.ORDER_BY_SPECIFICATION__SELECT_STATEMENT) {
			return null;
		}
	...
	public QueryExpressionBody getQuery() {
		if (eContainerFeatureID() != SQLQueryModelPackage.ORDER_BY_SPECIFICATION__QUERY) {
			return null;
		}
		return (QueryExpressionBody)eInternalContainer();
	}
