...
public QueryUpdateStatement getUpdateStatement() {
		if (eContainerFeatureID() != SQLQueryModelPackage.TABLE_IN_DATABASE__UPDATE_STATEMENT) {
			return null;
		}
...
public QueryDeleteStatement getDeleteStatement() {
		if (eContainerFeatureID() != SQLQueryModelPackage.TABLE_IN_DATABASE__DELETE_STATEMENT) {
			return null;
		}
...
public QueryInsertStatement getInsertStatement() {
		if (eContainerFeatureID() != SQLQueryModelPackage.TABLE_IN_DATABASE__INSERT_STATEMENT) {
			return null;
		}
