...
public class QueryExpressionRootImpl extends SQLQueryObjectImpl implements QueryExpressionRoot {
	...
	public QueryInsertStatement getInsertStatement() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_EXPRESSION_ROOT__INSERT_STATEMENT) {
			return null;
		}
		return (QueryInsertStatement)eInternalContainer();
	}
	...
	public QuerySelectStatement getSelectStatement() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_EXPRESSION_ROOT__SELECT_STATEMENT) {
			return null;
		}
		return (QuerySelectStatement)eInternalContainer();
	}
	...
	public PredicateInValueRowSelect getInValueRowSelectRight() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_EXPRESSION_ROOT__IN_VALUE_ROW_SELECT_RIGHT) {
			return null;
		}
	...
	public PredicateInValueSelect getInValueSelectRight() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_EXPRESSION_ROOT__IN_VALUE_SELECT_RIGHT) {
			return null;
		}
	...
	public PredicateQuantifiedRowSelect getQuantifiedRowSelectRight() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_EXPRESSION_ROOT__QUANTIFIED_ROW_SELECT_RIGHT) {
			return null;
		}
	...
	public PredicateQuantifiedValueSelect getQuantifiedValueSelectRight() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_EXPRESSION_ROOT__QUANTIFIED_VALUE_SELECT_RIGHT) {
			return null;
		}
	...
	public ValueExpressionScalarSelect getValExprScalarSelect() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_EXPRESSION_ROOT__VAL_EXPR_SCALAR_SELECT) {
			return null;
		}
		return (ValueExpressionScalarSelect)eInternalContainer();
	}
