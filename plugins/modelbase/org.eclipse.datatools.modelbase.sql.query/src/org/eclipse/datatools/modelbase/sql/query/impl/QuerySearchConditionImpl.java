...
public abstract class QuerySearchConditionImpl extends SQLQueryObjectImpl implements QuerySearchCondition {
	...
	public QueryUpdateStatement getUpdateStatement() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_SEARCH_CONDITION__UPDATE_STATEMENT) {
			return null;
		}
		return (QueryUpdateStatement)eInternalContainer();
	}
	...
	public QueryDeleteStatement getDeleteStatement() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_SEARCH_CONDITION__DELETE_STATEMENT) {
			return null;
		}
		return (QueryDeleteStatement)eInternalContainer();
	}
	...
	public TableJoined getTableJoined() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_SEARCH_CONDITION__TABLE_JOINED) {
			return null;
		}
		return (TableJoined)eInternalContainer();
	}
	...
	public SearchConditionCombined getCombinedLeft() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_SEARCH_CONDITION__COMBINED_LEFT) {
			return null;
		}
		return (SearchConditionCombined)eInternalContainer();
	}
	...
	public SearchConditionCombined getCombinedRight() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_SEARCH_CONDITION__COMBINED_RIGHT) {
			return null;
		}
		return (SearchConditionCombined)eInternalContainer();
	}
	...
	public QuerySelect getQuerySelectHaving() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_SEARCH_CONDITION__QUERY_SELECT_HAVING) {
			return null;
		}
		return (QuerySelect)eInternalContainer();
	}
	...
	public QuerySelect getQuerySelectWhere() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_SEARCH_CONDITION__QUERY_SELECT_WHERE) {
			return null;
		}
		return (QuerySelect)eInternalContainer();
	}
	...
	public ValueExpressionCaseSearchContent getValueExprCaseSearchContent() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_SEARCH_CONDITION__VALUE_EXPR_CASE_SEARCH_CONTENT) {
			return null;
		}
...
public SearchConditionNested getNest() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_SEARCH_CONDITION__NEST) {
			return null;
		}
		return (SearchConditionNested)eInternalContainer();
	}
...
public void setNest(SearchConditionNested newNest) {
	...
	public MergeOnCondition getMergeOnCondition() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_SEARCH_CONDITION__MERGE_ON_CONDITION) {
			return null;
		}
		return (MergeOnCondition)eInternalContainer();
	}
