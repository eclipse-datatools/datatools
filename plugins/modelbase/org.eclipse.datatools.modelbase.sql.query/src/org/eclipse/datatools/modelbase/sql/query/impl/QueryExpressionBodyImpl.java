...
public abstract class QueryExpressionBodyImpl extends TableExpressionImpl implements QueryExpressionBody {
	...
	public QueryExpressionRoot getQueryExpression() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_EXPRESSION_BODY__QUERY_EXPRESSION) {
			return null;
		}
		return (QueryExpressionRoot)eInternalContainer();
	}
	...
	public QueryCombined getCombinedLeft() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_EXPRESSION_BODY__COMBINED_LEFT) {
			return null;
		}
		return (QueryCombined)eInternalContainer();
	}
	...
	public QueryCombined getCombinedRight() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_EXPRESSION_BODY__COMBINED_RIGHT) {
			return null;
		}
		return (QueryCombined)eInternalContainer();
	}
	...
	public PredicateExists getPredicateExists() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_EXPRESSION_BODY__PREDICATE_EXISTS) {
			return null;
		}
		return (PredicateExists)eInternalContainer();
	}
...
public UpdateSourceQuery getUpdateSourceQuery() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_EXPRESSION_BODY__UPDATE_SOURCE_QUERY) {
			return null;
		}
		return (UpdateSourceQuery)eInternalContainer();
	}
...
public void setUpdateSourceQuery(UpdateSourceQuery newUpdateSourceQuery) {
	...
	public WithTableSpecification getWithTableSpecification() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_EXPRESSION_BODY__WITH_TABLE_SPECIFICATION) {
			return null;
		}
		return (WithTableSpecification)eInternalContainer();
	}
	...
	public QueryNested getQueryNest() {
		if (eContainerFeatureID() != SQLQueryModelPackage.QUERY_EXPRESSION_BODY__QUERY_NEST) {
			return null;
		}
		return (QueryNested)eInternalContainer();
	}
