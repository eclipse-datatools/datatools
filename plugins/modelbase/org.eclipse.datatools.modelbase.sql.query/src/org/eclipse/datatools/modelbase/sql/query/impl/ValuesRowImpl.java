...
public class ValuesRowImpl extends SQLQueryObjectImpl implements ValuesRow {
	...
	public QueryInsertStatement getInsertStatement() {
		if (eContainerFeatureID() != SQLQueryModelPackage.VALUES_ROW__INSERT_STATEMENT) {
			return null;
		}
	...
	public QueryValues getQueryValues() {
		if (eContainerFeatureID() != SQLQueryModelPackage.VALUES_ROW__QUERY_VALUES) {
			return null;
		}
		return (QueryValues)eInternalContainer();
	}
