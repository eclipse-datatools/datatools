...
public class ColumnNameImpl extends SQLQueryObjectImpl implements ColumnName {
	...
	public TableCorrelation getTableCorrelation() {
		if (eContainerFeatureID() != SQLQueryModelPackage.COLUMN_NAME__TABLE_CORRELATION) {
			return null;
		}
		return (TableCorrelation)eInternalContainer();
	}
	...
	public WithTableSpecification getWithTableSpecification() {
		if (eContainerFeatureID() != SQLQueryModelPackage.COLUMN_NAME__WITH_TABLE_SPECIFICATION) {
			return null;
		}
