 ...
 * </copyright>
 *
 * $Id: XMLPredicateImpl.java,v 1.2 2005/12/17 01:52:31 bpayton Exp $
 */
...
public abstract class XMLPredicateImpl extends PredicateImpl implements XMLPredicate {
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				case SQLXMLQueryPackage.XML_PREDICATE__EANNOTATIONS:
					return ((InternalEList)getEAnnotations()).basicAdd(otherEnd, msgs);
				case SQLXMLQueryPackage.XML_PREDICATE__UPDATE_STATEMENT:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_PREDICATE__UPDATE_STATEMENT, msgs);
				case SQLXMLQueryPackage.XML_PREDICATE__DELETE_STATEMENT:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_PREDICATE__DELETE_STATEMENT, msgs);
				case SQLXMLQueryPackage.XML_PREDICATE__TABLE_JOINED:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_PREDICATE__TABLE_JOINED, msgs);
				case SQLXMLQueryPackage.XML_PREDICATE__COMBINED_LEFT:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_PREDICATE__COMBINED_LEFT, msgs);
				case SQLXMLQueryPackage.XML_PREDICATE__COMBINED_RIGHT:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_PREDICATE__COMBINED_RIGHT, msgs);
				case SQLXMLQueryPackage.XML_PREDICATE__QUERY_SELECT_HAVING:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_PREDICATE__QUERY_SELECT_HAVING, msgs);
				case SQLXMLQueryPackage.XML_PREDICATE__QUERY_SELECT_WHERE:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_PREDICATE__QUERY_SELECT_WHERE, msgs);
				case SQLXMLQueryPackage.XML_PREDICATE__VALUE_EXPR_CASE_SEARCH_CONTENT:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_PREDICATE__VALUE_EXPR_CASE_SEARCH_CONTENT, msgs);
				case SQLXMLQueryPackage.XML_PREDICATE__NEST:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_PREDICATE__NEST, msgs);
				default:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case SQLXMLQueryPackage.XML_PREDICATE__DEPENDENCIES:
					return ((InternalEList)getDependencies()).basicRemove(otherEnd, msgs);
				case SQLXMLQueryPackage.XML_PREDICATE__UPDATE_STATEMENT:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_PREDICATE__UPDATE_STATEMENT, msgs);
				case SQLXMLQueryPackage.XML_PREDICATE__DELETE_STATEMENT:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_PREDICATE__DELETE_STATEMENT, msgs);
				case SQLXMLQueryPackage.XML_PREDICATE__TABLE_JOINED:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_PREDICATE__TABLE_JOINED, msgs);
				case SQLXMLQueryPackage.XML_PREDICATE__COMBINED_LEFT:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_PREDICATE__COMBINED_LEFT, msgs);
				case SQLXMLQueryPackage.XML_PREDICATE__COMBINED_RIGHT:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_PREDICATE__COMBINED_RIGHT, msgs);
				case SQLXMLQueryPackage.XML_PREDICATE__QUERY_SELECT_HAVING:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_PREDICATE__QUERY_SELECT_HAVING, msgs);
				case SQLXMLQueryPackage.XML_PREDICATE__QUERY_SELECT_WHERE:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_PREDICATE__QUERY_SELECT_WHERE, msgs);
				case SQLXMLQueryPackage.XML_PREDICATE__VALUE_EXPR_CASE_SEARCH_CONTENT:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_PREDICATE__VALUE_EXPR_CASE_SEARCH_CONTENT, msgs);
				case SQLXMLQueryPackage.XML_PREDICATE__NEST:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_PREDICATE__NEST, msgs);
				default:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case SQLXMLQueryPackage.XML_PREDICATE__NAME:
				return getName();
			case SQLXMLQueryPackage.XML_PREDICATE__DEPENDENCIES:
				return getDependencies();
			case SQLXMLQueryPackage.XML_PREDICATE__DESCRIPTION:
				return getDescription();
			case SQLXMLQueryPackage.XML_PREDICATE__LABEL:
				return getLabel();
			case SQLXMLQueryPackage.XML_PREDICATE__NEGATED_CONDITION:
			...
			case SQLXMLQueryPackage.XML_PREDICATE__NEST:
				return getNest();
			case SQLXMLQueryPackage.XML_PREDICATE__NEGATED_PREDICATE:
				return isNegatedPredicate() ? Boolean.TRUE : Boolean.FALSE;
			case SQLXMLQueryPackage.XML_PREDICATE__HAS_SELECTIVITY:
				return isHasSelectivity() ? Boolean.TRUE : Boolean.FALSE;
			case SQLXMLQueryPackage.XML_PREDICATE__SELECTIVITY_VALUE:
