 ...
 * </copyright>
 *
 * $Id: XMLQueryArgumentItemImpl.java,v 1.2 2005/10/22 01:40:26 bpayton Exp $
 */
...
public class XMLQueryArgumentItemImpl extends QueryValueExpressionImpl implements XMLQueryArgumentItem {
    ...
    protected EClass eStaticClass() {
		return SQLXMLQueryPackage.eINSTANCE.getXMLQueryArgumentItem();
	}
    ...
    public void setPassingMechanism(XMLPassingType newPassingMechanism) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__PASSING_MECHANISM, oldPassingMechanism, passingMechanism));
	}
    ...
    public XMLQueryArgumentList getXqueryArgList() {
		if (eContainerFeatureID != SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__XQUERY_ARG_LIST) return null;
    ...
    public void setXqueryArgList(XMLQueryArgumentList newXqueryArgList) {
		if (newXqueryArgList != eContainer || (eContainerFeatureID != SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__XQUERY_ARG_LIST && newXqueryArgList != null)) {
			...
			if (newXqueryArgList != null)
				msgs = ((InternalEObject)newXqueryArgList).eInverseAdd(this, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_LIST__XQUERY_ARG_LIST_CHILDREN, XMLQueryArgumentList.class, msgs);
			msgs = eBasicSetContainer((InternalEObject)newXqueryArgList, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__XQUERY_ARG_LIST, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__XQUERY_ARG_LIST, newXqueryArgList, newXqueryArgList));
	}
    ...
    public NotificationChain basicSetValueExpr(QueryValueExpression newValueExpr, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR, oldValueExpr, newValueExpr);
    ...
    public void setValueExpr(QueryValueExpression newValueExpr) {
		if (newValueExpr != valueExpr) {
			NotificationChain msgs = null;
			if (valueExpr != null)
				msgs = ((InternalEObject)valueExpr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR, null, msgs);
			if (newValueExpr != null)
				msgs = ((InternalEObject)newValueExpr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR, null, msgs);
			msgs = basicSetValueExpr(newValueExpr, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR, newValueExpr, newValueExpr));
	}
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__EANNOTATIONS:
					return ((InternalEList)getEAnnotations()).basicAdd(otherEnd, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUES_ROW:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUES_ROW, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__ORDER_BY_VALUE_EXPR:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__ORDER_BY_VALUE_EXPR, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__RESULT_COLUMN:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__RESULT_COLUMN, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__BASIC_RIGHT:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__BASIC_RIGHT, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__BASIC_LEFT:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__BASIC_LEFT, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__LIKE_PATTERN:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__LIKE_PATTERN, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__LIKE_MATCHING:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__LIKE_MATCHING, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__PREDICATE_NULL:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__PREDICATE_NULL, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__IN_VALUE_LIST_RIGHT:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__IN_VALUE_LIST_RIGHT, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__IN_VALUE_LIST_LEFT:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__IN_VALUE_LIST_LEFT, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__IN_VALUE_ROW_SELECT_LEFT:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__IN_VALUE_ROW_SELECT_LEFT, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__IN_VALUE_SELECT_LEFT:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__IN_VALUE_SELECT_LEFT, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__QUANTIFIED_ROW_SELECT_LEFT:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__QUANTIFIED_ROW_SELECT_LEFT, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__QUANTIFIED_VALUE_SELECT_LEFT:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__QUANTIFIED_VALUE_SELECT_LEFT, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__BETWEEN_LEFT:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__BETWEEN_LEFT, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__BETWEEN_RIGHT1:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__BETWEEN_RIGHT1, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__BETWEEN_RIGHT2:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__BETWEEN_RIGHT2, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_CAST:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_CAST, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_FUNCTION:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_FUNCTION, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_COMBINED_LEFT:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_COMBINED_LEFT, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_COMBINED_RIGHT:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_COMBINED_RIGHT, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__GROUPING_EXPR:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__GROUPING_EXPR, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_CASE_ELSE:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_CASE_ELSE, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_CASE_SIMPLE:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_CASE_SIMPLE, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_CASE_SIMPLE_CONTENT_WHEN:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_CASE_SIMPLE_CONTENT_WHEN, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_CASE_SIMPLE_CONTENT_RESULT:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_CASE_SIMPLE_CONTENT_RESULT, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_CASE_SEARCH_CONTENT:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_CASE_SEARCH_CONTENT, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__LIKE_ESCAPE:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__LIKE_ESCAPE, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_LABELED_DURATION:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_LABELED_DURATION, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__NEST:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__NEST, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__UPDATE_SOURCE_EXPR_LIST:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__UPDATE_SOURCE_EXPR_LIST, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__XQUERY_ARG_LIST:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__XQUERY_ARG_LIST, msgs);
				default:
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__DEPENDENCIES:
					return ((InternalEList)getDependencies()).basicRemove(otherEnd, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__DATA_TYPE:
					return basicSetDataType(null, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUES_ROW:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUES_ROW, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__ORDER_BY_VALUE_EXPR:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__ORDER_BY_VALUE_EXPR, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__RESULT_COLUMN:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__RESULT_COLUMN, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__BASIC_RIGHT:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__BASIC_RIGHT, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__BASIC_LEFT:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__BASIC_LEFT, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__LIKE_PATTERN:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__LIKE_PATTERN, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__LIKE_MATCHING:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__LIKE_MATCHING, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__PREDICATE_NULL:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__PREDICATE_NULL, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__IN_VALUE_LIST_RIGHT:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__IN_VALUE_LIST_RIGHT, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__IN_VALUE_LIST_LEFT:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__IN_VALUE_LIST_LEFT, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__IN_VALUE_ROW_SELECT_LEFT:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__IN_VALUE_ROW_SELECT_LEFT, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__IN_VALUE_SELECT_LEFT:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__IN_VALUE_SELECT_LEFT, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__QUANTIFIED_ROW_SELECT_LEFT:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__QUANTIFIED_ROW_SELECT_LEFT, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__QUANTIFIED_VALUE_SELECT_LEFT:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__QUANTIFIED_VALUE_SELECT_LEFT, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__BETWEEN_LEFT:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__BETWEEN_LEFT, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__BETWEEN_RIGHT1:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__BETWEEN_RIGHT1, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__BETWEEN_RIGHT2:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__BETWEEN_RIGHT2, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_CAST:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_CAST, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_FUNCTION:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_FUNCTION, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_COMBINED_LEFT:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_COMBINED_LEFT, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_COMBINED_RIGHT:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_COMBINED_RIGHT, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__GROUPING_EXPR:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__GROUPING_EXPR, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_CASE_ELSE:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_CASE_ELSE, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_CASE_SIMPLE:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_CASE_SIMPLE, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_CASE_SIMPLE_CONTENT_WHEN:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_CASE_SIMPLE_CONTENT_WHEN, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_CASE_SIMPLE_CONTENT_RESULT:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_CASE_SIMPLE_CONTENT_RESULT, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_CASE_SEARCH_CONTENT:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_CASE_SEARCH_CONTENT, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__LIKE_ESCAPE:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__LIKE_ESCAPE, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_LABELED_DURATION:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR_LABELED_DURATION, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__NEST:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__NEST, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__UPDATE_SOURCE_EXPR_LIST:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__UPDATE_SOURCE_EXPR_LIST, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__XQUERY_ARG_LIST:
					return eBasicSetContainer(null, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__XQUERY_ARG_LIST, msgs);
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__VALUE_EXPR:
    ...
    public NotificationChain eBasicRemoveFromContainer(NotificationChain msgs) {
		if (eContainerFeatureID >= 0) {
			switch (eContainerFeatureID) {
				...
				case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__XQUERY_ARG_LIST:
					return eContainer.eInverseRemove(this, SQLXMLQueryPackage.XML_QUERY_ARGUMENT_LIST__XQUERY_ARG_LIST_CHILDREN, XMLQueryArgumentList.class, msgs);
				default:
    ...
    public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__NAME:
				return getName();
			case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__DEPENDENCIES:
				return getDependencies();
			case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__DESCRIPTION:
				return getDescription();
			case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__LABEL:
				return getLabel();
			case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__UNARY_OPERATOR:
			...
			case SQLXMLQueryPackage.XML_QUERY_ARGUMENT_ITEM__PASSING_MECHANISM:
