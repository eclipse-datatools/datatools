 ...
 *******************************************************************************/
package org.eclipse.datatools.enablement.sqlite.ui.connection.drivers;
...
import org.eclipse.datatools.enablement.sqlite.ui.Messages;
...
public class SQLITEDriverUIContributor implements IDriverUIContributor,
		Listener, ModifyListener {

	private static final String CUI_NEWCW_GENERAL_TAB_UI_ = Messages
			.getString("SQLITEProfileDetailsWizardPage.general.tab"); //$NON-NLS-1$

	private static final String CUI_NEWCW_OPTIONAL_TAB_UI_ = Messages
			.getString("SQLITEProfileDetailsWizardPage.optional.tab"); //$NON-NLS-1$

	private static String CUI_NEWCW_DATABASE_LBL_UI_ = Messages
	.getString("SQLITEProfileDetailsWizardPage.databaseName.label"); //$NON-NLS-1$
	
	private static final String CUI_NEWCW_DBLOCATION_LBL_UI_ = Messages
			.getString("SQLITEProfileDetailsWizardPage.0"); //$NON-NLS-1$

	private static final String CUI_NEWCW_DBBROWSE_BTN_UI_ = Messages
			.getString("SQLITEProfileDetailsWizardPage.1"); //$NON-NLS-1$

	private static final String CUI_NEWCW_USERNAME_LBL_UI_ = Messages
			.getString("SQLITEProfileDetailsWizardPage.summary.userName.label"); //$NON-NLS-1$

	private static final String CUI_NEWCW_PASSWORD_LBL_UI_ = Messages
			.getString("SQLITEProfileDetailsWizardPage.password.label"); //$NON-NLS-1$

	private static final String CUI_NEWCW_SAVE_PASSWORD_LBL_UI_ = Messages
			.getString("SQLITEProfileDetailsWizardPage.persistpassword.label"); //$NON-NLS-1$

	private static final String CUI_NEWCW_CONNECTIONURL_LBL_UI_ = Messages
			.getString("SQLITEProfileDetailsWizardPage.summary.url.label"); //$NON-NLS-1$

	private static final String CUI_NEWCW_OPTIONAL_PROPERTIES_LBL_UI_ = Messages
			.getString("SQLITEProfileDetailsWizardPage.optionalProps.label"); //$NON-NLS-1$	

	private static final String CUI_NEWCW_DRIVER_NAME_SUMMARY_DATA_TEXT_ = Messages
			.getString("SQLITEProfileDetailsWizardPage.summary.driverName.label"); //$NON-NLS-1$
	
	private static final String CUI_NEWCW_DATABASE_SUMMARY_DATA_TEXT_ = Messages
	.getString("SQLITEProfileDetailsWizardPage.summary.database.label"); //$NON-NLS-1$

	private static final String CUI_NEWCW_DATABASE_LOCATION_SUMMARY_DATA_TEXT_ = Messages
			.getString("SQLITEProfileDetailsWizardPage.summary.databaselocation.label"); //$NON-NLS-1$
	...
	private static final String CUI_NEWCW_SAVE_PASSWORD_SUMMARY_DATA_TEXT_ = Messages
			.getString("SQLITEProfileDetailsWizardPage.summary.persistpassword.label"); //$NON-NLS-1$

	private static final String CUI_NEWCW_OPTIONAL_CONNECTION_PROPERTIES_SUMMARY_DATA_TEXT_ = Messages
			.getString("SQLITEProfileDetailsWizardPage.summary.connProps.label"); //$NON-NLS-1$

	private static final String CUI_NEWCW_TRUE_SUMMARY_DATA_TEXT_ = Messages
			.getString("SQLITEProfileDetailsWizardPage.summary.true"); //$NON-NLS-1$

	private static final String CUI_NEWCW_FALSE_SUMMARY_DATA_TEXT_ = Messages
			.getString("SQLITEProfileDetailsWizardPage.summary.false"); //$NON-NLS-1$

	private static final String CUI_NEWCW_FILE_BROWSER_TITLE_TEXT_ = Messages
			.getString("SQLITEProfileDetailsWizardPage.FileDialog.title.filebrowse"); //$NON-NLS-1$

	private static final String CUI_NEWCW_FILE_BROWSER_MESSAGE_TEXT_ = Messages
			.getString("SQLITEProfileDetailsWizardPage.FileDialog.msg.filebrowse"); //$NON-NLS-1$

	private static final String CUI_NEWCW_VALIDATE_DATABASE_REQ_UI_ = Messages
	.getString("SQLITEProfileDetailsWizardPage.database.validation.message"); //$NON-NLS-1$

	private static final String CUI_NEWCW_VALIDATE_DBLOCATION_REQ_UI_ = Messages
			.getString("SQLITEProfileDetailsWizardPage.databaselocation.validation.message"); //$NON-NLS-1$
		...
		if (parentComposite == null || parentComposite.isDisposed() || (this.isReadOnly != isReadOnly)) {
			...
			browseDatabaseLocation.addListener(SWT.Selection, new Listener() {
				...
				public void handleEvent(Event event) {
					SQLITEDriverUIContributor.this.browseForDBFolder();
				}
	...
	public void loadProperties() {
		removeListeners();
		SQLITEJDBCURL url = new SQLITEJDBCURL(this.properties
	...
	protected void updateURL() {
		String url = "jdbc:sqlite:" + databaseLocationText.getText(); //$NON-NLS-1$
		urlText.setText(url);
	}

	protected class SQLITEJDBCURL {
		 ...
		 * @param url
		 */
		public SQLITEJDBCURL(String url) {
			parseURL(url);
		}
