 ...
 * @author David cui
 */
public class CheckConstraintNode extends VirtualNode
{
     ...
     * @param parent
     */
    public CheckConstraintNode(String name, String displayName, Object parent)
    {
    ...
    {
        return ConstraintGroupID.CHECKCONSTRAINT;
    }
