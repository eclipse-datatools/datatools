...
public class ASEDBPropertyPage extends ExtensibleProfileDetailsPropertyPage implements IContextProvider 
{

    public ASEDBPropertyPage()
    {
        super(IASEConnectionProfileConstants.ASE_CATEGORY_ID);
    }
