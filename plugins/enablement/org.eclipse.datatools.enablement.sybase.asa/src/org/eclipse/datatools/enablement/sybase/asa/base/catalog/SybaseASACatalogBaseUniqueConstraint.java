...
{	
	...
	protected void loadUCInfo() {
		...
		SybaseASABaseDatabase db = (SybaseASABaseDatabase)getCatalogDatabase();
		...
		try {
			...
			stmt = conn.prepareStatement(SQLScriptsProvider.getQueryUnqiueConstraintInfo(db));
