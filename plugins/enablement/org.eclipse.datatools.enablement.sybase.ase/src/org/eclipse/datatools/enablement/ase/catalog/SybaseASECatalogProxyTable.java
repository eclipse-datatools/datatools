...
import org.eclipse.datatools.enablement.sybase.ase.models.sybaseasesqlmodel.impl.SybaseASEProxyTableImpl;
...
public class SybaseASECatalogProxyTable extends SybaseASEProxyTableImpl implements ISybaseASECatalogProxyTable,
        ICatalogObject, ICatalogTable, IAdaptable
{

    /**
     * 
     */
    private static final long        serialVersionUID = 1951793450278678055L;

    private SybaseASEBaseTableLoader tableLoader;

    public SybaseASECatalogProxyTable()
    {
        super();
        tableLoader = new SybaseASEProxyTableLoader(this);
    }
