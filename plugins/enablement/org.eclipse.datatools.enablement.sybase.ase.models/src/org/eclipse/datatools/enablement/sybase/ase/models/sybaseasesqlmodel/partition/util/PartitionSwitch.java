	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PartitionPackage.SYBASE_ASE_PARTITION: {
				...
				if (result == null) {
					result = caseSQLObject(sybaseASEPartition);
				}
				if (result == null) {
					result = caseENamedElement(sybaseASEPartition);
				}
				if (result == null) {
					result = caseEModelElement(sybaseASEPartition);
				}
				if (result == null) {
			...
			case PartitionPackage.SYBASE_ASE_RANGE_PARTITION: {
				...
				if (result == null) {
					result = caseSybaseASEPartition(sybaseASERangePartition);
				}
				if (result == null) {
					result = caseSQLObject(sybaseASERangePartition);
				}
				if (result == null) {
					result = caseENamedElement(sybaseASERangePartition);
				}
				if (result == null) {
					result = caseEModelElement(sybaseASERangePartition);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case PartitionPackage.SYBASE_ASE_HASH_PARTITION: {
				...
				if (result == null) {
					result = caseSybaseASEPartition(sybaseASEHashPartition);
				}
				if (result == null) {
					result = caseSQLObject(sybaseASEHashPartition);
				}
				if (result == null) {
					result = caseENamedElement(sybaseASEHashPartition);
				}
				if (result == null) {
					result = caseEModelElement(sybaseASEHashPartition);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case PartitionPackage.SYBASE_ASE_LIST_PARTITION: {
				...
				if (result == null) {
					result = caseSybaseASEPartition(sybaseASEListPartition);
				}
				if (result == null) {
					result = caseSQLObject(sybaseASEListPartition);
				}
				if (result == null) {
					result = caseENamedElement(sybaseASEListPartition);
				}
				if (result == null) {
					result = caseEModelElement(sybaseASEListPartition);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case PartitionPackage.SYBASE_ASE_ROUNDROBIN_PARTITION: {
				...
				if (result == null) {
					result = caseSybaseASEPartition(sybaseASERoundrobinPartition);
				}
				if (result == null) {
					result = caseSQLObject(sybaseASERoundrobinPartition);
				}
				if (result == null) {
					result = caseENamedElement(sybaseASERoundrobinPartition);
				}
				if (result == null) {
					result = caseEModelElement(sybaseASERoundrobinPartition);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case PartitionPackage.PARTITION_SEGMENT_PAIR: {
				...
				if (result == null) {
					result = caseSQLObject(partitionSegmentPair);
				}
				if (result == null) {
					result = caseENamedElement(partitionSegmentPair);
				}
				if (result == null) {
					result = caseEModelElement(partitionSegmentPair);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case PartitionPackage.PARTITION_NUM_IN_SEGMENTS: {
				...
				if (result == null) {
					result = caseSQLObject(partitionNumInSegments);
				}
				if (result == null) {
					result = caseENamedElement(partitionNumInSegments);
				}
				if (result == null) {
					result = caseEModelElement(partitionNumInSegments);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case PartitionPackage.LIST_RANGE_PARTITION_ITEM: {
				...
				if (result == null) {
					result = caseSQLObject(listRangePartitionItem);
				}
				if (result == null) {
					result = caseENamedElement(listRangePartitionItem);
				}
				if (result == null) {
					result = caseEModelElement(listRangePartitionItem);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
