 ...
 * </copyright>
 *
 * $Id: SybaseASEBaseTableImpl.java,v 1.9 2007/09/06 01:45:18 linsong Exp $
 */
...
import org.eclipse.datatools.enablement.sybase.models.sybasesqlmodel.impl.SybaseBaseTableImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.datatools.enablement.sybase.ase.models.sybaseasesqlmodel.impl.SybaseASEBaseTableImpl#getLockSchema <em>Lock Schema</em>}</li>
 *   <li>{@link org.eclipse.datatools.enablement.sybase.ase.models.sybaseasesqlmodel.impl.SybaseASEBaseTableImpl#getFillFactor <em>Fill Factor</em>}</li>
 *   <li>{@link org.eclipse.datatools.enablement.sybase.ase.models.sybaseasesqlmodel.impl.SybaseASEBaseTableImpl#getMaxRowPerPage <em>Max Row Per Page</em>}</li>
 *   <li>{@link org.eclipse.datatools.enablement.sybase.ase.models.sybaseasesqlmodel.impl.SybaseASEBaseTableImpl#getExpRowSize <em>Exp Row Size</em>}</li>
 *   <li>{@link org.eclipse.datatools.enablement.sybase.ase.models.sybaseasesqlmodel.impl.SybaseASEBaseTableImpl#getReservePageGap <em>Reserve Page Gap</em>}</li>
 *   <li>{@link org.eclipse.datatools.enablement.sybase.ase.models.sybaseasesqlmodel.impl.SybaseASEBaseTableImpl#getIdentityGap <em>Identity Gap</em>}</li>
 *   <li>{@link org.eclipse.datatools.enablement.sybase.ase.models.sybaseasesqlmodel.impl.SybaseASEBaseTableImpl#getSegment <em>Segment</em>}</li>
 *   <li>{@link org.eclipse.datatools.enablement.sybase.ase.models.sybaseasesqlmodel.impl.SybaseASEBaseTableImpl#getConcurrencyOptThreshold <em>Concurrency Opt Threshold</em>}</li>
 *   <li>{@link org.eclipse.datatools.enablement.sybase.ase.models.sybaseasesqlmodel.impl.SybaseASEBaseTableImpl#getPartitionCondition <em>Partition Condition</em>}</li>
 *   <li>{@link org.eclipse.datatools.enablement.sybase.ase.models.sybaseasesqlmodel.impl.SybaseASEBaseTableImpl#getTableOnlyCacheInfo <em>Table Only Cache Info</em>}</li>
 *   <li>{@link org.eclipse.datatools.enablement.sybase.ase.models.sybaseasesqlmodel.impl.SybaseASEBaseTableImpl#getTextOnlyCacheInfo <em>Text Only Cache Info</em>}</li>
 *   <li>{@link org.eclipse.datatools.enablement.sybase.ase.models.sybaseasesqlmodel.impl.SybaseASEBaseTableImpl#getLockPromotion <em>Lock Promotion</em>}</li>
 *   <li>{@link org.eclipse.datatools.enablement.sybase.ase.models.sybaseasesqlmodel.impl.SybaseASEBaseTableImpl#getPartitions <em>Partitions</em>}</li>
 *   <li>{@link org.eclipse.datatools.enablement.sybase.ase.models.sybaseasesqlmodel.impl.SybaseASEBaseTableImpl#getTextImageSegment <em>Text Image Segment</em>}</li>
 *   <li>{@link org.eclipse.datatools.enablement.sybase.ase.models.sybaseasesqlmodel.impl.SybaseASEBaseTableImpl#isSystemTable <em>System Table</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SybaseASEBaseTableImpl extends SybaseBaseTableImpl implements SybaseASEBaseTable
{
	/**
	 ...
	 * @generated
	 */
	protected SybaseASEBaseTableImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return SybaseasesqlmodelPackage.Literals.SYBASE_ASE_BASE_TABLE;
	}
	...
	public void setLockSchema(LockingSchemaType newLockSchema) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, SybaseasesqlmodelPackage.SYBASE_ASE_BASE_TABLE__LOCK_SCHEMA, oldLockSchema, lockSchema));
		}
	}
	...
	public void setFillFactor(int newFillFactor) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, SybaseasesqlmodelPackage.SYBASE_ASE_BASE_TABLE__FILL_FACTOR, oldFillFactor, fillFactor));
		}
	}
	...
	public void setMaxRowPerPage(int newMaxRowPerPage) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, SybaseasesqlmodelPackage.SYBASE_ASE_BASE_TABLE__MAX_ROW_PER_PAGE, oldMaxRowPerPage, maxRowPerPage));
		}
	}
	...
	public void setExpRowSize(int newExpRowSize) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, SybaseasesqlmodelPackage.SYBASE_ASE_BASE_TABLE__EXP_ROW_SIZE, oldExpRowSize, expRowSize));
		}
	}
	...
	public void setReservePageGap(int newReservePageGap) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, SybaseasesqlmodelPackage.SYBASE_ASE_BASE_TABLE__RESERVE_PAGE_GAP, oldReservePageGap, reservePageGap));
		}
	}
	...
	public void setIdentityGap(int newIdentityGap) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, SybaseasesqlmodelPackage.SYBASE_ASE_BASE_TABLE__IDENTITY_GAP, oldIdentityGap, identityGap));
		}
	}
	...
	public SybaseASESegment getSegment() {
		if (segment != null && segment.eIsProxy()) {
			...
			if (segment != oldSegment) {
				if (eNotificationRequired()) {
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SybaseasesqlmodelPackage.SYBASE_ASE_BASE_TABLE__SEGMENT, oldSegment, segment));
				}
			}
		}
		return segment;
	...
	public void setSegment(SybaseASESegment newSegment) {
		...
		segment = newSegment;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, SybaseasesqlmodelPackage.SYBASE_ASE_BASE_TABLE__SEGMENT, oldSegment, segment));
		}
	}
	...
	public void setConcurrencyOptThreshold(int newConcurrencyOptThreshold) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, SybaseasesqlmodelPackage.SYBASE_ASE_BASE_TABLE__CONCURRENCY_OPT_THRESHOLD, oldConcurrencyOptThreshold, concurrencyOptThreshold));
		}
	}
    ...
    public NotificationChain basicSetPartitionCondition(SybaseASEPartition newPartitionCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SybaseasesqlmodelPackage.SYBASE_ASE_BASE_TABLE__PARTITION_CONDITION, oldPartitionCondition, newPartitionCondition);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public void setPartitionCondition(SybaseASEPartition newPartitionCondition) {
		if (newPartitionCondition != partitionCondition) {
			...
			if (partitionCondition != null) {
				msgs = ((InternalEObject)partitionCondition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SybaseasesqlmodelPackage.SYBASE_ASE_BASE_TABLE__PARTITION_CONDITION, null, msgs);
			}
			if (newPartitionCondition != null) {
				msgs = ((InternalEObject)newPartitionCondition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SybaseasesqlmodelPackage.SYBASE_ASE_BASE_TABLE__PARTITION_CONDITION, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, SybaseasesqlmodelPackage.SYBASE_ASE_BASE_TABLE__PARTITION_CONDITION, newPartitionCondition, newPartitionCondition));
		}
	}
    ...
    public NotificationChain basicSetTableOnlyCacheInfo(CacheInfo newTableOnlyCacheInfo, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SybaseasesqlmodelPackage.SYBASE_ASE_BASE_TABLE__TABLE_ONLY_CACHE_INFO, oldTableOnlyCacheInfo, newTableOnlyCacheInfo);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
	...
	public void setTableOnlyCacheInfo(CacheInfo newTableOnlyCacheInfo) {
		if (newTableOnlyCacheInfo != tableOnlyCacheInfo) {
			...
			if (tableOnlyCacheInfo != null) {
				msgs = ((InternalEObject)tableOnlyCacheInfo).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SybaseasesqlmodelPackage.SYBASE_ASE_BASE_TABLE__TABLE_ONLY_CACHE_INFO, null, msgs);
			}
			if (newTableOnlyCacheInfo != null) {
				msgs = ((InternalEObject)newTableOnlyCacheInfo).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SybaseasesqlmodelPackage.SYBASE_ASE_BASE_TABLE__TABLE_ONLY_CACHE_INFO, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, SybaseasesqlmodelPackage.SYBASE_ASE_BASE_TABLE__TABLE_ONLY_CACHE_INFO, newTableOnlyCacheInfo, newTableOnlyCacheInfo));
		}
	}
    ...
    public NotificationChain basicSetTextOnlyCacheInfo(CacheInfo newTextOnlyCacheInfo, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SybaseasesqlmodelPackage.SYBASE_ASE_BASE_TABLE__TEXT_ONLY_CACHE_INFO, oldTextOnlyCacheInfo, newTextOnlyCacheInfo);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
	...
	public void setTextOnlyCacheInfo(CacheInfo newTextOnlyCacheInfo) {
		if (newTextOnlyCacheInfo != textOnlyCacheInfo) {
			...
			if (textOnlyCacheInfo != null) {
				msgs = ((InternalEObject)textOnlyCacheInfo).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SybaseasesqlmodelPackage.SYBASE_ASE_BASE_TABLE__TEXT_ONLY_CACHE_INFO, null, msgs);
			}
			if (newTextOnlyCacheInfo != null) {
				msgs = ((InternalEObject)newTextOnlyCacheInfo).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SybaseasesqlmodelPackage.SYBASE_ASE_BASE_TABLE__TEXT_ONLY_CACHE_INFO, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, SybaseasesqlmodelPackage.SYBASE_ASE_BASE_TABLE__TEXT_ONLY_CACHE_INFO, newTextOnlyCacheInfo, newTextOnlyCacheInfo));
		}
	}
	...
	public EList getLockPromotion() {
		if (lockPromotion == null) {
			lockPromotion = new EObjectContainmentEList(LockPromotionInfo.class, this, SybaseasesqlmodelPackage.SYBASE_ASE_BASE_TABLE__LOCK_PROMOTION);
		}
	...
	public void setPartitions(int newPartitions) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, SybaseasesqlmodelPackage.SYBASE_ASE_BASE_TABLE__PARTITIONS, oldPartitions, partitions));
		}
	}
	...
	public SybaseASESegment getTextImageSegment() {
		if (textImageSegment != null && textImageSegment.eIsProxy()) {
			...
			if (textImageSegment != oldTextImageSegment) {
				if (eNotificationRequired()) {
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SybaseasesqlmodelPackage.SYBASE_ASE_BASE_TABLE__TEXT_IMAGE_SEGMENT, oldTextImageSegment, textImageSegment));
				}
			}
		}
	...
	public void setTextImageSegment(SybaseASESegment newTextImageSegment) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, SybaseasesqlmodelPackage.SYBASE_ASE_BASE_TABLE__TEXT_IMAGE_SEGMENT, oldTextImageSegment, textImageSegment));
		}
	}
	...
	public void setSystemTable(boolean newSystemTable) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, SybaseasesqlmodelPackage.SYBASE_ASE_BASE_TABLE__SYSTEM_TABLE, oldSystemTable, systemTable));
		}
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case SybaseasesqlmodelPackage.SYBASE_ASE_BASE_TABLE__TEXT_ONLY_CACHE_INFO:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case SybaseasesqlmodelPackage.SYBASE_ASE_BASE_TABLE__SYSTEM_TABLE:
