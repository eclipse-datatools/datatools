	...
	protected Object doSwitch(int classifierID, EObject theEObject)
    {
		switch (classifierID) {
			case SybaseasesqlmodelPackage.SYBASE_ASE_SCHEMA: {
				...
				if (result == null) {
					result = caseSchema(sybaseASESchema);
				}
				if (result == null) {
					result = caseSQLObject(sybaseASESchema);
				}
				if (result == null) {
					result = caseENamedElement(sybaseASESchema);
				}
				if (result == null) {
					result = caseEModelElement(sybaseASESchema);
				}
				if (result == null) {
			...
			case SybaseasesqlmodelPackage.SYBASE_ASE_DATABASE: {
				...
				if (result == null) {
					result = caseDatabase(sybaseASEDatabase);
				}
				if (result == null) {
					result = caseSQLObject(sybaseASEDatabase);
				}
				if (result == null) {
					result = caseENamedElement(sybaseASEDatabase);
				}
				if (result == null) {
					result = caseEModelElement(sybaseASEDatabase);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SybaseasesqlmodelPackage.SYBASE_ASE_WEB_SERVICE: {
				...
				if (result == null) {
					result = caseSQLObject(sybaseASEWebService);
				}
				if (result == null) {
					result = caseENamedElement(sybaseASEWebService);
				}
				if (result == null) {
					result = caseEModelElement(sybaseASEWebService);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SybaseasesqlmodelPackage.SYBASE_ASE_PREDEFINED_DATA_TYPE: {
				...
				if (result == null) {
					result = casePredefinedDataType(sybaseASEPredefinedDataType);
				}
				if (result == null) {
					result = caseSQLDataType(sybaseASEPredefinedDataType);
				}
				if (result == null) {
					result = caseDataType(sybaseASEPredefinedDataType);
				}
				if (result == null) {
					result = caseSQLObject(sybaseASEPredefinedDataType);
				}
				if (result == null) {
					result = caseENamedElement(sybaseASEPredefinedDataType);
				}
				if (result == null) {
					result = caseEModelElement(sybaseASEPredefinedDataType);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SybaseasesqlmodelPackage.SYBASE_ASE_CATALOG: {
				...
				if (result == null) {
					result = caseCatalog(sybaseASECatalog);
				}
				if (result == null) {
					result = caseSQLObject(sybaseASECatalog);
				}
				if (result == null) {
					result = caseENamedElement(sybaseASECatalog);
				}
				if (result == null) {
					result = caseEModelElement(sybaseASECatalog);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SybaseasesqlmodelPackage.SYBASE_ASE_PROCEDURE: {
				...
				if (result == null) {
					result = caseProcedure(sybaseASEProcedure);
				}
				if (result == null) {
					result = caseSybaseRoutine(sybaseASEProcedure);
				}
				if (result == null) {
					result = caseRoutine(sybaseASEProcedure);
				}
				if (result == null) {
					result = caseSybaseAuthorizedObject(sybaseASEProcedure);
				}
				if (result == null) {
					result = caseSQLObject(sybaseASEProcedure);
				}
				if (result == null) {
					result = caseENamedElement(sybaseASEProcedure);
				}
				if (result == null) {
					result = caseEModelElement(sybaseASEProcedure);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SybaseasesqlmodelPackage.SYBASE_ASE_DEFAULT: {
				...
				if (result == null) {
					result = caseSQLObject(sybaseASEDefault);
				}
				if (result == null) {
					result = caseENamedElement(sybaseASEDefault);
				}
				if (result == null) {
					result = caseEModelElement(sybaseASEDefault);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SybaseasesqlmodelPackage.SYBASE_ASE_RULE: {
				...
				if (result == null) {
					result = caseSQLObject(sybaseASERule);
				}
				if (result == null) {
					result = caseENamedElement(sybaseASERule);
				}
				if (result == null) {
					result = caseEModelElement(sybaseASERule);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SybaseasesqlmodelPackage.SYBASE_ASE_INDEX: {
				...
				if (result == null) {
					result = caseIndex(sybaseASEIndex);
				}
				if (result == null) {
					result = caseSQLObject(sybaseASEIndex);
				}
				if (result == null) {
					result = caseENamedElement(sybaseASEIndex);
				}
				if (result == null) {
					result = caseEModelElement(sybaseASEIndex);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SybaseasesqlmodelPackage.SYBASE_ASE_SEGMENT: {
				...
				if (result == null) {
					result = caseSQLObject(sybaseASESegment);
				}
				if (result == null) {
					result = caseENamedElement(sybaseASESegment);
				}
				if (result == null) {
					result = caseEModelElement(sybaseASESegment);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SybaseasesqlmodelPackage.SYBASE_ASE_FUNC_BASED_INDEX_MEMBER: {
				...
				if (result == null) {
					result = caseSybaseIndexMember(sybaseASEFuncBasedIndexMember);
				}
				if (result == null) {
					result = caseIndexMember(sybaseASEFuncBasedIndexMember);
				}
				if (result == null) {
					result = caseSQLObject(sybaseASEFuncBasedIndexMember);
				}
				if (result == null) {
					result = caseENamedElement(sybaseASEFuncBasedIndexMember);
				}
				if (result == null) {
					result = caseEModelElement(sybaseASEFuncBasedIndexMember);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SybaseasesqlmodelPackage.SYBASE_ASE_TABLE: {
				...
				if (result == null) {
					result = casePersistentTable(sybaseASETable);
				}
				if (result == null) {
					result = caseSybaseASEBaseTable(sybaseASETable);
				}
				if (result == null) {
					result = caseSybaseBaseTable(sybaseASETable);
				}
				if (result == null) {
					result = caseBaseTable(sybaseASETable);
				}
				if (result == null) {
					result = caseTable(sybaseASETable);
				}
				if (result == null) {
					result = caseSybaseAuthorizedObject(sybaseASETable);
				}
				if (result == null) {
					result = caseSQLObject(sybaseASETable);
				}
				if (result == null) {
					result = caseENamedElement(sybaseASETable);
				}
				if (result == null) {
					result = caseEModelElement(sybaseASETable);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SybaseasesqlmodelPackage.SYBASE_ASE_COLUMN_CHECK_CONSTRAINT: {
				...
				if (result == null) {
					result = caseSybaseASECheckConstraint(sybaseASEColumnCheckConstraint);
				}
				if (result == null) {
					result = caseCheckConstraint(sybaseASEColumnCheckConstraint);
				}
				if (result == null) {
					result = caseTableConstraint(sybaseASEColumnCheckConstraint);
				}
				if (result == null) {
					result = caseConstraint(sybaseASEColumnCheckConstraint);
				}
				if (result == null) {
					result = caseSQLObject(sybaseASEColumnCheckConstraint);
				}
				if (result == null) {
					result = caseENamedElement(sybaseASEColumnCheckConstraint);
				}
				if (result == null) {
					result = caseEModelElement(sybaseASEColumnCheckConstraint);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SybaseasesqlmodelPackage.SYBASE_ASE_COLUMN: {
				...
				if (result == null) {
					result = caseColumn(sybaseASEColumn);
				}
				if (result == null) {
					result = caseSybaseAuthorizedObject(sybaseASEColumn);
				}
				if (result == null) {
					result = caseTypedElement(sybaseASEColumn);
				}
				if (result == null) {
					result = caseSQLObject(sybaseASEColumn);
				}
				if (result == null) {
					result = caseENamedElement(sybaseASEColumn);
				}
				if (result == null) {
					result = caseEModelElement(sybaseASEColumn);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SybaseasesqlmodelPackage.SYBASE_ASE_UNIQUE_CONSTRAINT: {
				...
				if (result == null) {
					result = caseUniqueConstraint(sybaseASEUniqueConstraint);
				}
				if (result == null) {
					result = caseReferenceConstraint(sybaseASEUniqueConstraint);
				}
				if (result == null) {
					result = caseTableConstraint(sybaseASEUniqueConstraint);
				}
				if (result == null) {
					result = caseConstraint(sybaseASEUniqueConstraint);
				}
				if (result == null) {
					result = caseSQLObject(sybaseASEUniqueConstraint);
				}
				if (result == null) {
					result = caseENamedElement(sybaseASEUniqueConstraint);
				}
				if (result == null) {
					result = caseEModelElement(sybaseASEUniqueConstraint);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SybaseasesqlmodelPackage.SYBASE_ASE_PRIMARY_KEY: {
				...
				if (result == null) {
					result = casePrimaryKey(sybaseASEPrimaryKey);
				}
				if (result == null) {
					result = caseUniqueConstraint(sybaseASEPrimaryKey);
				}
				if (result == null) {
					result = caseReferenceConstraint(sybaseASEPrimaryKey);
				}
				if (result == null) {
					result = caseTableConstraint(sybaseASEPrimaryKey);
				}
				if (result == null) {
					result = caseConstraint(sybaseASEPrimaryKey);
				}
				if (result == null) {
					result = caseSQLObject(sybaseASEPrimaryKey);
				}
				if (result == null) {
					result = caseENamedElement(sybaseASEPrimaryKey);
				}
				if (result == null) {
					result = caseEModelElement(sybaseASEPrimaryKey);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SybaseasesqlmodelPackage.DEVICE_ITEM: {
				...
				if (result == null) {
					result = caseSQLObject(deviceItem);
				}
				if (result == null) {
					result = caseENamedElement(deviceItem);
				}
				if (result == null) {
					result = caseEModelElement(deviceItem);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SybaseasesqlmodelPackage.SEGMENT_THRESHOLD: {
				...
				if (result == null) {
					result = caseSQLObject(segmentThreshold);
				}
				if (result == null) {
					result = caseENamedElement(segmentThreshold);
				}
				if (result == null) {
					result = caseEModelElement(segmentThreshold);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SybaseasesqlmodelPackage.CACHE_INFO: {
				...
				if (result == null) {
					result = caseSQLObject(cacheInfo);
				}
				if (result == null) {
					result = caseENamedElement(cacheInfo);
				}
				if (result == null) {
					result = caseEModelElement(cacheInfo);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SybaseasesqlmodelPackage.SYBASE_ASE_USER_DEFINED_TYPE: {
				...
				if (result == null) {
					result = caseDistinctUserDefinedType(sybaseASEUserDefinedType);
				}
				if (result == null) {
					result = caseUserDefinedType(sybaseASEUserDefinedType);
				}
				if (result == null) {
					result = caseDataType(sybaseASEUserDefinedType);
				}
				if (result == null) {
					result = caseSQLObject(sybaseASEUserDefinedType);
				}
				if (result == null) {
					result = caseENamedElement(sybaseASEUserDefinedType);
				}
				if (result == null) {
					result = caseEModelElement(sybaseASEUserDefinedType);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SybaseasesqlmodelPackage.SYBASE_ASE_ENCRYPTION_KEY: {
				...
				if (result == null) {
					result = caseSQLObject(sybaseASEEncryptionKey);
				}
				if (result == null) {
					result = caseENamedElement(sybaseASEEncryptionKey);
				}
				if (result == null) {
					result = caseEModelElement(sybaseASEEncryptionKey);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SybaseasesqlmodelPackage.LOCK_PROMOTION_INFO: {
				...
				if (result == null) {
					result = caseSQLObject(lockPromotionInfo);
				}
				if (result == null) {
					result = caseENamedElement(lockPromotionInfo);
				}
				if (result == null) {
					result = caseEModelElement(lockPromotionInfo);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SybaseasesqlmodelPackage.SYBASE_ASE_ROLE: {
				...
				if (result == null) {
					result = caseRole(sybaseASERole);
				}
				if (result == null) {
					result = caseSybaseAuthorizationIdentifier(sybaseASERole);
				}
				if (result == null) {
					result = caseAuthorizationIdentifier(sybaseASERole);
				}
				if (result == null) {
					result = caseSQLObject(sybaseASERole);
				}
				if (result == null) {
					result = caseENamedElement(sybaseASERole);
				}
				if (result == null) {
					result = caseEModelElement(sybaseASERole);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SybaseasesqlmodelPackage.SYBASE_ASE_CACHE: {
				...
				if (result == null) {
					result = caseSQLObject(sybaseASECache);
				}
				if (result == null) {
					result = caseENamedElement(sybaseASECache);
				}
				if (result == null) {
					result = caseEModelElement(sybaseASECache);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SybaseasesqlmodelPackage.SYBASE_ASE_VIEW_TABLE: {
				...
				if (result == null) {
					result = caseSybaseViewTable(sybaseASEViewTable);
				}
				if (result == null) {
					result = caseViewTable(sybaseASEViewTable);
				}
				if (result == null) {
					result = caseSybaseAuthorizedObject(sybaseASEViewTable);
				}
				if (result == null) {
					result = caseDerivedTable(sybaseASEViewTable);
				}
				if (result == null) {
					result = caseTable(sybaseASEViewTable);
				}
				if (result == null) {
					result = caseSQLObject(sybaseASEViewTable);
				}
				if (result == null) {
					result = caseENamedElement(sybaseASEViewTable);
				}
				if (result == null) {
					result = caseEModelElement(sybaseASEViewTable);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SybaseasesqlmodelPackage.SYBASE_ASE_TEMP_TABLE: {
				...
				if (result == null) {
					result = caseTemporaryTable(sybaseASETempTable);
				}
				if (result == null) {
					result = caseSybaseASEBaseTable(sybaseASETempTable);
				}
				if (result == null) {
					result = caseSybaseBaseTable(sybaseASETempTable);
				}
				if (result == null) {
					result = caseBaseTable(sybaseASETempTable);
				}
				if (result == null) {
					result = caseTable(sybaseASETempTable);
				}
				if (result == null) {
					result = caseSybaseAuthorizedObject(sybaseASETempTable);
				}
				if (result == null) {
					result = caseSQLObject(sybaseASETempTable);
				}
				if (result == null) {
					result = caseENamedElement(sybaseASETempTable);
				}
				if (result == null) {
					result = caseEModelElement(sybaseASETempTable);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SybaseasesqlmodelPackage.SYBASE_ASE_PROXY_TABLE: {
				...
				if (result == null) {
					result = caseSybaseASETable(sybaseASEProxyTable);
				}
				if (result == null) {
					result = casePersistentTable(sybaseASEProxyTable);
				}
				if (result == null) {
					result = caseSybaseASEBaseTable(sybaseASEProxyTable);
				}
				if (result == null) {
					result = caseSybaseBaseTable(sybaseASEProxyTable);
				}
				if (result == null) {
					result = caseBaseTable(sybaseASEProxyTable);
				}
				if (result == null) {
					result = caseTable(sybaseASEProxyTable);
				}
				if (result == null) {
					result = caseSybaseAuthorizedObject(sybaseASEProxyTable);
				}
				if (result == null) {
					result = caseSQLObject(sybaseASEProxyTable);
				}
				if (result == null) {
					result = caseENamedElement(sybaseASEProxyTable);
				}
				if (result == null) {
					result = caseEModelElement(sybaseASEProxyTable);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SybaseasesqlmodelPackage.SYBASE_ASE_WEB_SERVICE_TABLE: {
				...
				if (result == null) {
					result = caseSybaseASEProxyTable(sybaseASEWebServiceTable);
				}
				if (result == null) {
					result = caseSybaseASETable(sybaseASEWebServiceTable);
				}
				if (result == null) {
					result = casePersistentTable(sybaseASEWebServiceTable);
				}
				if (result == null) {
					result = caseSybaseASEBaseTable(sybaseASEWebServiceTable);
				}
				if (result == null) {
					result = caseSybaseBaseTable(sybaseASEWebServiceTable);
				}
				if (result == null) {
					result = caseBaseTable(sybaseASEWebServiceTable);
				}
				if (result == null) {
					result = caseTable(sybaseASEWebServiceTable);
				}
				if (result == null) {
					result = caseSybaseAuthorizedObject(sybaseASEWebServiceTable);
				}
				if (result == null) {
					result = caseSQLObject(sybaseASEWebServiceTable);
				}
				if (result == null) {
					result = caseENamedElement(sybaseASEWebServiceTable);
				}
				if (result == null) {
					result = caseEModelElement(sybaseASEWebServiceTable);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SybaseasesqlmodelPackage.SYBASE_ASE_BASE_TABLE: {
				...
				if (result == null) {
					result = caseSybaseBaseTable(sybaseASEBaseTable);
				}
				if (result == null) {
					result = caseBaseTable(sybaseASEBaseTable);
				}
				if (result == null) {
					result = caseSybaseAuthorizedObject(sybaseASEBaseTable);
				}
				if (result == null) {
					result = caseTable(sybaseASEBaseTable);
				}
				if (result == null) {
					result = caseSQLObject(sybaseASEBaseTable);
				}
				if (result == null) {
					result = caseENamedElement(sybaseASEBaseTable);
				}
				if (result == null) {
					result = caseEModelElement(sybaseASEBaseTable);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SybaseasesqlmodelPackage.SYBASE_ASE_USER: {
				...
				if (result == null) {
					result = caseUser(sybaseASEUser);
				}
				if (result == null) {
					result = caseSybaseAuthorizationIdentifier(sybaseASEUser);
				}
				if (result == null) {
					result = caseAuthorizationIdentifier(sybaseASEUser);
				}
				if (result == null) {
					result = caseSQLObject(sybaseASEUser);
				}
				if (result == null) {
					result = caseENamedElement(sybaseASEUser);
				}
				if (result == null) {
					result = caseEModelElement(sybaseASEUser);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SybaseasesqlmodelPackage.SYBASE_ASE_GROUP: {
				...
				if (result == null) {
					result = caseGroup(sybaseASEGroup);
				}
				if (result == null) {
					result = caseSybaseAuthorizationIdentifier(sybaseASEGroup);
				}
				if (result == null) {
					result = caseAuthorizationIdentifier(sybaseASEGroup);
				}
				if (result == null) {
					result = caseSQLObject(sybaseASEGroup);
				}
				if (result == null) {
					result = caseENamedElement(sybaseASEGroup);
				}
				if (result == null) {
					result = caseEModelElement(sybaseASEGroup);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SybaseasesqlmodelPackage.SYBASE_ASE_PRIVILEGE: {
				...
				if (result == null) {
					result = caseSybasePrivilege(sybaseASEPrivilege);
				}
				if (result == null) {
					result = casePrivilege(sybaseASEPrivilege);
				}
				if (result == null) {
					result = caseSQLObject(sybaseASEPrivilege);
				}
				if (result == null) {
					result = caseENamedElement(sybaseASEPrivilege);
				}
				if (result == null) {
					result = caseEModelElement(sybaseASEPrivilege);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SybaseasesqlmodelPackage.SYBASE_ASE_TRIGGER: {
				...
				if (result == null) {
					result = caseTrigger(sybaseASETrigger);
				}
				if (result == null) {
					result = caseSQLObject(sybaseASETrigger);
				}
				if (result == null) {
					result = caseENamedElement(sybaseASETrigger);
				}
				if (result == null) {
					result = caseEModelElement(sybaseASETrigger);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case SybaseasesqlmodelPackage.SYBASE_ASE_CHECK_CONSTRAINT: {
				...
				if (result == null) {
					result = caseCheckConstraint(sybaseASECheckConstraint);
				}
				if (result == null) {
					result = caseTableConstraint(sybaseASECheckConstraint);
				}
				if (result == null) {
					result = caseConstraint(sybaseASECheckConstraint);
				}
				if (result == null) {
					result = caseSQLObject(sybaseASECheckConstraint);
				}
				if (result == null) {
					result = caseENamedElement(sybaseASECheckConstraint);
				}
				if (result == null) {
					result = caseEModelElement(sybaseASECheckConstraint);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
