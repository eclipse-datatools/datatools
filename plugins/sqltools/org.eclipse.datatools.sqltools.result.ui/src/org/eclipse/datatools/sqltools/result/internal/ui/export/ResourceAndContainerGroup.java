...
public class ResourceAndContainerGroup implements Listener
{
    ...
    private String                  resourceType                        = OutputterConstants.RESOURCE_TYPE;
     ...
     */
    public ResourceAndContainerGroup(Composite parent, Listener client, String resourceFieldLabel, String resourceType, Listener listener)
    {
