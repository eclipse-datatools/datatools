 ...
 * <li>if selection is of type <code>IStructuredSelection</code> then <code>run(IStructuredSelection)</code> and
 * <code>
...
public abstract class SelectionDispatchAction extends Action implements ISelectionChangedListener
{
    ...
    {
        return _fSite.getSelectionProvider();
    }

    /**
     * Updates the action's enablement state according to the given selection. This default implementation calls one of
     * the <code>selectionChanged</code> methods depending on the type of the passed selection.
     * 
    ...
    /**
     * Notifies this action that the given text selection has changed. This default implementation calls
     * <code>selectionChanged(ISelection selection)</code>.
     * 
     * @param selection the new selection
     */
    ...
    /**
     * Notifies this action that the given selection has changed. This default implementation sets the action's
     * enablement state to <code>false</code>.
     * 
     * @param selection the new selection
     */
