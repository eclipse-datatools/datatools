...
public class SearchConditionDefaultImpl extends SQLObjectImpl implements SearchConditionDefault {
	...
	protected EClass eStaticClass() {
		return SQLExpressionsPackage.eINSTANCE.getSearchConditionDefault();
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				case SQLExpressionsPackage.SEARCH_CONDITION_DEFAULT__EANNOTATIONS:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case SQLExpressionsPackage.SEARCH_CONDITION_DEFAULT__DEPENDENCIES:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case SQLExpressionsPackage.SEARCH_CONDITION_DEFAULT__NAME:
				return getName();
			case SQLExpressionsPackage.SEARCH_CONDITION_DEFAULT__DEPENDENCIES:
				return getDependencies();
			case SQLExpressionsPackage.SEARCH_CONDITION_DEFAULT__DESCRIPTION:
				return getDescription();
			case SQLExpressionsPackage.SEARCH_CONDITION_DEFAULT__LABEL:
				return getLabel();
