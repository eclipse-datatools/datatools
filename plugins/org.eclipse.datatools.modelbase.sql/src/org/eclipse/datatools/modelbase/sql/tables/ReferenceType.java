 ...
 * </copyright>
 *
 * $Id: ReferenceType.java,v 1.1 2005/08/02 22:56:30 ledunnel Exp $
 */
...
public final class ReferenceType extends AbstractEnumerator {
	 ...
	 * @ordered
	 */
	public static final ReferenceType SYSTEM_GENERATED_LITERAL = new ReferenceType(SYSTEM_GENERATED, "SYSTEM_GENERATED"); //$NON-NLS-1$
	 ...
	 * @ordered
	 */
	public static final ReferenceType USER_GENERATED_LITERAL = new ReferenceType(USER_GENERATED, "USER_GENERATED"); //$NON-NLS-1$
	 ...
	 * @ordered
	 */
	public static final ReferenceType DERIVED_SELF_REF_LITERAL = new ReferenceType(DERIVED_SELF_REF, "DERIVED_SELF_REF"); //$NON-NLS-1$
