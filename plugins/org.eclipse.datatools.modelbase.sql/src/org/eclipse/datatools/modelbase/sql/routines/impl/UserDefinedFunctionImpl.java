...
public class UserDefinedFunctionImpl extends FunctionImpl implements UserDefinedFunction {
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				case SQLRoutinesPackage.USER_DEFINED_FUNCTION__EANNOTATIONS:
				...
				case SQLRoutinesPackage.USER_DEFINED_FUNCTION__SCHEMA:
					if (schema != null)
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case SQLRoutinesPackage.USER_DEFINED_FUNCTION__DEPENDENCIES:
					return ((InternalEList)getDependencies()).basicRemove(otherEnd, msgs);
				case SQLRoutinesPackage.USER_DEFINED_FUNCTION__PARAMETERS:
					return ((InternalEList)getParameters()).basicRemove(otherEnd, msgs);
				case SQLRoutinesPackage.USER_DEFINED_FUNCTION__SOURCE:
					return basicSetSource(null, msgs);
				case SQLRoutinesPackage.USER_DEFINED_FUNCTION__SCHEMA:
					return basicSetSchema(null, msgs);
				case SQLRoutinesPackage.USER_DEFINED_FUNCTION__RETURN_TABLE:
					return basicSetReturnTable(null, msgs);
				case SQLRoutinesPackage.USER_DEFINED_FUNCTION__RETURN_SCALER:
					return basicSetReturnScaler(null, msgs);
				case SQLRoutinesPackage.USER_DEFINED_FUNCTION__RETURN_CAST:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case SQLRoutinesPackage.USER_DEFINED_FUNCTION__NAME:
				return getName();
			case SQLRoutinesPackage.USER_DEFINED_FUNCTION__DEPENDENCIES:
				return getDependencies();
			case SQLRoutinesPackage.USER_DEFINED_FUNCTION__DESCRIPTION:
				return getDescription();
			case SQLRoutinesPackage.USER_DEFINED_FUNCTION__LABEL:
				return getLabel();
			case SQLRoutinesPackage.USER_DEFINED_FUNCTION__SPECIFIC_NAME:
				return getSpecificName();
			case SQLRoutinesPackage.USER_DEFINED_FUNCTION__LANGUAGE:
				return getLanguage();
			case SQLRoutinesPackage.USER_DEFINED_FUNCTION__PARAMETER_STYLE:
				return getParameterStyle();
			case SQLRoutinesPackage.USER_DEFINED_FUNCTION__DETERMINISTIC:
				return isDeterministic() ? Boolean.TRUE : Boolean.FALSE;
			case SQLRoutinesPackage.USER_DEFINED_FUNCTION__SQL_DATA_ACCESS:
				return getSqlDataAccess();
			case SQLRoutinesPackage.USER_DEFINED_FUNCTION__CREATION_TS:
				return getCreationTS();
			case SQLRoutinesPackage.USER_DEFINED_FUNCTION__LAST_ALTERED_TS:
				return getLastAlteredTS();
			case SQLRoutinesPackage.USER_DEFINED_FUNCTION__AUTHORIZATION_ID:
				return getAuthorizationID();
			case SQLRoutinesPackage.USER_DEFINED_FUNCTION__SECURITY:
				return getSecurity();
			case SQLRoutinesPackage.USER_DEFINED_FUNCTION__EXTERNAL_NAME:
			...
			case SQLRoutinesPackage.USER_DEFINED_FUNCTION__NULL_CALL:
				return isNullCall() ? Boolean.TRUE : Boolean.FALSE;
			case SQLRoutinesPackage.USER_DEFINED_FUNCTION__STATIC:
				return isStatic() ? Boolean.TRUE : Boolean.FALSE;
			case SQLRoutinesPackage.USER_DEFINED_FUNCTION__TRANSFORM_GROUP:
				return getTransformGroup();
			case SQLRoutinesPackage.USER_DEFINED_FUNCTION__TYPE_PRESERVING:
				return isTypePreserving() ? Boolean.TRUE : Boolean.FALSE;
			case SQLRoutinesPackage.USER_DEFINED_FUNCTION__MUTATOR:
