...
public abstract class NumericalDataTypeImpl extends PredefinedDataTypeImpl implements NumericalDataType {
	...
	protected EClass eStaticClass() {
		return SQLDataTypesPackage.eINSTANCE.getNumericalDataType();
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				case SQLDataTypesPackage.NUMERICAL_DATA_TYPE__EANNOTATIONS:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case SQLDataTypesPackage.NUMERICAL_DATA_TYPE__DEPENDENCIES:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case SQLDataTypesPackage.NUMERICAL_DATA_TYPE__NAME:
				return getName();
			case SQLDataTypesPackage.NUMERICAL_DATA_TYPE__DEPENDENCIES:
				return getDependencies();
			case SQLDataTypesPackage.NUMERICAL_DATA_TYPE__DESCRIPTION:
				return getDescription();
			case SQLDataTypesPackage.NUMERICAL_DATA_TYPE__LABEL:
				return getLabel();
			case SQLDataTypesPackage.NUMERICAL_DATA_TYPE__PRIMITIVE_TYPE:
